...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:48:14 2006,
...
schedLocalTime = MibScalar((1, 3, 6, 1, 2, 1, 63, 1, 1), DateAndTime().subtype(subtypeSpec=constraint.ValueSizeConstraint(11, 11)).setFixedLength()).setMaxAccess("readonly")
