...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:13:22 2006,
...
hrDeviceStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 2, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(5,1,4,2,3,)).subtype(namedValues=namedval.NamedValues(("unknown", 1), ("running", 2), ("warning", 3), ("testing", 4), ("down", 5), ))).setMaxAccess("readonly")
...
hrSWRunStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 7), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,4,1,3,)).subtype(namedValues=namedval.NamedValues(("running", 1), ("runnable", 2), ("notRunnable", 3), ("invalid", 4), ))).setMaxAccess("readwrite")
