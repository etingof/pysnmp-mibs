...
hrSystemInitialLoadDevice = MibVariable((1, 3, 6, 1, 2, 1, 25, 1, 3), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readwrite")
hrSystemInitialLoadParameters = MibVariable((1, 3, 6, 1, 2, 1, 25, 1, 4), InternationalDisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 128))).setMaxAccess("readwrite")
...
hrSystemMaxProcesses = MibVariable((1, 3, 6, 1, 2, 1, 25, 1, 7), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readonly")
...
hrStorageIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 2, 3, 1, 1)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readonly"))
...
hrStorageAllocationUnits = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 2, 3, 1, 4)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readonly"))
hrStorageSize = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 2, 3, 1, 5)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readwrite"))
hrStorageUsed = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 2, 3, 1, 6)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readonly"))
...
hrDeviceIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 2, 1, 1)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readonly"))
hrDeviceType = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 2, 1, 2)).setColumnInitializer(MibVariable((), AutonomousType()).setMaxAccess("readonly"))
hrDeviceDescr = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 2, 1, 3)).setColumnInitializer(MibVariable((), DisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 64))).setMaxAccess("readonly"))
hrDeviceID = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 2, 1, 4)).setColumnInitializer(MibVariable((), ProductID()).setMaxAccess("readonly"))
hrDeviceStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 2, 1, 5)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(5,2,3,1,4,)).addNamedValues(("unknown", 1), ("running", 2), ("warning", 3), ("testing", 4), ("down", 5), )).setMaxAccess("readonly"))
...
hrProcessorLoad = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 3, 1, 2)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 100))).setMaxAccess("readonly"))
...
hrPrinterStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 5, 1, 1)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(3,1,5,2,4,)).addNamedValues(("other", 1), ("unknown", 2), ("idle", 3), ("printing", 4), ("warmup", 5), )).setMaxAccess("readonly"))
...
hrDiskStorageAccess = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 6, 1, 1)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,)).addNamedValues(("readWrite", 1), ("readOnly", 2), )).setMaxAccess("readonly"))
hrDiskStorageMedia = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 6, 1, 2)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(8,5,1,7,2,3,6,4,)).addNamedValues(("other", 1), ("unknown", 2), ("hardDisk", 3), ("floppyDisk", 4), ("opticalDiskROM", 5), ("opticalDiskWORM", 6), ("opticalDiskRW", 7), ("ramDisk", 8), )).setMaxAccess("readonly"))
...
hrPartitionIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 7, 1, 1)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readonly"))
hrPartitionLabel = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 7, 1, 2)).setColumnInitializer(MibVariable((), InternationalDisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 128))).setMaxAccess("readonly"))
...
hrPartitionFSIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 7, 1, 5)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readonly"))
...
hrFSIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 1)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readonly"))
hrFSMountPoint = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 2)).setColumnInitializer(MibVariable((), InternationalDisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 128))).setMaxAccess("readonly"))
hrFSRemoteMountPoint = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 3)).setColumnInitializer(MibVariable((), InternationalDisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 128))).setMaxAccess("readonly"))
hrFSType = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 4)).setColumnInitializer(MibVariable((), AutonomousType()).setMaxAccess("readonly"))
hrFSAccess = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 5)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,)).addNamedValues(("readWrite", 1), ("readOnly", 2), )).setMaxAccess("readonly"))
hrFSBootable = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 6)).setColumnInitializer(MibVariable((), TruthValue()).setMaxAccess("readonly"))
hrFSStorageIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 3, 8, 1, 7)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readonly"))
...
hrSWOSIndex = MibVariable((1, 3, 6, 1, 2, 1, 25, 4, 1), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readonly")
...
hrSWRunIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 1)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readonly"))
hrSWRunName = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 2)).setColumnInitializer(MibVariable((), InternationalDisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 64))).setMaxAccess("readonly"))
hrSWRunID = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 3)).setColumnInitializer(MibVariable((), ProductID()).setMaxAccess("readonly"))
hrSWRunPath = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 4)).setColumnInitializer(MibVariable((), InternationalDisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 128))).setMaxAccess("readonly"))
hrSWRunParameters = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 5)).setColumnInitializer(MibVariable((), InternationalDisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 128))).setMaxAccess("readonly"))
hrSWRunType = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 6)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(3,1,4,2,)).addNamedValues(("unknown", 1), ("operatingSystem", 2), ("deviceDriver", 3), ("application", 4), )).setMaxAccess("readonly"))
hrSWRunStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 4, 2, 1, 7)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,3,4,)).addNamedValues(("running", 1), ("runnable", 2), ("notRunnable", 3), ("invalid", 4), )).setMaxAccess("readwrite"))
...
hrSWRunPerfCPU = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 5, 1, 1, 1)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readonly"))
...
hrSWInstalledIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 6, 3, 1, 1)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readonly"))
hrSWInstalledName = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 6, 3, 1, 2)).setColumnInitializer(MibVariable((), InternationalDisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 64))).setMaxAccess("readonly"))
hrSWInstalledID = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 6, 3, 1, 3)).setColumnInitializer(MibVariable((), ProductID()).setMaxAccess("readonly"))
hrSWInstalledType = MibTableColumn((1, 3, 6, 1, 2, 1, 25, 6, 3, 1, 4)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(3,1,4,2,)).addNamedValues(("unknown", 1), ("operatingSystem", 2), ("deviceDriver", 3), ("application", 4), )).setMaxAccess("readonly"))
...
# Groups
mibBuilder.exportSymbols("HOST-RESOURCES-MIB", hrSWRunGroup=hrSWRunGroup, hrSWRunPerfGroup=hrSWRunPerfGroup, hrSWInstalledGroup=hrSWInstalledGroup, hrStorageGroup=hrStorageGroup, hrDeviceGroup=hrDeviceGroup, hrSystemGroup=hrSystemGroup)
