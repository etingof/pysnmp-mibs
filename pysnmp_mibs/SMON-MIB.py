...
portCopyDirection = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 22, 1, 3, 1, 1, 4), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,3,)).subtype(namedValues=namedval.NamedValues(("copyRxOnly", 1), ("copyTxOnly", 2), ("copyBoth", 3), )).clone(3)).setMaxAccess("readcreate")
