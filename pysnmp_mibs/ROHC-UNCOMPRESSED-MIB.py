...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:31:40 2015
...
rohcUncmprContextEntry = MibTableRow((1, 3, 6, 1, 2, 1, 113, 1, 1, 1), ).setIndexNames((0, "ROHC-UNCOMPRESSED-MIB", "rohcChannelID"), (0, "ROHC-UNCOMPRESSED-MIB", "rohcContextCID"))
if mibBuilder.loadTexts: rohcUncmprContextEntry.setDescription('An entry describing a particular context.')
rohcUncmprContextState = MibTableColumn((1, 3, 6, 1, 2, 1, 113, 1, 1, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("initAndRefresh", 1), ("normal", 2), ("noContext", 3), ("fullContext", 4),))).setMaxAccess("readonly")
...
rohcUncmprContextMode = MibTableColumn((1, 3, 6, 1, 2, 1, 113, 1, 1, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2,)).clone(namedValues=NamedValues(("unidirectional", 1), ("bidirectional", 2),))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("ROHC-UNCOMPRESSED-MIB", rohcUncmprMIB=rohcUncmprMIB, rohcUncmprGroups=rohcUncmprGroups, rohcUncmprContextMode=rohcUncmprContextMode, rohcUncmprStatisticsGroup=rohcUncmprStatisticsGroup, rohcUncmprConformance=rohcUncmprConformance, rohcUncmprContextState=rohcUncmprContextState, rohcUncmprContextEntry=rohcUncmprContextEntry, rohcUncmprCompliance=rohcUncmprCompliance, rohcUncmprCompliances=rohcUncmprCompliances, rohcUncmprContextACKs=rohcUncmprContextACKs, rohcUncmprContextTable=rohcUncmprContextTable, rohcUncmprContextGroup=rohcUncmprContextGroup, rohcUncmprObjects=rohcUncmprObjects, PYSNMP_MODULE_ID=rohcUncmprMIB)
