...
rohcUncmprContextState = MibTableColumn((1, 3, 6, 1, 2, 1, 113, 1, 1, 1, 3)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(3,2,1,4,)).addNamedValues(("initAndRefresh", 1), ("normal", 2), ("noContext", 3), ("fullContext", 4), )).setMaxAccess("readonly"))
rohcUncmprContextMode = MibTableColumn((1, 3, 6, 1, 2, 1, 113, 1, 1, 1, 4)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(2,1,)).addNamedValues(("unidirectional", 1), ("bidirectional", 2), )).setMaxAccess("readonly"))
