...
rohcUncmprContextState = MibTableColumn((1, 3, 6, 1, 2, 1, 113, 1, 1, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,3,1,4,)).subtype(namedValues=namedval.NamedValues(("initAndRefresh", 1), ("normal", 2), ("noContext", 3), ("fullContext", 4), ))).setMaxAccess("readonly")
