...
applIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 1)).setColumnInitializer(MibVariable((), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("noaccess"))
applName = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 2)).setColumnInitializer(MibVariable((), SnmpAdminString()).setMaxAccess("readonly"))
applDirectoryName = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 3)).setColumnInitializer(MibVariable((), DistinguishedName()).setMaxAccess("readonly"))
applVersion = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 4)).setColumnInitializer(MibVariable((), SnmpAdminString()).setMaxAccess("readonly"))
applUptime = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 5)).setColumnInitializer(MibVariable((), TimeStamp()).setMaxAccess("readonly"))
applOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 6)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,1,2,5,6,4,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), ("halted", 3), ("congested", 4), ("restarting", 5), ("quiescing", 6), ))).setMaxAccess("readonly"))
applLastChange = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 7)).setColumnInitializer(MibVariable((), TimeStamp()).setMaxAccess("readonly"))
applInboundAssociations = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 8)).setColumnInitializer(MibVariable((), Gauge32()).setMaxAccess("readonly"))
applOutboundAssociations = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 9)).setColumnInitializer(MibVariable((), Gauge32()).setMaxAccess("readonly"))
applAccumulatedInboundAssociations = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 10)).setColumnInitializer(MibVariable((), Counter32()).setMaxAccess("readonly"))
applAccumulatedOutboundAssociations = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 11)).setColumnInitializer(MibVariable((), Counter32()).setMaxAccess("readonly"))
applLastInboundActivity = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 12)).setColumnInitializer(MibVariable((), TimeStamp()).setMaxAccess("readonly"))
applLastOutboundActivity = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 13)).setColumnInitializer(MibVariable((), TimeStamp()).setMaxAccess("readonly"))
applRejectedInboundAssociations = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 14)).setColumnInitializer(MibVariable((), Counter32()).setMaxAccess("readonly"))
applFailedOutboundAssociations = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 15)).setColumnInitializer(MibVariable((), Counter32()).setMaxAccess("readonly"))
applDescription = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 16)).setColumnInitializer(MibVariable((), SnmpAdminString()).setMaxAccess("readonly"))
applURL = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 1, 1, 17)).setColumnInitializer(MibVariable((), URLString()).setMaxAccess("readonly"))
...
assocIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 2, 1, 1)).setColumnInitializer(MibVariable((), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("noaccess"))
assocRemoteApplication = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 2, 1, 2)).setColumnInitializer(MibVariable((), SnmpAdminString()).setMaxAccess("readonly"))
assocApplicationProtocol = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 2, 1, 3)).setColumnInitializer(MibVariable((), ObjectIdentifier()).setMaxAccess("readonly"))
assocApplicationType = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 2, 1, 4)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,4,3,)).subtype(namedValues=namedval.NamedValues(("uainitiator", 1), ("uaresponder", 2), ("peerinitiator", 3), ("peerresponder", 4), ))).setMaxAccess("readonly"))
assocDuration = MibTableColumn((1, 3, 6, 1, 2, 1, 27, 2, 1, 5)).setColumnInitializer(MibVariable((), TimeStamp()).setMaxAccess("readonly"))
