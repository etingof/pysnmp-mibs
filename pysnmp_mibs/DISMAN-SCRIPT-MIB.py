...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:48:24 2006,
...
smScriptLastChange = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 3, 1, 1, 11), DateAndTime().clone('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readonly")
...
smLaunchMaxRunning = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 1, 1, 6), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L)).clone(1)).setMaxAccess("readcreate")
smLaunchMaxCompleted = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 1, 1, 7), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L)).clone(1)).setMaxAccess("readcreate")
...
smLaunchControl = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 1, 1, 11), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,3,1,4,)).subtype(namedValues=namedval.NamedValues(("abort", 1), ("suspend", 2), ("resume", 3), ("nop", 4), )).clone(4)).setMaxAccess("readcreate")
...
smLaunchLastChange = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 1, 1, 18), DateAndTime().clone('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readonly")
...
smRunStartTime = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 2, 1, 3), DateAndTime().clone('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readonly")
smRunEndTime = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 2, 1, 4), DateAndTime().clone('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readonly")
...
smRunExitCode = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 2, 1, 7), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,6,7,3,8,1,5,4,9,)).subtype(namedValues=namedval.NamedValues(("noError", 1), ("halted", 2), ("lifeTimeExceeded", 3), ("noResourcesLeft", 4), ("languageError", 5), ("runtimeError", 6), ("invalidArgument", 7), ("securityViolation", 8), ("genericError", 9), )).clone(1)).setMaxAccess("readonly")
smRunResult = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 2, 1, 8), OctetString().clone('')).setMaxAccess("readonly")
smRunControl = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 2, 1, 9), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,3,1,4,)).subtype(namedValues=namedval.NamedValues(("abort", 1), ("suspend", 2), ("resume", 3), ("nop", 4), )).clone(4)).setMaxAccess("readwrite")
...
smRunResultTime = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 2, 1, 12), DateAndTime().clone('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readonly")
smRunErrorTime = MibTableColumn((1, 3, 6, 1, 2, 1, 64, 1, 4, 2, 1, 13), DateAndTime().clone('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readonly")
