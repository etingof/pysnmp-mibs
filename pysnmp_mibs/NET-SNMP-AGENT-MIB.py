...
nsLogLevel = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 7, 2, 1, 1, 1), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2, 3, 4, 5, 6, 7,)).clone(namedValues=NamedValues(("emergency", 0), ("alert", 1), ("critical", 2), ("error", 3), ("warning", 4), ("notice", 5), ("info", 6), ("debug", 7),)))
...
nsLogType = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 7, 2, 1, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5,)).clone(namedValues=NamedValues(("stdout", 1), ("stderr", 2), ("file", 3), ("syslog", 4), ("callback", 5),))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: nsLogType.setDescription('The type of logging for this entry.')
nsLogMaxLevel = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 7, 2, 1, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(0, 1, 2, 3, 4, 5, 6, 7,)).clone(namedValues=NamedValues(("emergency", 0), ("alert", 1), ("critical", 2), ("error", 3), ("warning", 4), ("notice", 5), ("info", 6), ("debug", 7),)).clone('emergency')).setMaxAccess("readcreate")
...
mibBuilder.exportSymbols("NET-SNMP-AGENT-MIB", nsDLMod=nsDLMod, nsLoggingEntry=nsLoggingEntry, nsNotifyShutdown=nsNotifyShutdown, nsMibRegistry=nsMibRegistry, nsCacheTable=nsCacheTable, nsTransactionID=nsTransactionID, nsDebugOutputAll=nsDebugOutputAll, nsLoggingGroup=nsLoggingGroup, nsModuleEntry=nsModuleEntry, nsDebugGroup=nsDebugGroup, nsModuleTimeout=nsModuleTimeout, nsModuleName=nsModuleName, nsDebugDumpPdu=nsDebugDumpPdu, nsConfigDebug=nsConfigDebug, nsTransactionEntry=nsTransactionEntry, nsModuleGroup=nsModuleGroup, nsmRegistrationPoint=nsmRegistrationPoint, nsCacheStatus=nsCacheStatus, nsLogMaxLevel=nsLogMaxLevel, nsNotifyRestart=nsNotifyRestart, nsmContextName=nsmContextName, nsDebugTokenStatus=nsDebugTokenStatus, netSnmpAgentMIB=netSnmpAgentMIB, nsTransactionGroup=nsTransactionGroup, nsLogType=nsLogType, nsConfiguration=nsConfiguration, nsDebugTokenTable=nsDebugTokenTable, nsErrorHistory=nsErrorHistory, nsCacheEnabled=nsCacheEnabled, nsCacheEntry=nsCacheEntry, nsmRegistrationPriority=nsmRegistrationPriority, nsVersion=nsVersion, nsConfigGroups=nsConfigGroups, PYSNMP_MODULE_ID=netSnmpAgentMIB, nsCachedOID=nsCachedOID, nsModuleTable=nsModuleTable, nsTransactionTable=nsTransactionTable, nsCacheDefaultTimeout=nsCacheDefaultTimeout, NetsnmpCacheStatus=NetsnmpCacheStatus, nsTransactions=nsTransactions, nsCacheGroup=nsCacheGroup, nsTransactionMode=nsTransactionMode, nsNotifyStart=nsNotifyStart, nsExtensions=nsExtensions, nsAgentNotifyGroup=nsAgentNotifyGroup, nsLogStatus=nsLogStatus, nsDebugTokenEntry=nsDebugTokenEntry, nsCache=nsCache, nsConfigLogging=nsConfigLogging, nsCacheTimeout=nsCacheTimeout, nsDebugEnabled=nsDebugEnabled, nsLogLevel=nsLogLevel, nsLogToken=nsLogToken, nsModuleModes=nsModuleModes, nsLoggingTable=nsLoggingTable, nsDebugTokenPrefix=nsDebugTokenPrefix)
