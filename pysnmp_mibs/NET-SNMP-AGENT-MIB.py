...
# by libsmi2pysnmp-0.0.5-alpha at Wed Apr  5 20:31:09 2006,
...
nsmContextName = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 2, 1, 1, 1), OctetString()).setMaxAccess("noaccess")
nsmRegistrationPoint = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 2, 1, 1, 2), ObjectIdentifier()).setMaxAccess("noaccess")
nsmRegistrationPriority = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 2, 1, 1, 3), Integer32()).setMaxAccess("noaccess")
...
nsCacheEntry = MibTableRow((1, 3, 6, 1, 4, 1, 8072, 1, 5, 3, 1)).setIndexNames((0, "NET-SNMP-AGENT-MIB", "nsCachedOID"))
...
nsDebugEnabled = MibScalar((1, 3, 6, 1, 4, 1, 8072, 1, 7, 1, 1), TruthValue()).setMaxAccess("readwrite")
nsDebugOutputAll = MibScalar((1, 3, 6, 1, 4, 1, 8072, 1, 7, 1, 2), TruthValue()).setMaxAccess("readwrite")
nsDebugDumpPdu = MibScalar((1, 3, 6, 1, 4, 1, 8072, 1, 7, 1, 3), TruthValue()).setMaxAccess("readwrite")
nsDebugTokenTable = MibTable((1, 3, 6, 1, 4, 1, 8072, 1, 7, 1, 4))
nsDebugTokenEntry = MibTableRow((1, 3, 6, 1, 4, 1, 8072, 1, 7, 1, 4, 1)).setIndexNames((0, "NET-SNMP-AGENT-MIB", "nsDebugTokenPrefix"))
nsDebugTokenPrefix = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 7, 1, 4, 1, 2), DisplayString()).setMaxAccess("noaccess")
nsDebugTokenStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 7, 1, 4, 1, 4), RowStatus()).setMaxAccess("readwrite")
nsConfigLogging = MibIdentifier((1, 3, 6, 1, 4, 1, 8072, 1, 7, 2))
nsLoggingTable = MibTable((1, 3, 6, 1, 4, 1, 8072, 1, 7, 2, 1))
nsLoggingEntry = MibTableRow((1, 3, 6, 1, 4, 1, 8072, 1, 7, 2, 1, 1)).setIndexNames((0, "NET-SNMP-AGENT-MIB", "nsLogLevel"), (0, "NET-SNMP-AGENT-MIB", "nsLogToken"))
...
nsLogType = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 7, 2, 1, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,4,5,3,)).subtype(namedValues=namedval.NamedValues(("stdout", 1), ("stderr", 2), ("file", 3), ("syslog", 4), ("callback", 5), ))).setMaxAccess("readwrite")
nsLogStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 7, 2, 1, 1, 5), RowStatus()).setMaxAccess("readwrite")
...
nsTransactionID = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 8, 1, 1, 1), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-1, 0))).setMaxAccess("noaccess")
nsTransactionMode = MibTableColumn((1, 3, 6, 1, 4, 1, 8072, 1, 8, 1, 1, 2), Integer32()).setMaxAccess("readonly")
netSnmpAgentMIB = ModuleIdentity((1, 3, 6, 1, 4, 1, 8072, 3, 1, 2)).setRevisions(("2002-02-09 00:00",))
...
nsTransctionGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 8072, 5, 2, 8)).setObjects(("NET-SNMP-AGENT-MIB", "nsTransactionMode"), ("NET-SNMP-AGENT-MIB", "nsTransactionID"), )
nsDebugGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 8072, 5, 2, 7, 1)).setObjects(("NET-SNMP-AGENT-MIB", "nsDebugTokenStatus"), ("NET-SNMP-AGENT-MIB", "nsDebugOutputAll"), ("NET-SNMP-AGENT-MIB", "nsDebugEnabled"), ("NET-SNMP-AGENT-MIB", "nsDebugTokenPrefix"), ("NET-SNMP-AGENT-MIB", "nsDebugDumpPdu"), )
...
nsModuleGroup = ObjectGroup((1, 3, 6, 1, 4, 1, 8072, 5, 2, 2)).setObjects(("NET-SNMP-AGENT-MIB", "nsmContextName"), ("NET-SNMP-AGENT-MIB", "nsmRegistrationPriority"), ("NET-SNMP-AGENT-MIB", "nsModuleModes"), ("NET-SNMP-AGENT-MIB", "nsModuleName"), ("NET-SNMP-AGENT-MIB", "nsModuleTimeout"), ("NET-SNMP-AGENT-MIB", "nsmRegistrationPoint"), )
...
# Groups
mibBuilder.exportSymbols("NET-SNMP-AGENT-MIB", nsTransctionGroup=nsTransctionGroup, nsDebugGroup=nsDebugGroup, nsLoggingGroup=nsLoggingGroup, nsModuleGroup=nsModuleGroup, nsAgentNotifyGroup=nsAgentNotifyGroup, nsCacheGroup=nsCacheGroup)
