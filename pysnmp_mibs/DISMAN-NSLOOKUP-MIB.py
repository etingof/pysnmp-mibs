...
lookupPurgeTime = MibScalar((1, 3, 6, 1, 2, 1, 82, 1, 2), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 86400)).clone(900)).setMaxAccess("readwrite").setUnits("seconds")
