...
tn3270eRtCollCtlType = MibTableColumn((1, 3, 6, 1, 2, 1, 34, 9, 1, 1, 1, 2)).setColumnInitializer(MibVariable((), Bits().subtype(namedValues=namedval.NamedValues(("aggregate", 0), ("excludeIpComponent", 1), ("ddr", 2), ("average", 3), ("buckets", 4), ("traps", 5), ))).setMaxAccess("readwrite"))
tn3270eRtCollCtlSPeriod = MibTableColumn((1, 3, 6, 1, 2, 1, 34, 9, 1, 1, 1, 3)).setColumnInitializer(MibVariable((), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(15, 86400))).setMaxAccess("readwrite"))
tn3270eRtCollCtlSPMult = MibTableColumn((1, 3, 6, 1, 2, 1, 34, 9, 1, 1, 1, 4)).setColumnInitializer(MibVariable((), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 5760))).setMaxAccess("readwrite"))
...
tn3270eRtDataClientPort = MibTableColumn((1, 3, 6, 1, 2, 1, 34, 9, 1, 2, 1, 3)).setColumnInitializer(MibVariable((), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 65535))).setMaxAccess("noaccess"))
...
tn3270eRtDataRtMethod = MibTableColumn((1, 3, 6, 1, 2, 1, 34, 9, 1, 2, 1, 19)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(0,2,1,)).subtype(namedValues=namedval.NamedValues(("none", 0), ("responses", 1), ("timingMark", 2), ))).setMaxAccess("readonly"))
