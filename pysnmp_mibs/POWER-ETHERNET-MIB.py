...
# by libsmi2pysnmp-0.0.7-alpha at Wed Feb  7 16:13:08 2007,
...
pethPsePortDetectionStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 105, 1, 1, 1, 6), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,4,2,3,6,5,)).subtype(namedValues=namedval.NamedValues(("disabled", 1), ("searching", 2), ("deliveringPower", 3), ("fault", 4), ("test", 5), ("otherFault", 6), ))).setMaxAccess("readonly")
