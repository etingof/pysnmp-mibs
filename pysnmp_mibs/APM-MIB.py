...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:13:10 2006,
...
apmAppDirResponsivenessType = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 23, 1, 1, 1, 2), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,3,)).subtype(namedValues=namedval.NamedValues(("transactionOriented", 1), ("throughputOriented", 2), ("streamingOriented", 3), ))).setMaxAccess("noaccess")
