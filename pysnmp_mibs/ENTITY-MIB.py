...
class PhysicalClass(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(5,3,2,12,6,9,11,1,7,4,8,10,)
    namedValues = namedval.NamedValues(("other", 1), ("port", 10), ("stack", 11), ("cpu", 12), ("unknown", 2), ("chassis", 3), ("backplane", 4), ("container", 5), ("powerSupply", 6), ("fan", 7), ("sensor", 8), ("module", 9), )
    pass
