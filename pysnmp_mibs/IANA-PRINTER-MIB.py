...
# by libsmi2pysnmp-0.1.1 at Sun Nov  6 01:15:37 2011,
...
class PrtAlertCodeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(16,32,14,19,9,30,506,20,1106,902,808,501,901,36,23,1004,1502,6,804,5,13,803,1303,1115,1509,802,1001,1110,35,812,28,24,27,1102,504,26,3,1301,502,811,1113,15,904,807,22,21,11,813,7,29,1105,2,1101,810,1003,8,1304,1801,31,1114,505,1111,1103,1104,1302,1109,503,801,25,1108,4,1107,18,1112,10,1505,507,806,1005,1506,805,1501,1,33,809,38,12,1503,17,903,1507,34,1504,1002,37,)
...
class PrtAlertTrainingLevelTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(1,4,2,7,6,5,3,)
...
class PrtChannelTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(21,38,19,12,9,32,35,2,10,11,33,3,17,45,25,13,20,28,26,27,41,4,31,42,8,18,24,23,36,14,39,30,37,1,34,7,44,29,40,15,6,5,22,16,43,)
...
class PrtConsoleColorTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(9,7,8,6,2,1,5,10,3,4,)
...
class PrtCoverStatusTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(1,3,5,6,2,4,)
...
class PrtInputTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(3,1,5,7,2,6,4,)
...
class PrtInterpreterLangFamilyTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(57,13,52,39,15,42,47,60,17,14,28,21,33,4,49,6,45,8,64,61,31,2,58,53,10,3,16,7,48,63,1,9,35,24,11,32,38,65,20,27,43,34,18,54,25,62,29,59,50,46,30,36,40,26,19,23,5,37,22,12,51,44,56,55,41,)
...
class PrtMarkerSuppliesTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(33,14,12,28,13,8,4,9,32,23,29,7,5,30,24,26,10,11,22,27,18,34,6,17,2,31,19,15,1,16,3,25,20,21,)
...
class PrtMediaPathTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(1,5,2,3,4,)
...
class PrtOutputTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(1,4,5,7,2,3,6,)
