...
# by libsmi2pysnmp-0.0.9-alpha at Fri Jul  9 17:12:41 2010,
...
class LmpInterval(TextualConvention, Unsigned32):
    displayHint = "d"
    subtypeSpec = Unsigned32.subtypeSpec+constraint.ValueRangeConstraint(1,65535)
    pass
...
lmpAdminStatus = MibScalar((1, 3, 6, 1, 2, 1, 10, 227, 1, 1), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), )).clone(1)).setMaxAccess("readwrite")
...
lmpOperStatus = MibScalar((1, 3, 6, 1, 2, 1, 10, 227, 1, 2), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), ))).setMaxAccess("readonly")
...
lmpNbrAdminStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 3, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), ))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: lmpNbrAdminStatus.setDescription("The desired operational status of LMP to this remote node.")
lmpNbrOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 3, 1, 6), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), ))).setMaxAccess("readonly")
...
lmpCcId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 10, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
lmpCcSetupRole = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 10, 1, 8), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,)).subtype(namedValues=namedval.NamedValues(("active", 1), ("passive", 2), )).clone(1)).setMaxAccess("readcreate")
...
lmpCcAdminStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 10, 1, 19), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), ))).setMaxAccess("readcreate")
if mibBuilder.loadTexts: lmpCcAdminStatus.setDescription("The desired operational status of this control channel.")
lmpCcOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 10, 1, 20), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,6,1,2,5,4,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), ("configSnd", 3), ("configRcv", 4), ("active", 5), ("goingDown", 6), ))).setMaxAccess("readonly")
...
lmpTeLinkOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 12, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,1,2,4,5,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), ("testing", 3), ("init", 4), ("degraded", 5), ))).setMaxAccess("readonly")
...
lmpLinkVerifyTransportMechanism = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 14, 1, 3), Bits().subtype(namedValues=namedval.NamedValues(("payload", 0), ("dccSectionOverheadBytes", 1), ("dccLineOverheadBytes", 2), ("j0Trace", 3), ("j1Trace", 4), ("j2Trace", 5), ))).setMaxAccess("readcreate")
...
lmpDataLinkType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 16, 1, 1), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("port", 1), ("componentLink", 2), ))).setMaxAccess("readonly")
...
lmpDataLinkActiveOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 16, 1, 7), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,2,4,1,)).subtype(namedValues=namedval.NamedValues(("upAlloc", 1), ("upFree", 2), ("down", 3), ("testing", 4), ))).setMaxAccess("readonly")
...
lmpDataLinkPassiveOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 227, 1, 16, 1, 8), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,4,2,1,)).subtype(namedValues=namedval.NamedValues(("upAlloc", 1), ("upFree", 2), ("down", 3), ("psvTst", 4), ))).setMaxAccess("readonly")
...
# Notifications
mibBuilder.exportSymbols("LMP-MIB", lmpTeLinkNotDegraded=lmpTeLinkNotDegraded, lmpUnprotected=lmpUnprotected, lmpTeLinkPropertyMismatch=lmpTeLinkPropertyMismatch, lmpDataLinkVerificationFailure=lmpDataLinkVerificationFailure, lmpDataLinkPropertyMismatch=lmpDataLinkPropertyMismatch, lmpControlChannelDown=lmpControlChannelDown, lmpControlChannelUp=lmpControlChannelUp, lmpTeLinkDegraded=lmpTeLinkDegraded)

# Groups
mibBuilder.exportSymbols("LMP-MIB", lmpLinkPropertyCorrelationGroup=lmpLinkPropertyCorrelationGroup, lmpCcIsInterfaceGroup=lmpCcIsInterfaceGroup, lmpLinkVerificationGroup=lmpLinkVerificationGroup, lmpDataLinkGroup=lmpDataLinkGroup, lmpNotificationGroup=lmpNotificationGroup, lmpControlChannelGroup=lmpControlChannelGroup, lmpPerfGroup=lmpPerfGroup, lmpNodeGroup=lmpNodeGroup, lmpCcIsNotInterfaceGroup=lmpCcIsNotInterfaceGroup, lmpTeLinkGroup=lmpTeLinkGroup)
