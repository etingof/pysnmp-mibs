...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:26:33 2015
...
( TimeInterval, TimeStamp, DisplayString, TextualConvention, ) = mibBuilder.importSymbols("SNMPv2-TC", "TimeInterval", "TimeStamp", "DisplayString", "TextualConvention")
...
potType = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("automatic-drip", 1), ("percolator", 2), ("french-press", 3), ("espresso", 4),))).setMaxAccess("readwrite")
...
potOperStatus = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 6, 1), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5,)).clone(namedValues=NamedValues(("off", 1), ("brewing", 2), ("holding", 3), ("other", 4), ("waiting", 5),))).setMaxAccess("readonly")
...
potMetric = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 6, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5,)).clone(namedValues=NamedValues(("espresso", 1), ("demi-tasse", 2), ("cup", 3), ("mug", 4), ("bucket", 5),))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("COFFEE-POT-MIB", potName=potName, potCapacity=potCapacity, potOperStatus=potOperStatus, potLevel=potLevel, coffee=coffee, potTemperature=potTemperature, potType=potType, lastStartTime=lastStartTime, potMetric=potMetric, PYSNMP_MODULE_ID=coffee, potStartTime=potStartTime, potLocation=potLocation, potMonitor=potMonitor)
