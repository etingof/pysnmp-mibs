...
potType = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,4,3,1,)).subtype(namedValues=namedval.NamedValues(("automatic-drip", 1), ("percolator", 2), ("french-press", 3), ("espresso", 4), ))).setMaxAccess("readwrite")
...
potMetric = MibScalar((1, 3, 6, 1, 2, 1, 10, 132, 6, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,5,1,4,2,)).subtype(namedValues=namedval.NamedValues(("espresso", 1), ("demi-tasse", 2), ("cup", 3), ("mug", 4), ("bucket", 5), ))).setMaxAccess("readonly")
