...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:13:25 2006,
...
marsClientRegistration = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 1, 1, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,3,4,5,)).subtype(namedValues=namedval.NamedValues(("notRegistered", 1), ("registering", 2), ("registered", 3), ("reRegisteringFault", 4), ("reRegisteringRedirMap", 5), ))).setMaxAccess("readcreate")
...
marsClientFailureTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 1, 1, 1, 8), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L)).clone(10)).setMaxAccess("readcreate")
...
marsClientJoinLeaveRetrInterval = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 1, 1, 1, 12), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(5, 2147483647L)).clone(10)).setMaxAccess("readcreate")
...
marsClientForceWaitTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 1, 1, 1, 15), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readcreate")
...
marsClientIdleTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 1, 1, 1, 17), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L)).clone(20)).setMaxAccess("readcreate")
...
marsClientVcIdleTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 1, 4, 1, 9), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L)).clone(20)).setMaxAccess("readcreate")
...
marsServStatus = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 2, 1, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,3,)).subtype(namedValues=namedval.NamedValues(("active", 1), ("inactive", 2), ("faulted", 3), ))).setMaxAccess("readcreate")
...
marsVcIdleTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 2, 5, 1, 9), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L)).clone(20)).setMaxAccess("readcreate")
...
marsMcsRegistration = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 3, 1, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,3,4,5,)).subtype(namedValues=namedval.NamedValues(("notRegistered", 1), ("registering", 2), ("registered", 3), ("reRegisteringFault", 4), ("reRegisteringRedirMap", 5), ))).setMaxAccess("readcreate")
...
marsMcsFailureTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 3, 1, 1, 8), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L)).clone(10)).setMaxAccess("readcreate")
...
marsMcsRegisterRetrInterval = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 3, 1, 1, 12), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(5, 2147483647L)).clone(10)).setMaxAccess("readcreate")
...
marsMcsForceWaitTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 3, 1, 1, 15), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readcreate")
...
marsMcsIdleTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 3, 1, 1, 17), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L)).clone(20)).setMaxAccess("readcreate")
...
marsMcsVcIdleTimer = MibTableColumn((1, 3, 6, 1, 6, 3, 17, 3, 4, 1, 9), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L)).clone(20)).setMaxAccess("readcreate")
