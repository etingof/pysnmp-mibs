...
class AtmConnCastType(Integer):
    ...
    namedValues = Integer.namedValues.clone(("p2p", 1), ("p2mpRoot", 2), ("p2mpLeaf", 3), )
    pass
...
class AtmIlmiNetworkPrefix(OctetString):
    subtypeConstraints = OctetString.subtypeConstraints + ( subtypes.ValueRangeConstraint(13, 13), )
    pass

class AtmInterfaceType(Integer):
    subtypeConstraints = Integer.subtypeConstraints + ( subtypes.SingleValueConstraint(4,5,8,7,12,10,1,3,13,11,9,2,6,), )
    namedValues = Integer.namedValues.clone(("other", 1), ("atmfPnni1Dot0", 10), ("atmfBici2Dot0", 11), ("atmfUniPvcOnly", 12), ("atmfNniPvcOnly", 13), ("autoConfig", 2), ("ituDss2", 3), ("atmfUni3Dot0", 4), ("atmfUni3Dot1", 5), ("atmfUni4Dot0", 6), ("atmfIispUni3Dot0", 7), ("atmfIispUni3Dot1", 8), ("atmfIispUni4Dot0", 9), )
    pass

class AtmServiceCategory(Integer):
    subtypeConstraints = Integer.subtypeConstraints + ( subtypes.SingleValueConstraint(2,5,1,6,3,4,), )
    namedValues = Integer.namedValues.clone(("other", 1), ("cbr", 2), ("rtVbr", 3), ("nrtVbr", 4), ("abr", 5), ("ubr", 6), )
    pass
...
class AtmVorXAdminStatus(Integer):
    ...
    namedValues = Integer.namedValues.clone(("up", 1), ("down", 2), )
    pass
...
class AtmVorXOperStatus(Integer):
    subtypeConstraints = Integer.subtypeConstraints + ( subtypes.SingleValueConstraint(2,3,1,), )
    namedValues = Integer.namedValues.clone(("up", 1), ("down", 2), ("unknown", 3), )
    pass

class AtmVpIdentifier(Integer32):
    subtypeConstraints = Integer32.subtypeConstraints + ( subtypes.ValueRangeConstraint(0, 4095), )
    pass
