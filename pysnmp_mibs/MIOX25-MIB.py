...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:51:01 2006,
...
mioxPeerStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 38, 2, 1, 1, 2), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,5,6,4,2,1,)).subtype(namedValues=namedval.NamedValues(("valid", 1), ("createRequest", 2), ("underCreation", 3), ("invalid", 4), ("clearCall", 5), ("makeCall", 6), ))).setMaxAccess("readwrite")
...
mioxPeerX25CallParamId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 38, 2, 1, 1, 6), InstancePointer().clone((0,0))).setMaxAccess("readwrite")
...
mioxPeerX25CircuitId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 38, 2, 1, 1, 9), InstancePointer().clone((0,0))).setMaxAccess("readwrite")
