...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:25:49 2015
...
aggrCtlCompressionAlgorithm = MibTableColumn((1, 3, 6, 1, 3, 123, 1, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2,)).clone(namedValues=NamedValues(("none", 1), ("deflate", 2),)).clone('none')).setMaxAccess("readcreate")
...
mibBuilder.exportSymbols("AGGREGATE-MIB", aggrCtlTable=aggrCtlTable, aggrDataRecord=aggrDataRecord, aggrMibBasicGroup=aggrMibBasicGroup, aggrCtlMOIndex=aggrCtlMOIndex, aggrMIB=aggrMIB, aggrMOTable=aggrMOTable, AggrMOErrorStatus=AggrMOErrorStatus, aggrCtlEntryOwner=aggrCtlEntryOwner, aggrMOEntry=aggrMOEntry, aggrDataTable=aggrDataTable, aggrDataErrorRecord=aggrDataErrorRecord, aggrCtlCompressionAlgorithm=aggrCtlCompressionAlgorithm, aggrCtlEntryID=aggrCtlEntryID, aggrCtlEntryStatus=aggrCtlEntryStatus, aggrMOEntryID=aggrMOEntryID, PYSNMP_MODULE_ID=aggrMIB, aggrMODescr=aggrMODescr, aggrCompliances=aggrCompliances, aggrMOEntryMOID=aggrMOEntryMOID, aggrCtlEntryStorageType=aggrCtlEntryStorageType, AggrMOCompressedValue=AggrMOCompressedValue, aggrDataRecordCompressed=aggrDataRecordCompressed, aggrCtlMODescr=aggrCtlMODescr, aggrDataEntry=aggrDataEntry, aggrMOInstance=aggrMOInstance, aggrMibCompliance=aggrMibCompliance, aggrCtlEntry=aggrCtlEntry, AggrMOValue=AggrMOValue, aggrGroups=aggrGroups, aggrMOEntryStatus=aggrMOEntryStatus, aggrConformance=aggrConformance, aggrMOEntryStorageType=aggrMOEntryStorageType)
