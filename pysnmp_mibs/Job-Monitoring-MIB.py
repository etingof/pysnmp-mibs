...
class JmAttributeTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(90,51,74,175,115,52,93,174,22,6,94,36,23,38,195,70,54,170,171,151,114,8,55,132,1,173,56,150,7,172,113,75,76,112,9,192,190,111,25,95,91,29,34,50,152,193,194,31,96,32,26,30,92,73,4,3,72,5,110,130,21,35,53,20,77,28,71,131,97,33,27,24,191,37,)
...
class JmJobStateTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(6,2,9,5,7,8,4,3,)
...
class JmPrintQualityTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(5,2,4,1,3,)
...
jmJobSubmissionID = MibTableColumn((1, 3, 6, 1, 4, 1, 2699, 1, 1, 1, 2, 1, 1, 1), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(48, 48)).setFixedLength()).setMaxAccess("noaccess")
