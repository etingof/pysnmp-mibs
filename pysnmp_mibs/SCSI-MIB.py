...
class ScsiDeviceOrPort(Integer):
    ...
    namedValues = namedval.NamedValues(("device", 1), ("port", 2), ("other", 3), )
    pass
...
class ScsiIdAssociation(TextualConvention, Unsigned32):
    displayHint = "d"
    subtypeSpec = Unsigned32.subtypeSpec+constraint.ValueRangeConstraint(0,3)
    pass

class ScsiIdCodeSet(TextualConvention, Unsigned32):
    displayHint = "d"
    subtypeSpec = Unsigned32.subtypeSpec+constraint.ValueRangeConstraint(0,15)
    pass
...
class ScsiIdentifier(OctetString):
    subtypeSpec = OctetString.subtypeSpec+constraint.ValueSizeConstraint(0,262)
    pass
...
class ScsiLUN(OctetString):
    subtypeSpec = OctetString.subtypeSpec+constraint.ConstraintsUnion(constraint.ValueSizeConstraint(2,2),constraint.ValueSizeConstraint(8,8),)
    pass

class ScsiLuNameOrZero(OctetString):
    subtypeSpec = OctetString.subtypeSpec+constraint.ConstraintsUnion(constraint.ValueSizeConstraint(0,0),constraint.ValueSizeConstraint(8,8),)
    pass
...
scsiInstAlias = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 1, 1, 1, 2), SnmpAdminString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 79))).setMaxAccess("readwrite")
...
scsiDeviceAlias = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 1, 2, 1, 2), SnmpAdminString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 79))).setMaxAccess("readwrite")
...
scsiDeviceRole = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 1, 2, 1, 3), Bits().subtype(namedValues=namedval.NamedValues(("target", 0), ("initiator", 1), ))).setMaxAccess("readonly")
...
scsiPortRole = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 1, 3, 1, 2), Bits().subtype(namedValues=namedval.NamedValues(("target", 0), ("initiator", 1), ))).setMaxAccess("readonly")
...
scsiIntrDevTgtAccessMode = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 2, 1, 1, 1), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,3,)).subtype(namedValues=namedval.NamedValues(("unknown", 1), ("autoEnable", 2), ("manualEnable", 3), ))).setMaxAccess("readwrite")
...
scsiTgtDeviceStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 3, 1, 1, 2), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,3,4,6,7,1,8,5,)).subtype(namedValues=namedval.NamedValues(("unknown", 1), ("available", 2), ("broken", 3), ("readying", 4), ("abnormal", 5), ("nonAddrFailure", 6), ("nonAddrFailReadying", 7), ("nonAddrFailAbnormal", 8), ))).setMaxAccess("readonly")
...
scsiLuStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 4, 1, 1, 8), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,6,4,5,3,)).subtype(namedValues=namedval.NamedValues(("unknown", 1), ("available", 2), ("notAvailable", 3), ("broken", 4), ("readying", 5), ("abnormal", 6), ))).setMaxAccess("readonly")
...
scsiLuState = MibTableColumn((1, 3, 6, 1, 2, 1, 139, 2, 4, 1, 1, 9), Bits().subtype(namedValues=namedval.NamedValues(("dataLost", 0), ("dynamicReconfigurationInProgress", 1), ("verifyInProgress", 10), ("exposed", 2), ("fractionallyExposed", 3), ("partiallyExposed", 4), ("protectedRebuild", 5), ("protectionDisabled", 6), ("rebuild", 7), ("recalculate", 8), ("spareInUse", 9), ))).setMaxAccess("readonly")
...
# Notifications
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged)

# Groups
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevLuNotificationsGroup=scsiTgtDevLuNotificationsGroup, scsiInitiatorDevHSStatsGroup=scsiInitiatorDevHSStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorDeviceGroup=scsiInitiatorDeviceGroup, scsiTargetDevHSStatsGroup=scsiTargetDevHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTargetDevStatsGroup=scsiTargetDevStatsGroup, scsiTargetDeviceGroup=scsiTargetDeviceGroup, scsiInitiatorDevStatsGroup=scsiInitiatorDevStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup)
