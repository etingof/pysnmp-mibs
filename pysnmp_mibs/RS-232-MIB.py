...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:13:38 2006,
...
rs232AsyncPortStopBits = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 33, 3, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,4,2,1,)).subtype(namedValues=namedval.NamedValues(("one", 1), ("two", 2), ("oneAndHalf", 3), ("dynamic", 4), ))).setMaxAccess("readwrite")
...
rs232SyncPortMode = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 33, 4, 1, 12), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,4,1,3,)).subtype(namedValues=namedval.NamedValues(("fdx", 1), ("hdx", 2), ("simplex-receive", 3), ("simplex-send", 4), )).clone(1)).setMaxAccess("readwrite")
