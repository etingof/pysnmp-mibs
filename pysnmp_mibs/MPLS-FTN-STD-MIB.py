...
mplsFTNMask = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 3, 1, 4)).setColumnInitializer(MibVariable((), Bits().subtype(namedValues=namedval.NamedValues(("sourceAddr", 0), ("destAddr", 1), ("sourcePort", 2), ("destPort", 3), ("protocol", 4), ("dscp", 5), ))).setMaxAccess("readwrite"))
...
mplsFTNProtocol = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 3, 1, 14)).setColumnInitializer(MibVariable((), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 255)).clone(255)).setMaxAccess("readwrite"))
mplsFTNDscp = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 3, 1, 15)).setColumnInitializer(MibVariable((), Dscp()).setMaxAccess("readwrite"))
mplsFTNActionType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 3, 1, 16)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("redirectLsp", 1), ("redirectTunnel", 2), ))).setMaxAccess("readwrite"))
...
mplsFTNMapRowStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 8, 1, 5, 1, 4)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,6,4,)).subtype(namedValues=namedval.NamedValues(("active", 1), ("createAndGo", 4), ("destroy", 6), ))).setMaxAccess("readwrite"))
