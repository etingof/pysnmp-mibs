...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:32:54 2015
...
class TripAddressFamily(Integer32, TextualConvention):
    subtypeSpec = Integer32.subtypeSpec+SingleValueConstraint(1, 2, 3, 255,)
    namedValues = NamedValues(("decimal", 1), ("pentadecimal", 2), ("e164", 3), ("other", 255),)

class TripAppProtocol(Integer32, TextualConvention):
    subtypeSpec = Integer32.subtypeSpec+SingleValueConstraint(1, 2, 3, 4, 255,)
...
mibBuilder.exportSymbols("TRIP-TC-MIB", TripCommunityId=TripCommunityId, tripTC=tripTC, TripSendReceiveMode=TripSendReceiveMode, PYSNMP_MODULE_ID=tripTC, TripAddressFamily=TripAddressFamily, TripId=TripId, TripProtocolVersion=TripProtocolVersion, TripItad=TripItad, TripAppProtocol=TripAppProtocol)
