...
ospfSetTrap = MibVariable((1, 3, 6, 1, 2, 1, 14, 16, 1, 1), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(4, 4))).setMaxAccess("readwrite")
ospfConfigErrorType = MibVariable((1, 3, 6, 1, 2, 1, 14, 16, 1, 2), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,9,1,6,4,10,8,2,5,7,)).subtype(namedValues=namedval.NamedValues(("badVersion", 1), ("optionMismatch", 10), ("areaMismatch", 2), ("unknownNbmaNbr", 3), ("unknownVirtualNbr", 4), ("authTypeMismatch", 5), ("authFailure", 6), ("netMaskMismatch", 7), ("helloIntervalMismatch", 8), ("deadIntervalMismatch", 9), ))).setMaxAccess("readonly")
ospfPacketType = MibVariable((1, 3, 6, 1, 2, 1, 14, 16, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(5,3,4,2,1,)).subtype(namedValues=namedval.NamedValues(("hello", 1), ("dbDescript", 2), ("lsReq", 3), ("lsUpdate", 4), ("lsAck", 5), ))).setMaxAccess("readonly")
