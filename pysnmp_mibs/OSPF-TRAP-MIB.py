...
( Bits, Integer32, IpAddress, ModuleIdentity, MibIdentifier, NotificationType, MibVariable, MibTable, MibTableRow, MibTableColumn, TimeTicks, ) = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "IpAddress", "ModuleIdentity", "MibIdentifier", "NotificationType", "MibVariable", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")

# Objects

ospfTrap = ModuleIdentity((1, 3, 6, 1, 2, 1, 14, 16))
ospfTrapControl = MibIdentifier((1, 3, 6, 1, 2, 1, 14, 16, 1))
ospfSetTrap = MibVariable((1, 3, 6, 1, 2, 1, 14, 16, 1, 1), OctetString().addConstraints(subtypes.ValueRangeConstraint(4, 4))).setMaxAccess("readwrite")
ospfConfigErrorType = MibVariable((1, 3, 6, 1, 2, 1, 14, 16, 1, 2), Integer().addConstraints(subtypes.SingleValueConstraint(3,9,1,6,4,10,8,2,5,7,)).addNamedValues(("badVersion", 1), ("optionMismatch", 10), ("areaMismatch", 2), ("unknownNbmaNbr", 3), ("unknownVirtualNbr", 4), ("authTypeMismatch", 5), ("authFailure", 6), ("netMaskMismatch", 7), ("helloIntervalMismatch", 8), ("deadIntervalMismatch", 9), )).setMaxAccess("readonly")
ospfPacketType = MibVariable((1, 3, 6, 1, 2, 1, 14, 16, 1, 3), Integer().addConstraints(subtypes.SingleValueConstraint(5,3,4,2,1,)).addNamedValues(("hello", 1), ("dbDescript", 2), ("lsReq", 3), ("lsUpdate", 4), ("lsAck", 5), )).setMaxAccess("readonly")
ospfPacketSrc = MibVariable((1, 3, 6, 1, 2, 1, 14, 16, 1, 4), IpAddress()).setMaxAccess("readonly")
...
ospfVirtIfTxRetransmit = NotificationType((1, 3, 6, 1, 2, 1, 14, 16, 2, 11)).setObjects(("OSPF-MIB", "ospfVirtIfNeighbor"), ("OSPF-MIB", "ospfLsdbRouterId"), ("OSPF-TRAP-MIB", "ospfPacketType"), ("OSPF-MIB", "ospfVirtIfAreaId"), ("OSPF-MIB", "ospfLsdbLsid"), ("OSPF-MIB", "ospfRouterId"), ("OSPF-MIB", "ospfLsdbType"), )
...
ospfIfConfigError = NotificationType((1, 3, 6, 1, 2, 1, 14, 16, 2, 4)).setObjects(("OSPF-MIB", "ospfAddressLessIf"), ("OSPF-MIB", "ospfIfIpAddress"), ("OSPF-TRAP-MIB", "ospfPacketType"), ("OSPF-TRAP-MIB", "ospfConfigErrorType"), ("OSPF-MIB", "ospfRouterId"), ("OSPF-TRAP-MIB", "ospfPacketSrc"), )
ospfTxRetransmit = NotificationType((1, 3, 6, 1, 2, 1, 14, 16, 2, 10)).setObjects(("OSPF-MIB", "ospfLsdbRouterId"), ("OSPF-MIB", "ospfIfIpAddress"), ("OSPF-TRAP-MIB", "ospfPacketType"), ("OSPF-MIB", "ospfLsdbLsid"), ("OSPF-MIB", "ospfAddressLessIf"), ("OSPF-MIB", "ospfRouterId"), ("OSPF-MIB", "ospfLsdbType"), ("OSPF-MIB", "ospfNbrRtrId"), )
ospfIfAuthFailure = NotificationType((1, 3, 6, 1, 2, 1, 14, 16, 2, 6)).setObjects(("OSPF-MIB", "ospfAddressLessIf"), ("OSPF-MIB", "ospfIfIpAddress"), ("OSPF-TRAP-MIB", "ospfPacketType"), ("OSPF-TRAP-MIB", "ospfConfigErrorType"), ("OSPF-MIB", "ospfRouterId"), ("OSPF-TRAP-MIB", "ospfPacketSrc"), )
