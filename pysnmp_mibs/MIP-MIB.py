...
mipEntities = MibVariable((1, 3, 6, 1, 2, 1, 44, 1, 1, 1), Bits().subtype(namedValues=namedval.NamedValues(("mobileNode", 0), ("foreignAgent", 1), ("homeAgent", 2), ))).setMaxAccess("readonly")
mipEnable = MibVariable((1, 3, 6, 1, 2, 1, 44, 1, 1, 2), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("enabled", 1), ("disabled", 2), ))).setMaxAccess("readwrite")
mipEncapsulationSupported = MibVariable((1, 3, 6, 1, 2, 1, 44, 1, 1, 3), Bits().subtype(namedValues=namedval.NamedValues(("ipInIp", 0), ("gre", 1), ("minEnc", 2), ("other", 3), ))).setMaxAccess("readonly")
...
mipSecSPI = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 2, 1, 1, 2)).setColumnInitializer(MibVariable((), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 4294967295L))).setMaxAccess("noaccess"))
mipSecAlgorithmType = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 2, 1, 1, 3)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("md5", 2), ))).setMaxAccess("readwrite"))
mipSecAlgorithmMode = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 2, 1, 1, 4)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("prefixSuffix", 2), ))).setMaxAccess("readwrite"))
mipSecKey = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 2, 1, 1, 5)).setColumnInitializer(MibVariable((), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(16, 16))).setMaxAccess("readwrite"))
mipSecReplayMethod = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 2, 1, 1, 6)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,3,1,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("timestamps", 2), ("nonces", 3), ))).setMaxAccess("readwrite"))
...
mipSecRecentViolationReason = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 2, 3, 1, 7)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(5,6,3,2,1,4,)).subtype(namedValues=namedval.NamedValues(("noMobilitySecurityAssociation", 1), ("badAuthenticator", 2), ("badIdentifier", 3), ("badSPI", 4), ("missingSecurityExtension", 5), ("other", 6), ))).setMaxAccess("readonly"))
mipMN = MibIdentifier((1, 3, 6, 1, 2, 1, 44, 1, 3))
mnSystem = MibIdentifier((1, 3, 6, 1, 2, 1, 44, 1, 3, 1))
mnState = MibVariable((1, 3, 6, 1, 2, 1, 44, 1, 3, 1, 1), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(5,2,4,1,3,)).subtype(namedValues=namedval.NamedValues(("home", 1), ("registered", 2), ("pending", 3), ("isolated", 4), ("unknown", 5), ))).setMaxAccess("readonly")
...
mnAdvSequence = MibVariable((1, 3, 6, 1, 2, 1, 44, 1, 3, 2, 2, 2), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
mnAdvFlags = MibVariable((1, 3, 6, 1, 2, 1, 44, 1, 3, 2, 2, 3), Bits().subtype(namedValues=namedval.NamedValues(("vjCompression", 0), ("gre", 1), ("minEnc", 2), ("foreignAgent", 3), ("homeAgent", 4), ("busy", 5), ("regRequired", 6), ))).setMaxAccess("readonly")
mnAdvMaxRegLifetime = MibVariable((1, 3, 6, 1, 2, 1, 44, 1, 3, 2, 2, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 65535))).setMaxAccess("readonly").setUnits("seconds")
mnAdvMaxAdvLifetime = MibVariable((1, 3, 6, 1, 2, 1, 44, 1, 3, 2, 2, 5), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 65535))).setMaxAccess("readonly").setUnits("seconds")
...
maAdvMaxRegLifetime = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 4, 2, 1, 1, 2)).setColumnInitializer(MibVariable((), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 65535))).setMaxAccess("readwrite"))
...
maAdvMaxInterval = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 4, 2, 1, 1, 5)).setColumnInitializer(MibVariable((), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(4, 1800))).setMaxAccess("readwrite"))
maAdvMinInterval = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 4, 2, 1, 1, 6)).setColumnInitializer(MibVariable((), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(3, 1800))).setMaxAccess("readwrite"))
maAdvMaxAdvLifetime = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 4, 2, 1, 1, 7)).setColumnInitializer(MibVariable((), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(4, 9000))).setMaxAccess("readwrite"))
