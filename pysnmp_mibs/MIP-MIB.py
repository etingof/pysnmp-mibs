...
mipSecAlgorithmMode = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 2, 1, 1, 4), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("prefixSuffix", 2), ))).setMaxAccess("readcreate")
mipSecKey = MibTableColumn((1, 3, 6, 1, 2, 1, 44, 1, 2, 1, 1, 5), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(16, 16)).setFixedLength()).setMaxAccess("readcreate")
