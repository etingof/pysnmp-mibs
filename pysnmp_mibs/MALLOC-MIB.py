...
mallocCapabilities = MibVariable((1, 3, 6, 1, 2, 1, 101, 1, 1, 1), Bits().subtype(namedValues=namedval.NamedValues(("startTime", 0), ("serverMobility", 1), ("retryAfter", 2), ))).setMaxAccess("readonly")
...
mallocScopeFirstAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 2, 1, 2)).setColumnInitializer(MibVariable((), InetAddress().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 20))).setMaxAccess("noaccess"))
mallocScopeLastAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 2, 1, 3)).setColumnInitializer(MibVariable((), InetAddress().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 20))).setMaxAccess("readwrite"))
mallocScopeHopLimit = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 2, 1, 4)).setColumnInitializer(MibVariable((), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 255))).setMaxAccess("readwrite"))
...
mallocScopeNameLangName = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 3, 1, 1)).setColumnInitializer(MibVariable((), LanguageTag().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 94))).setMaxAccess("noaccess"))
...
mallocAllocRangeFirstAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 4, 1, 1)).setColumnInitializer(MibVariable((), InetAddress().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 20))).setMaxAccess("noaccess"))
mallocAllocRangeLastAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 4, 1, 2)).setColumnInitializer(MibVariable((), InetAddress().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 20))).setMaxAccess("readwrite"))
...
mallocRequestId = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 5, 1, 1)).setColumnInitializer(MibVariable((), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess"))
...
mallocRequestState = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 5, 1, 7)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,1,4,2,)).subtype(namedValues=namedval.NamedValues(("allocated", 1), ("offered", 2), ("waiting", 3), ("trying", 4), ))).setMaxAccess("readonly"))
...
mallocRequestLeaseIdentifier = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 5, 1, 12)).setColumnInitializer(MibVariable((), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 255))).setMaxAccess("readonly"))
...
mallocAddressFirstAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 101, 1, 1, 6, 1, 2)).setColumnInitializer(MibVariable((), InetAddress().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 20))).setMaxAccess("noaccess"))
...
madcapConfigResponseCacheInterval = MibVariable((1, 3, 6, 1, 2, 1, 101, 1, 2, 1, 4), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 300))).setMaxAccess("readwrite").setUnits("seconds")
