...
ipForwardMask = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 2)).setColumnInitializer(MibVariable((), IpAddress().clone("0.0.0.0")).setMaxAccess("readwrite"))
...
ipForwardIfIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 5)).setColumnInitializer(MibVariable((), Integer32().clone(0)).setMaxAccess("readwrite"))
ipForwardType = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 6)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(4,1,3,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("invalid", 2), ("local", 3), ("remote", 4), )).clone(2)).setMaxAccess("readwrite"))
ipForwardProto = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 7)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(14,12,3,13,5,8,10,15,11,1,9,4,2,7,6,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("es-is", 10), ("ciscoIgrp", 11), ("bbnSpfIgp", 12), ("ospf", 13), ("bgp", 14), ("idpr", 15), ("local", 2), ("netmgmt", 3), ("icmp", 4), ("egp", 5), ("ggp", 6), ("hello", 7), ("rip", 8), ("is-is", 9), ))).setMaxAccess("readonly"))
ipForwardAge = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 8)).setColumnInitializer(MibVariable((), Integer32().clone(0)).setMaxAccess("readonly"))
...
ipForwardNextHopAS = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 10)).setColumnInitializer(MibVariable((), Integer32().clone(0)).setMaxAccess("readwrite"))
ipForwardMetric1 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 11)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
ipForwardMetric2 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 12)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
ipForwardMetric3 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 13)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
ipForwardMetric4 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 14)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
ipForwardMetric5 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 2, 1, 15)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
...
ipCidrRouteIfIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 5)).setColumnInitializer(MibVariable((), Integer32().clone(0)).setMaxAccess("readwrite"))
ipCidrRouteType = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 6)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(4,1,3,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("reject", 2), ("local", 3), ("remote", 4), ))).setMaxAccess("readwrite"))
ipCidrRouteProto = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 7)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(10,9,3,13,16,5,8,14,15,11,1,12,4,2,7,6,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("esIs", 10), ("ciscoIgrp", 11), ("bbnSpfIgp", 12), ("ospf", 13), ("bgp", 14), ("idpr", 15), ("ciscoEigrp", 16), ("local", 2), ("netmgmt", 3), ("icmp", 4), ("egp", 5), ("ggp", 6), ("hello", 7), ("rip", 8), ("isIs", 9), ))).setMaxAccess("readonly"))
ipCidrRouteAge = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 8)).setColumnInitializer(MibVariable((), Integer32().clone(0)).setMaxAccess("readonly"))
...
ipCidrRouteNextHopAS = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 10)).setColumnInitializer(MibVariable((), Integer32().clone(0)).setMaxAccess("readwrite"))
ipCidrRouteMetric1 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 11)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
ipCidrRouteMetric2 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 12)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
ipCidrRouteMetric3 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 13)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
ipCidrRouteMetric4 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 14)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
ipCidrRouteMetric5 = MibTableColumn((1, 3, 6, 1, 2, 1, 4, 24, 4, 1, 15)).setColumnInitializer(MibVariable((), Integer32().clone(-1)).setMaxAccess("readwrite"))
