...
( Bits, Counter32, Gauge32, Integer32, Integer32, IpAddress, ModuleIdentity, MibIdentifier, MibVariable, MibTable, MibTableRow, MibTableColumn, TimeTicks, ) = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Gauge32", "Integer32", "Integer32", "IpAddress", "ModuleIdentity", "MibIdentifier", "MibVariable", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
class BigMetric(Integer32):
    subtypeConstraints = Integer32.subtypeConstraints + ( subtypes.ValueRangeConstraint(0, 16777215), )
    pass
...
class Status(Integer):
    ...
    namedValues = Integer.namedValues.clone(("enabled", 1), ("disabled", 2), )
    pass

class TOSType(Integer32):
    subtypeConstraints = Integer32.subtypeConstraints + ( subtypes.ValueRangeConstraint(0, 30), )
    pass

class UpToMaxAge(Integer32):
    subtypeConstraints = Integer32.subtypeConstraints + ( subtypes.ValueRangeConstraint(0, 3600), )
    pass
...
ospfVersionNumber = MibVariable((1, 3, 6, 1, 2, 1, 14, 1, 3), Integer().addConstraints(subtypes.SingleValueConstraint(2,)).addNamedValues(("version2", 2), )).setMaxAccess("readonly")
...
ospfExtLsdbLimit = MibVariable((1, 3, 6, 1, 2, 1, 14, 1, 11), Integer32().addConstraints(subtypes.ValueRangeConstraint(-1, 2147483647L)).set(-1)).setMaxAccess("readwrite")
ospfMulticastExtensions = MibVariable((1, 3, 6, 1, 2, 1, 14, 1, 12), Integer32().set(0)).setMaxAccess("readwrite")
...
ospfAuthType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 2, 1, 2)).setColumnInitializer(MibVariable((), Integer32().set(0)).setMaxAccess("readwrite"))
ospfImportAsExtern = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 2, 1, 3)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,3,)).addNamedValues(("importExternal", 1), ("importNoExternal", 2), ("importNssa", 3), ).set(1)).setMaxAccess("readwrite"))
...
ospfAreaLsaCksumSum = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 2, 1, 8)).setColumnInitializer(MibVariable((), Integer32().set(0)).setMaxAccess("readonly"))
ospfAreaSummary = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 2, 1, 9)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(2,1,)).addNamedValues(("noAreaSummary", 1), ("sendAreaSummary", 2), ).set(1)).setMaxAccess("readwrite"))
...
ospfStubMetricType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 3, 1, 5)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(3,2,1,)).addNamedValues(("ospfMetric", 1), ("comparableCost", 2), ("nonComparable", 3), ).set(1)).setMaxAccess("readwrite"))
...
ospfLsdbType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 4, 1, 2)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,3,4,5,7,2,6,)).addNamedValues(("routerLink", 1), ("networkLink", 2), ("summaryLink", 3), ("asSummaryLink", 4), ("asExternalLink", 5), ("multicastLink", 6), ("nssaExternalLink", 7), )).setMaxAccess("readonly"))
...
ospfLsdbAdvertisement = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 4, 1, 8)).setColumnInitializer(MibVariable((), OctetString().addConstraints(subtypes.ValueRangeConstraint(1, 65535))).setMaxAccess("readonly"))
...
ospfAreaRangeEffect = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 5, 1, 5)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,)).addNamedValues(("advertiseMatching", 1), ("doNotAdvertiseMatching", 2), ).set(1)).setMaxAccess("readwrite"))
...
ospfIfType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 4)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,5,3,)).addNamedValues(("broadcast", 1), ("nbma", 2), ("pointToPoint", 3), ("pointToMultipoint", 5), )).setMaxAccess("readwrite"))
...
ospfIfState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 12)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,5,3,6,2,7,4,)).addNamedValues(("down", 1), ("loopback", 2), ("waiting", 3), ("pointToPoint", 4), ("designatedRouter", 5), ("backupDesignatedRouter", 6), ("otherDesignatedRouter", 7), ).set(1)).setMaxAccess("readonly"))
ospfIfDesignatedRouter = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 13)).setColumnInitializer(MibVariable((), IpAddress().set("0.0.0.0")).setMaxAccess("readonly"))
ospfIfBackupDesignatedRouter = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 14)).setColumnInitializer(MibVariable((), IpAddress().set("0.0.0.0")).setMaxAccess("readonly"))
ospfIfEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 15)).setColumnInitializer(MibVariable((), Counter32()).setMaxAccess("readonly"))
ospfIfAuthKey = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 16)).setColumnInitializer(MibVariable((), OctetString().addConstraints(subtypes.ValueRangeConstraint(0, 256)).set('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readwrite"))
ospfIfStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 17)).setColumnInitializer(MibVariable((), RowStatus()).setMaxAccess("readwrite"))
ospfIfMulticastForwarding = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 18)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(3,1,2,)).addNamedValues(("blocked", 1), ("multicast", 2), ("unicast", 3), ).set(1)).setMaxAccess("readwrite"))
ospfIfDemand = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 19)).setColumnInitializer(MibVariable((), TruthValue()).setMaxAccess("readwrite"))
ospfIfAuthType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 20)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 255)).set(0)).setMaxAccess("readwrite"))
...
ospfVirtIfState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 7)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,4,)).addNamedValues(("down", 1), ("pointToPoint", 4), ).set(1)).setMaxAccess("readonly"))
ospfVirtIfEvents = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 8)).setColumnInitializer(MibVariable((), Counter32()).setMaxAccess("readonly"))
ospfVirtIfAuthKey = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 9)).setColumnInitializer(MibVariable((), OctetString().addConstraints(subtypes.ValueRangeConstraint(0, 256)).set('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readwrite"))
ospfVirtIfStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 10)).setColumnInitializer(MibVariable((), RowStatus()).setMaxAccess("readwrite"))
ospfVirtIfAuthType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 11)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 255)).set(0)).setMaxAccess("readwrite"))
...
ospfNbrOptions = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 4)).setColumnInitializer(MibVariable((), Integer32().set(0)).setMaxAccess("readonly"))
...
ospfNbrState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 6)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,5,3,7,2,8,6,4,)).addNamedValues(("down", 1), ("attempt", 2), ("init", 3), ("twoWay", 4), ("exchangeStart", 5), ("exchange", 6), ("loading", 7), ("full", 8), ).set(1)).setMaxAccess("readonly"))
...
ospfNbmaNbrPermanence = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 10)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(2,1,)).addNamedValues(("dynamic", 1), ("permanent", 2), ).set(2)).setMaxAccess("readonly"))
...
ospfVirtNbrState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 11, 1, 5)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,5,3,7,2,8,6,4,)).addNamedValues(("down", 1), ("attempt", 2), ("init", 3), ("twoWay", 4), ("exchangeStart", 5), ("exchange", 6), ("loading", 7), ("full", 8), )).setMaxAccess("readonly"))
...
ospfExtLsdbType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 12, 1, 1)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(5,)).addNamedValues(("asExternalLink", 5), )).setMaxAccess("readonly"))
...
ospfExtLsdbAdvertisement = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 12, 1, 7)).setColumnInitializer(MibVariable((), OctetString().addConstraints(subtypes.ValueRangeConstraint(36, 36))).setMaxAccess("readonly"))
...
ospfAreaAggregateLsdbType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 14, 1, 2)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(7,3,)).addNamedValues(("summaryLink", 3), ("nssaExternalLink", 7), )).setMaxAccess("readonly"))
...
ospfAreaAggregateEffect = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 14, 1, 6)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,)).addNamedValues(("advertiseMatching", 1), ("doNotAdvertiseMatching", 2), ).set(1)).setMaxAccess("readwrite"))
...
ospfExtLsdbGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 14, 15, 1, 12)).setObjects(("OSPF-MIB", "ospfExtLsdbType"), ("OSPF-MIB", "ospfExtLsdbChecksum"), ("OSPF-MIB", "ospfExtLsdbAdvertisement"), ("OSPF-MIB", "ospfExtLsdbAge"), ("OSPF-MIB", "ospfExtLsdbRouterId"), ("OSPF-MIB", "ospfExtLsdbSequence"), ("OSPF-MIB", "ospfExtLsdbLsid"), )
...
ospfIfGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 14, 15, 1, 7)).setObjects(("OSPF-MIB", "ospfIfEvents"), ("OSPF-MIB", "ospfIfAdminStat"), ("OSPF-MIB", "ospfIfStatus"), ("OSPF-MIB", "ospfIfIpAddress"), ("OSPF-MIB", "ospfIfRtrPriority"), ("OSPF-MIB", "ospfIfTransitDelay"), ("OSPF-MIB", "ospfIfState"), ("OSPF-MIB", "ospfIfAuthKey"), ("OSPF-MIB", "ospfIfDesignatedRouter"), ("OSPF-MIB", "ospfAddressLessIf"), ("OSPF-MIB", "ospfIfDemand"), ("OSPF-MIB", "ospfIfPollInterval"), ("OSPF-MIB", "ospfIfMulticastForwarding"), ("OSPF-MIB", "ospfIfAuthType"), ("OSPF-MIB", "ospfIfBackupDesignatedRouter"), ("OSPF-MIB", "ospfIfType"), ("OSPF-MIB", "ospfIfAreaId"), ("OSPF-MIB", "ospfIfHelloInterval"), ("OSPF-MIB", "ospfIfRetransInterval"), ("OSPF-MIB", "ospfIfRtrDeadInterval"), )
...
ospfAreaAggregateGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 14, 15, 1, 13)).setObjects(("OSPF-MIB", "ospfAreaAggregateEffect"), ("OSPF-MIB", "ospfAreaAggregateMask"), ("OSPF-MIB", "ospfAreaAggregateLsdbType"), ("OSPF-MIB", "ospfAreaAggregateStatus"), ("OSPF-MIB", "ospfAreaAggregateNet"), ("OSPF-MIB", "ospfAreaAggregateAreaID"), )
ospfBasicGroup = ObjectGroup((1, 3, 6, 1, 2, 1, 14, 15, 1, 1)).setObjects(("OSPF-MIB", "ospfExitOverflowInterval"), ("OSPF-MIB", "ospfExternLsaCksumSum"), ("OSPF-MIB", "ospfASBdrRtrStatus"), ("OSPF-MIB", "ospfVersionNumber"), ("OSPF-MIB", "ospfRxNewLsas"), ("OSPF-MIB", "ospfTOSSupport"), ("OSPF-MIB", "ospfDemandExtensions"), ("OSPF-MIB", "ospfExternLsaCount"), ("OSPF-MIB", "ospfExtLsdbLimit"), ("OSPF-MIB", "ospfOriginateNewLsas"), ("OSPF-MIB", "ospfAreaBdrRtrStatus"), ("OSPF-MIB", "ospfAdminStat"), ("OSPF-MIB", "ospfMulticastExtensions"), ("OSPF-MIB", "ospfRouterId"), )
...
# Groups
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaGroup=ospfAreaGroup, ospfIfGroup=ospfIfGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostGroup=ospfHostGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrGroup=ospfNbrGroup)
