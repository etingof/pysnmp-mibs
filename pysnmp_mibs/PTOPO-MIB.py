...
# by libsmi2pysnmp-0.0.9-alpha at Fri Jul  9 17:12:44 2010,
...
class PtopoAddrSeenState(Integer):
    ...
    namedValues = namedval.NamedValues(("notUsed", 1), ("unknown", 2), ("oneAddr", 3), ("multiAddr", 4), )
    pass

class PtopoChassisId(OctetString):
    subtypeSpec = OctetString.subtypeSpec+constraint.ValueSizeConstraint(1,32)
    pass

class PtopoChassisIdType(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(2,1,3,4,5,)
    namedValues = namedval.NamedValues(("chasIdEntPhysicalAlias", 1), ("chasIdIfAlias", 2), ("chasIdPortEntPhysicalAlias", 3), ("chasIdMacAddress", 4), ("chasIdPtopoGenAddr", 5), )
    pass

class PtopoGenAddr(OctetString):
    subtypeSpec = OctetString.subtypeSpec+constraint.ValueSizeConstraint(0,20)
    pass
...
class PtopoPortIdType(Integer):
    ...
    namedValues = namedval.NamedValues(("portIdIfAlias", 1), ("portIdEntPhysicalAlias", 2), ("portIdMacAddr", 3), ("portIdPtopoGenAddr", 4), )
    pass
...
ptopoConnIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 79, 1, 1, 1, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("noaccess")
...
ptopoConfigTrapInterval = MibScalar((1, 3, 6, 1, 2, 1, 79, 1, 3, 1), Integer32().subtype(subtypeSpec=constraint.ConstraintsUnion(constraint.ValueRangeConstraint(0,0),constraint.ValueRangeConstraint(5,3600),)).clone(0)).setMaxAccess("readwrite").setUnits("seconds")
...
ptopoConfigMaxHoldTime = MibScalar((1, 3, 6, 1, 2, 1, 79, 1, 3, 2), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L)).clone(300)).setMaxAccess("readwrite").setUnits("seconds")
...
# Groups
mibBuilder.exportSymbols("PTOPO-MIB", ptopoDataGroup=ptopoDataGroup, ptopoGeneralGroup=ptopoGeneralGroup, ptopoNotificationsGroup=ptopoNotificationsGroup, ptopoConfigGroup=ptopoConfigGroup)
