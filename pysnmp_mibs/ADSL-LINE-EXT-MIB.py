...
adslLineGlitePowerState = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 3, 1, 17, 1, 4), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,4,2,3,)).subtype(namedValues=namedval.NamedValues(("none", 1), ("l0", 2), ("l1", 3), ("l3", 4), ))).setMaxAccess("readonly")
...
adslConfProfileLineType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 3, 1, 22, 1, 1), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,3,4,5,)).subtype(namedValues=namedval.NamedValues(("noChannel", 1), ("fastOnly", 2), ("interleavedOnly", 3), ("fastOrInterleaved", 4), ("fastAndInterleaved", 5), )).clone(2)).setMaxAccess("readcreate")
...
adslAtucThreshold15MinFailedFastR = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 3, 1, 23, 1, 1), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 900)).clone(0)).setMaxAccess("readcreate")
adslAtucThreshold15MinSesL = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 3, 1, 23, 1, 2), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 900)).clone(0)).setMaxAccess("readcreate")
adslAtucThreshold15MinUasL = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 3, 1, 23, 1, 3), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 900)).clone(0)).setMaxAccess("readcreate")
adslAturThreshold15MinSesL = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 3, 1, 23, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 900)).clone(0)).setMaxAccess("readcreate")
adslAturThreshold15MinUasL = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 94, 3, 1, 23, 1, 5), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 900)).clone(0)).setMaxAccess("readcreate")
