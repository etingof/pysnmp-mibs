...
class FinAttributeTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(3,15,13,82,20,162,81,31,19,80,50,8,10,17,83,40,160,14,100,5,16,12,9,7,18,161,130,11,4,1,30,6,)
...
class FinBindingTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(6,11,10,7,9,2,8,5,1,4,)
...
class FinFoldingTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(4,1,2,3,5,)
    namedValues = namedval.NamedValues(("other", 1), ("unknown", 2), ("zFold", 3), ("halfFold", 4), ("letterFold", 5), )
    
class FinPunchHoleTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(1,5,2,6,7,3,4,)
...
class FinStackOutputTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(1,6,2,4,5,)
...
class FinStitchingTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(4,8,9,6,5,10,2,1,7,)
