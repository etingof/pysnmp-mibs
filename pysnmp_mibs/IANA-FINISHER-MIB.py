...
class FinBindingTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(6,11,2,8,5,1,4,9,7,10,)
...
class FinDeviceTypeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(17,8,3,2,16,13,1,4,15,18,5,12,10,11,6,9,7,14,)
...
class FinEdgeTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(5,4,6,3,)
