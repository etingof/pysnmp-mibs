...
# by libsmi2pysnmp-0.0.7-alpha at Wed Feb  7 16:13:09 2007,
...
class CapacityUnit(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(16,4,17,8,3,)
...
class PrtCapacityUnitTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(16,2,19,4,1,17,8,3,18,)
...
class PrtChannelStateTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(4,3,1,)
...
class PrtMarkerCounterUnitTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(11,8,6,4,9,17,5,3,7,16,)
...
class PrtMarkerSuppliesSupplyUnitTC(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(11,15,2,14,13,4,19,1,17,8,3,7,18,16,12,)
...
prtLocalizationLanguage = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 7, 1, 1, 2), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(2, 2)).setFixedLength(2)).setMaxAccess("readonly")
prtLocalizationCountry = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 7, 1, 1, 3), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(2, 2)).setFixedLength(2)).setMaxAccess("readonly")
