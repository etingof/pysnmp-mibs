...
dsmonAggControlDescr = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 1, 5, 1, 2), SnmpAdminString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 64))).setMaxAccess("readwrite")
dsmonAggControlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 1, 5, 1, 3), OwnerString()).setMaxAccess("readwrite")
dsmonAggControlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 1, 5, 1, 4), RowStatus()).setMaxAccess("readwrite")
...
dsmonAggGroupDescr = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 1, 7, 1, 1), SnmpAdminString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 64))).setMaxAccess("readwrite")
dsmonAggGroupStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 1, 7, 1, 2), RowStatus()).setMaxAccess("readwrite")
...
dsmonStatsControlDataSource = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 2, 1, 1, 2), DataSource()).setMaxAccess("readwrite")
dsmonStatsControlAggProfile = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 2, 1, 1, 3), DsmonCounterAggProfileIndex()).setMaxAccess("readwrite")
...
dsmonStatsControlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 2, 1, 1, 6), OwnerString()).setMaxAccess("readwrite")
dsmonStatsControlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 2, 1, 1, 7), RowStatus()).setMaxAccess("readwrite")
...
dsmonPdistCtlDataSource = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 1, 1, 2), DataSource()).setMaxAccess("readwrite")
dsmonPdistCtlAggProfile = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 1, 1, 3), DsmonCounterAggProfileIndex()).setMaxAccess("readwrite")
dsmonPdistCtlMaxDesiredEntries = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 1, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readwrite")
...
dsmonPdistCtlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 1, 1, 9), OwnerString()).setMaxAccess("readwrite")
dsmonPdistCtlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 1, 1, 10), RowStatus()).setMaxAccess("readwrite")
...
dsmonPdistTopNCtlPdistIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 3, 1, 2), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 65535))).setMaxAccess("readwrite")
dsmonPdistTopNCtlRateBase = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 3, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,3,4,)).subtype(namedValues=namedval.NamedValues(("dsmonPdistTopNPkts", 1), ("dsmonPdistTopNOctets", 2), ("dsmonPdistTopNHCPkts", 3), ("dsmonPdistTopNHCOctets", 4), ))).setMaxAccess("readwrite")
dsmonPdistTopNCtlTimeRemaining = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 3, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L)).clone(1800)).setMaxAccess("readwrite")
...
dsmonPdistTopNCtlRequestedSize = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 3, 1, 7), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L)).clone(150)).setMaxAccess("readwrite")
...
dsmonPdistTopNCtlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 3, 1, 10), OwnerString()).setMaxAccess("readwrite")
dsmonPdistTopNCtlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 3, 3, 1, 11), RowStatus()).setMaxAccess("readwrite")
...
dsmonHostCtlDataSource = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 1, 1, 2), DataSource()).setMaxAccess("readwrite")
dsmonHostCtlAggProfile = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 1, 1, 3), DsmonCounterAggProfileIndex()).setMaxAccess("readwrite")
dsmonHostCtlMaxDesiredEntries = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 1, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readwrite")
dsmonHostCtlIPv4PrefixLen = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 1, 1, 5), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(8, 32)).clone(32)).setMaxAccess("readwrite")
dsmonHostCtlIPv6PrefixLen = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 1, 1, 6), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(8, 128)).clone(128)).setMaxAccess("readwrite")
...
dsmonHostCtlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 1, 1, 11), OwnerString()).setMaxAccess("readwrite")
dsmonHostCtlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 1, 1, 12), RowStatus()).setMaxAccess("readwrite")
...
dsmonHostTopNCtlHostIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 3, 1, 2), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 65535))).setMaxAccess("readwrite")
...
dsmonHostTopNCtlTimeRemaining = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 3, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L)).clone(1800)).setMaxAccess("readwrite")
...
dsmonHostTopNCtlRequestedSize = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 3, 1, 7), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L)).clone(150)).setMaxAccess("readwrite")
...
dsmonHostTopNCtlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 3, 1, 10), OwnerString()).setMaxAccess("readwrite")
dsmonHostTopNCtlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 4, 3, 1, 11), RowStatus()).setMaxAccess("readwrite")
...
dsmonMatrixCtlDataSource = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 1, 1, 2), DataSource()).setMaxAccess("readwrite")
dsmonMatrixCtlAggProfile = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 1, 1, 3), DsmonCounterAggProfileIndex()).setMaxAccess("readwrite")
dsmonMatrixCtlMaxDesiredEntries = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 1, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("readwrite")
...
dsmonMatrixCtlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 1, 1, 9), OwnerString()).setMaxAccess("readwrite")
dsmonMatrixCtlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 1, 1, 10), RowStatus()).setMaxAccess("readwrite")
...
dsmonMatrixTopNCtlMatrixIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 4, 1, 2), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 65535))).setMaxAccess("readwrite")
dsmonMatrixTopNCtlRateBase = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 4, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,3,4,)).subtype(namedValues=namedval.NamedValues(("dsmonMatrixTopNPkts", 1), ("dsmonMatrixTopNOctets", 2), ("dsmonMatrixTopNHCPkts", 3), ("dsmonMatrixTopNHCOctets", 4), ))).setMaxAccess("readwrite")
dsmonMatrixTopNCtlTimeRemaining = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 4, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L)).clone(1800)).setMaxAccess("readwrite")
...
dsmonMatrixTopNCtlRequestedSize = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 4, 1, 7), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L)).clone(150)).setMaxAccess("readwrite")
...
dsmonMatrixTopNCtlOwner = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 4, 1, 10), OwnerString()).setMaxAccess("readwrite")
dsmonMatrixTopNCtlStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 16, 26, 1, 6, 4, 1, 11), RowStatus()).setMaxAccess("readwrite")
