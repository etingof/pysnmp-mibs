...
mldInterfaceQuerier = MibTableColumn((1, 3, 6, 1, 2, 1, 91, 1, 1, 1, 5), InetAddressIPv6().subtype(subtypeSpec=constraint.ValueSizeConstraint(16, 16)).setFixedLength(16)).setMaxAccess("readonly")
...
mldCacheAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 91, 1, 2, 1, 1), InetAddressIPv6().subtype(subtypeSpec=constraint.ValueSizeConstraint(16, 16)).setFixedLength(16)).setMaxAccess("noaccess")
...
mldCacheLastReporter = MibTableColumn((1, 3, 6, 1, 2, 1, 91, 1, 2, 1, 4), InetAddressIPv6().subtype(subtypeSpec=constraint.ValueSizeConstraint(16, 16)).setFixedLength(16)).setMaxAccess("readonly")
