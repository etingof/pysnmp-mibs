...
class IANAipMRouteProtocol(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(10,4,3,6,12,9,5,8,1,7,2,11,)
...
class IANAipRouteProtocol(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(10,9,3,13,16,5,8,14,15,11,1,17,12,4,2,7,6,)
