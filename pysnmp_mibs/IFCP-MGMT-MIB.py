...
# by libsmi2pysnmp-0.0.9-alpha at Fri Jul  9 17:12:40 2010,
...
class IfcpAddressMode(Integer):
    ...
    namedValues = namedval.NamedValues(("addressTransparent", 1), ("addressTranslation", 2), )
    pass

class IfcpIpTOVorZero(TextualConvention, Unsigned32):
    displayHint = "d"
    subtypeSpec = Unsigned32.subtypeSpec+constraint.ValueRangeConstraint(0,3600)
    pass
...
class IfcpSessionStates(Integer):
    ...
    namedValues = namedval.NamedValues(("down", 1), ("openPending", 2), ("open", 3), )
    pass
...
ifcpLclGtwyInstIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("noaccess")
...
ifcpLclGtwyInstVersionMin = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1, 3), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 255))).setMaxAccess("readonly")
...
ifcpLclGtwyInstVersionMax = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1, 4), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 255))).setMaxAccess("readonly")
...
ifcpLclGtwyInstDescr = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1, 9), SnmpAdminString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 64)).clone('')).setMaxAccess("readwrite")
if mibBuilder.loadTexts: ifcpLclGtwyInstDescr.setDescription("A user-entered description for this iFCP Gateway.")
ifcpLclGtwyInstNumActiveSessions = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 1, 1, 1, 10), Gauge32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 4294967295L))).setMaxAccess("readonly")
...
ifcpSessionIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 1, 1, 1), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 2147483647L))).setMaxAccess("noaccess")
...
ifcpSessionDuration = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 230, 1, 2, 2, 1, 2), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 4294967295L))).setMaxAccess("readonly")
...
apply(ifcpSessionStatsEntry.setIndexNames, ifcpSessionAttributesEntry.getIndexNames())
ifcpSessionAttributesEntry.registerAugmentions(("IFCP-MGMT-MIB", "ifcpSessionLcStatsEntry"))
apply(ifcpSessionLcStatsEntry.setIndexNames, ifcpSessionAttributesEntry.getIndexNames())
...
# Groups
mibBuilder.exportSymbols("IFCP-MGMT-MIB", ifcpLclGatewayGroup=ifcpLclGatewayGroup, ifcpLclGatewaySessionGroup=ifcpLclGatewaySessionGroup, ifcpLclGatewaySessionLcStatsGroup=ifcpLclGatewaySessionLcStatsGroup, ifcpLclGatewaySessionStatsGroup=ifcpLclGatewaySessionStatsGroup)
