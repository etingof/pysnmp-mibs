...
atportZoneName = MibTableColumn((1, 3, 6, 1, 2, 1, 13, 3, 2, 1, 2), ATName().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 32))).setMaxAccess("noaccess")
...
nbpObject = MibTableColumn((1, 3, 6, 1, 2, 1, 13, 8, 1, 1, 2), ATName().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 32))).setMaxAccess("readwrite")
nbpType = MibTableColumn((1, 3, 6, 1, 2, 1, 13, 8, 1, 1, 3), ATName().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 32))).setMaxAccess("readwrite")
