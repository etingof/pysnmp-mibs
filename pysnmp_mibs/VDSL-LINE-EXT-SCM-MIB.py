...
# by libsmi2pysnmp-0.1.1 at Sun Nov  6 01:16:24 2011,
...
class VdslSCMBandId(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(7,6,1,4,5,2,3,)
    namedValues = namedval.NamedValues(("optionalBand", 1), ("firstDownstreamBand", 2), ("firstUpstreamBand", 3), ("secondDownstreamBand", 4), ("secondUpstreamBand", 5), ("thirdDownstreamBand", 6), ("thirdUpstreamBand", 7), )
...
vdslLineSCMConfProfileBandConstellationSize = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 228, 1, 1, 1, 1, 5), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 16))).setMaxAccess("readcreate")
...
vdslLineSCMPhysBandCurrConstellationSize = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 228, 1, 1, 2, 1, 5), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 16))).setMaxAccess("readonly")
...
vdslLineSCMPhysBandCurrAtn = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 228, 1, 1, 2, 1, 8), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 255))).setMaxAccess("readonly")
