...
# by libsmi2pysnmp-0.0.7-alpha at Wed Feb  7 16:13:06 2007,
...
optIfOTMnOpticalReach = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 133, 1, 1, 1, 1, 6), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,4,2,1,5,)).subtype(namedValues=namedval.NamedValues(("intraOffice", 1), ("shortHaul", 2), ("longHaul", 3), ("veryLongHaul", 4), ("ultraLongHaul", 5), ))).setMaxAccess("readonly")
