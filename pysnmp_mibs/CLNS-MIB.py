...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:26:32 2015
...
( Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, IpAddress, TimeTicks, Counter64, Unsigned32, iso, experimental, ModuleIdentity, ObjectIdentity, Bits, Counter32, Gauge32, ) = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "IpAddress", "TimeTicks", "Counter64", "Unsigned32", "iso", "experimental", "ModuleIdentity", "ObjectIdentity", "Bits", "Counter32", "Gauge32")
...
clnpForwarding = MibScalar((1, 3, 6, 1, 3, 1, 1, 1), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2,)).clone(namedValues=NamedValues(("is", 1), ("es", 2),))).setMaxAccess("readwrite")
...
clnpRouteType = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 22, 1, 8), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("other", 1), ("invalid", 2), ("direct", 3), ("remote", 4),))).setMaxAccess("readwrite")
...
clnpRouteProto = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 22, 1, 9), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 9, 11, 12, 13, 14,)).clone(namedValues=NamedValues(("other", 1), ("local", 2), ("netmgmt", 3), ("is-is", 9), ("ciscoIgrp", 11), ("bbnSpfIgp", 12), ("ospf", 13), ("bgp", 14),))).setMaxAccess("readonly")
...
clnpNetToMediaType = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 23, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("other", 1), ("invalid", 2), ("dynamic", 3), ("static", 4),))).setMaxAccess("readwrite")
...
clnpMediaToNetType = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 24, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("other", 1), ("invalid", 2), ("dynamic", 3), ("static", 4),))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("CLNS-MIB", clnpAdEntIfIndex=clnpAdEntIfIndex, clnpOutErrSegs=clnpOutErrSegs, clnpOutErrCongests=clnpOutErrCongests, clnpInErrHdrs=clnpInErrHdrs, clnpInErrInterferences=clnpInErrInterferences, clnpMediaToNetAge=clnpMediaToNetAge, clnpOutDiscards=clnpOutDiscards, clnpInAddrErrors=clnpInAddrErrors, clnpOutErrIncomps=clnpOutErrIncomps, clnpInReceives=clnpInReceives, clnpOutErrUnsRRs=clnpOutErrUnsRRs, clnpInErrSRBadPaths=clnpInErrSRBadPaths, clnpForwarding=clnpForwarding, clnpOutErrInterferences=clnpOutErrInterferences, clnpOutErrUnreachDsts=clnpOutErrUnreachDsts, clnpRouteProto=clnpRouteProto, clnpOutErrUnsVersions=clnpOutErrUnsVersions, clnpDefaultLifeTime=clnpDefaultLifeTime, clnpRouteMetric3=clnpRouteMetric3, clnpOutRequests=clnpOutRequests, clnpAdEntReasmMaxSize=clnpAdEntReasmMaxSize, clnpNetToMediaPhysAddress=clnpNetToMediaPhysAddress, clnpOutErrProcs=clnpOutErrProcs, clnpInErrUnreachDsts=clnpInErrUnreachDsts, clnpInErrUnsOptions=clnpInErrUnsOptions, esisESHins=esisESHins, clnpOutErrUnspecs=clnpOutErrUnspecs, clnpNetToMediaIfIndex=clnpNetToMediaIfIndex, clnpInErrUnknownDsts=clnpInErrUnknownDsts, clnpOutOpts=clnpOutOpts, esisISHouts=esisISHouts, clnpRouteEntry=clnpRouteEntry, clnpInErrUnsVersions=clnpInErrUnsVersions, clnpInErrDups=clnpInErrDups, clnpInErrSegs=clnpInErrSegs, clnpReasmTimeout=clnpReasmTimeout, clnpRouteMetric2=clnpRouteMetric2, clnpInOpts=clnpInOpts, clnpMediaToNetTable=clnpMediaToNetTable, clnpMediaToNetHoldTime=clnpMediaToNetHoldTime, clnpInErrCksums=clnpInErrCksums, clnpOutErrHopReassms=clnpOutErrHopReassms, clnpInDelivers=clnpInDelivers, clnpInErrSRSyntaxes=clnpInErrSRSyntaxes, clnpOutErrUnknownDsts=clnpOutErrUnknownDsts, clnpOutErrHops=clnpOutErrHops, clnpOutErrDups=clnpOutErrDups, clnpOutErrSRUnkAddrs=clnpOutErrSRUnkAddrs, clnpNetToMediaHoldTime=clnpNetToMediaHoldTime, echo=echo, clnpOutErrSRSyntaxes=clnpOutErrSRSyntaxes, clnpRouteMetric4=clnpRouteMetric4, clnpInErrSRUnspecs=clnpInErrSRUnspecs, clnpInErrUnsSRs=clnpInErrUnsSRs, clnpOutErrHdrs=clnpOutErrHdrs, clnpInErrors=clnpInErrors, clnpRouteMetric5=clnpRouteMetric5, clnpOutNoRoutes=clnpOutNoRoutes, clnpOutErrUnsSRs=clnpOutErrUnsSRs, clnpRouteNextHop=clnpRouteNextHop, clnpMediaToNetEntry=clnpMediaToNetEntry, clnpSegFails=clnpSegFails, clnpInErrProcs=clnpInErrProcs, clnpSegOKs=clnpSegOKs, clnpReasmReqds=clnpReasmReqds, ClnpAddress=ClnpAddress, clnpInDiscards=clnpInDiscards, clnpAddrTable=clnpAddrTable, clnpNetToMediaAge=clnpNetToMediaAge, clnpReasmOKs=clnpReasmOKs, clnpNetToMediaEntry=clnpNetToMediaEntry, clnpInErrHops=clnpInErrHops, clnp=clnp, es_is=es_is, clnpForwPDUs=clnpForwPDUs, clnpRouteInfo=clnpRouteInfo, clnpNetToMediaType=clnpNetToMediaType, clnpOutErrUnsSecurities=clnpOutErrUnsSecurities, clnpRouteType=clnpRouteType, clnpInErrUnspecs=clnpInErrUnspecs, clnpInErrUnsSecurities=clnpInErrUnsSecurities, clns=clns, clnpOutErrors=clnpOutErrors, clnpOutErrCksums=clnpOutErrCksums, clnpInErrIncomps=clnpInErrIncomps, clnpMediaToNetType=clnpMediaToNetType, clnpRouteDest=clnpRouteDest, esisISHins=esisISHins, clnpRoutingTable=clnpRoutingTable, clnpRoutingDiscards=clnpRoutingDiscards, clnpInErrHopReassms=clnpInErrHopReassms, clnpInUnknownULPs=clnpInUnknownULPs, clnpInErrSRUnkAddrs=clnpInErrSRUnkAddrs, esisRDUins=esisRDUins, clnpOutErrSRBadPaths=clnpOutErrSRBadPaths, clnpMediaToNetAddress=clnpMediaToNetAddress, clnpInUnknownNLPs=clnpInUnknownNLPs, clnpInHdrErrors=clnpInHdrErrors, clnpRouteMetric1=clnpRouteMetric1, esisRDUouts=esisRDUouts, clnpRouteAge=clnpRouteAge, clnpInErrUnsRRs=clnpInErrUnsRRs, clnpOutErrSRUnspecs=clnpOutErrSRUnspecs, clnpSegCreates=clnpSegCreates, clnpNetToMediaNetAddress=clnpNetToMediaNetAddress, error=error, clnpRouteIfIndex=clnpRouteIfIndex, clnpReasmFails=clnpReasmFails, esisESHouts=esisESHouts, clnpMediaToNetPhysAddress=clnpMediaToNetPhysAddress, clnpInErrCongests=clnpInErrCongests, clnpNetToMediaTable=clnpNetToMediaTable, clnpOutErrUnsOptions=clnpOutErrUnsOptions, clnpMediaToNetIfIndex=clnpMediaToNetIfIndex, clnpAddrEntry=clnpAddrEntry, clnpAdEntAddr=clnpAdEntAddr)
