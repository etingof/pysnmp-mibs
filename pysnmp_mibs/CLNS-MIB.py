...
( Bits, Counter32, Integer32, Integer32, MibIdentifier, MibVariable, MibTable, MibTableRow, MibTableColumn, TimeTicks, experimental, ) = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Integer32", "Integer32", "MibIdentifier", "MibVariable", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "experimental")
...
clnpForwarding = MibVariable((1, 3, 6, 1, 3, 1, 1, 1), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,)).subtype(namedValues=namedval.NamedValues(("is", 1), ("es", 2), ))).setMaxAccess("readwrite")
clnpDefaultLifeTime = MibVariable((1, 3, 6, 1, 3, 1, 1, 2), Integer32()).setMaxAccess("readwrite")
clnpInReceives = MibVariable((1, 3, 6, 1, 3, 1, 1, 3), Counter32()).setMaxAccess("readonly")
clnpInHdrErrors = MibVariable((1, 3, 6, 1, 3, 1, 1, 4), Counter32()).setMaxAccess("readonly")
clnpInAddrErrors = MibVariable((1, 3, 6, 1, 3, 1, 1, 5), Counter32()).setMaxAccess("readonly")
clnpForwPDUs = MibVariable((1, 3, 6, 1, 3, 1, 1, 6), Counter32()).setMaxAccess("readonly")
clnpInUnknownNLPs = MibVariable((1, 3, 6, 1, 3, 1, 1, 7), Counter32()).setMaxAccess("readonly")
clnpInUnknownULPs = MibVariable((1, 3, 6, 1, 3, 1, 1, 8), Counter32()).setMaxAccess("readonly")
clnpInDiscards = MibVariable((1, 3, 6, 1, 3, 1, 1, 9), Counter32()).setMaxAccess("readonly")
clnpInDelivers = MibVariable((1, 3, 6, 1, 3, 1, 1, 10), Counter32()).setMaxAccess("readonly")
clnpOutRequests = MibVariable((1, 3, 6, 1, 3, 1, 1, 11), Counter32()).setMaxAccess("readonly")
clnpOutDiscards = MibVariable((1, 3, 6, 1, 3, 1, 1, 12), Counter32()).setMaxAccess("readonly")
clnpOutNoRoutes = MibVariable((1, 3, 6, 1, 3, 1, 1, 13), Counter32()).setMaxAccess("readonly")
clnpReasmTimeout = MibVariable((1, 3, 6, 1, 3, 1, 1, 14), Integer32()).setMaxAccess("readonly")
clnpReasmReqds = MibVariable((1, 3, 6, 1, 3, 1, 1, 15), Counter32()).setMaxAccess("readonly")
clnpReasmOKs = MibVariable((1, 3, 6, 1, 3, 1, 1, 16), Counter32()).setMaxAccess("readonly")
clnpReasmFails = MibVariable((1, 3, 6, 1, 3, 1, 1, 17), Counter32()).setMaxAccess("readonly")
clnpSegOKs = MibVariable((1, 3, 6, 1, 3, 1, 1, 18), Counter32()).setMaxAccess("readonly")
clnpSegFails = MibVariable((1, 3, 6, 1, 3, 1, 1, 19), Counter32()).setMaxAccess("readonly")
clnpSegCreates = MibVariable((1, 3, 6, 1, 3, 1, 1, 20), Counter32()).setMaxAccess("readonly")
...
clnpAdEntReasmMaxSize = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 21, 1, 3)).setColumnInitializer(MibVariable((), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 65535))).setMaxAccess("readonly"))
...
clnpRouteType = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 22, 1, 8)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,4,3,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("invalid", 2), ("direct", 3), ("remote", 4), ))).setMaxAccess("readwrite"))
clnpRouteProto = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 22, 1, 9)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(12,3,13,14,11,1,9,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("ciscoIgrp", 11), ("bbnSpfIgp", 12), ("ospf", 13), ("bgp", 14), ("local", 2), ("netmgmt", 3), ("is-is", 9), ))).setMaxAccess("readonly"))
...
clnpNetToMediaType = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 23, 1, 4)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(4,1,3,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("invalid", 2), ("dynamic", 3), ("static", 4), ))).setMaxAccess("readwrite"))
...
clnpMediaToNetType = MibTableColumn((1, 3, 6, 1, 3, 1, 1, 24, 1, 4)).setColumnInitializer(MibVariable((), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(4,1,3,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("invalid", 2), ("dynamic", 3), ("static", 4), ))).setMaxAccess("readwrite"))
...
clnpInOpts = MibVariable((1, 3, 6, 1, 3, 1, 1, 25), Counter32()).setMaxAccess("readonly")
clnpOutOpts = MibVariable((1, 3, 6, 1, 3, 1, 1, 26), Counter32()).setMaxAccess("readonly")
clnpRoutingDiscards = MibVariable((1, 3, 6, 1, 3, 1, 1, 27), Counter32()).setMaxAccess("readonly")
error = MibIdentifier((1, 3, 6, 1, 3, 1, 2))
clnpInErrors = MibVariable((1, 3, 6, 1, 3, 1, 2, 1), Counter32()).setMaxAccess("readonly")
clnpOutErrors = MibVariable((1, 3, 6, 1, 3, 1, 2, 2), Counter32()).setMaxAccess("readonly")
clnpInErrUnspecs = MibVariable((1, 3, 6, 1, 3, 1, 2, 3), Counter32()).setMaxAccess("readonly")
clnpInErrProcs = MibVariable((1, 3, 6, 1, 3, 1, 2, 4), Counter32()).setMaxAccess("readonly")
clnpInErrCksums = MibVariable((1, 3, 6, 1, 3, 1, 2, 5), Counter32()).setMaxAccess("readonly")
clnpInErrCongests = MibVariable((1, 3, 6, 1, 3, 1, 2, 6), Counter32()).setMaxAccess("readonly")
clnpInErrHdrs = MibVariable((1, 3, 6, 1, 3, 1, 2, 7), Counter32()).setMaxAccess("readonly")
clnpInErrSegs = MibVariable((1, 3, 6, 1, 3, 1, 2, 8), Counter32()).setMaxAccess("readonly")
clnpInErrIncomps = MibVariable((1, 3, 6, 1, 3, 1, 2, 9), Counter32()).setMaxAccess("readonly")
clnpInErrDups = MibVariable((1, 3, 6, 1, 3, 1, 2, 10), Counter32()).setMaxAccess("readonly")
clnpInErrUnreachDsts = MibVariable((1, 3, 6, 1, 3, 1, 2, 11), Counter32()).setMaxAccess("readonly")
clnpInErrUnknownDsts = MibVariable((1, 3, 6, 1, 3, 1, 2, 12), Counter32()).setMaxAccess("readonly")
clnpInErrSRUnspecs = MibVariable((1, 3, 6, 1, 3, 1, 2, 13), Counter32()).setMaxAccess("readonly")
clnpInErrSRSyntaxes = MibVariable((1, 3, 6, 1, 3, 1, 2, 14), Counter32()).setMaxAccess("readonly")
clnpInErrSRUnkAddrs = MibVariable((1, 3, 6, 1, 3, 1, 2, 15), Counter32()).setMaxAccess("readonly")
clnpInErrSRBadPaths = MibVariable((1, 3, 6, 1, 3, 1, 2, 16), Counter32()).setMaxAccess("readonly")
clnpInErrHops = MibVariable((1, 3, 6, 1, 3, 1, 2, 17), Counter32()).setMaxAccess("readonly")
clnpInErrHopReassms = MibVariable((1, 3, 6, 1, 3, 1, 2, 18), Counter32()).setMaxAccess("readonly")
clnpInErrUnsOptions = MibVariable((1, 3, 6, 1, 3, 1, 2, 19), Counter32()).setMaxAccess("readonly")
clnpInErrUnsVersions = MibVariable((1, 3, 6, 1, 3, 1, 2, 20), Counter32()).setMaxAccess("readonly")
clnpInErrUnsSecurities = MibVariable((1, 3, 6, 1, 3, 1, 2, 21), Counter32()).setMaxAccess("readonly")
clnpInErrUnsSRs = MibVariable((1, 3, 6, 1, 3, 1, 2, 22), Counter32()).setMaxAccess("readonly")
clnpInErrUnsRRs = MibVariable((1, 3, 6, 1, 3, 1, 2, 23), Counter32()).setMaxAccess("readonly")
clnpInErrInterferences = MibVariable((1, 3, 6, 1, 3, 1, 2, 24), Counter32()).setMaxAccess("readonly")
clnpOutErrUnspecs = MibVariable((1, 3, 6, 1, 3, 1, 2, 25), Counter32()).setMaxAccess("readonly")
clnpOutErrProcs = MibVariable((1, 3, 6, 1, 3, 1, 2, 26), Counter32()).setMaxAccess("readonly")
clnpOutErrCksums = MibVariable((1, 3, 6, 1, 3, 1, 2, 27), Counter32()).setMaxAccess("readonly")
clnpOutErrCongests = MibVariable((1, 3, 6, 1, 3, 1, 2, 28), Counter32()).setMaxAccess("readonly")
clnpOutErrHdrs = MibVariable((1, 3, 6, 1, 3, 1, 2, 29), Counter32()).setMaxAccess("readonly")
clnpOutErrSegs = MibVariable((1, 3, 6, 1, 3, 1, 2, 30), Counter32()).setMaxAccess("readonly")
clnpOutErrIncomps = MibVariable((1, 3, 6, 1, 3, 1, 2, 31), Counter32()).setMaxAccess("readonly")
clnpOutErrDups = MibVariable((1, 3, 6, 1, 3, 1, 2, 32), Counter32()).setMaxAccess("readonly")
clnpOutErrUnreachDsts = MibVariable((1, 3, 6, 1, 3, 1, 2, 33), Counter32()).setMaxAccess("readonly")
clnpOutErrUnknownDsts = MibVariable((1, 3, 6, 1, 3, 1, 2, 34), Counter32()).setMaxAccess("readonly")
clnpOutErrSRUnspecs = MibVariable((1, 3, 6, 1, 3, 1, 2, 35), Counter32()).setMaxAccess("readonly")
clnpOutErrSRSyntaxes = MibVariable((1, 3, 6, 1, 3, 1, 2, 36), Counter32()).setMaxAccess("readonly")
clnpOutErrSRUnkAddrs = MibVariable((1, 3, 6, 1, 3, 1, 2, 37), Counter32()).setMaxAccess("readonly")
clnpOutErrSRBadPaths = MibVariable((1, 3, 6, 1, 3, 1, 2, 38), Counter32()).setMaxAccess("readonly")
clnpOutErrHops = MibVariable((1, 3, 6, 1, 3, 1, 2, 39), Counter32()).setMaxAccess("readonly")
clnpOutErrHopReassms = MibVariable((1, 3, 6, 1, 3, 1, 2, 40), Counter32()).setMaxAccess("readonly")
clnpOutErrUnsOptions = MibVariable((1, 3, 6, 1, 3, 1, 2, 41), Counter32()).setMaxAccess("readonly")
clnpOutErrUnsVersions = MibVariable((1, 3, 6, 1, 3, 1, 2, 42), Counter32()).setMaxAccess("readonly")
clnpOutErrUnsSecurities = MibVariable((1, 3, 6, 1, 3, 1, 2, 43), Counter32()).setMaxAccess("readonly")
clnpOutErrUnsSRs = MibVariable((1, 3, 6, 1, 3, 1, 2, 44), Counter32()).setMaxAccess("readonly")
clnpOutErrUnsRRs = MibVariable((1, 3, 6, 1, 3, 1, 2, 45), Counter32()).setMaxAccess("readonly")
clnpOutErrInterferences = MibVariable((1, 3, 6, 1, 3, 1, 2, 46), Counter32()).setMaxAccess("readonly")
echo = MibIdentifier((1, 3, 6, 1, 3, 1, 3))
es_is = MibIdentifier((1, 3, 6, 1, 3, 1, 4)).setLabel("es-is")
esisESHins = MibVariable((1, 3, 6, 1, 3, 1, 4, 1), Counter32()).setMaxAccess("readonly")
esisESHouts = MibVariable((1, 3, 6, 1, 3, 1, 4, 2), Counter32()).setMaxAccess("readonly")
esisISHins = MibVariable((1, 3, 6, 1, 3, 1, 4, 3), Counter32()).setMaxAccess("readonly")
esisISHouts = MibVariable((1, 3, 6, 1, 3, 1, 4, 4), Counter32()).setMaxAccess("readonly")
esisRDUins = MibVariable((1, 3, 6, 1, 3, 1, 4, 5), Counter32()).setMaxAccess("readonly")
esisRDUouts = MibVariable((1, 3, 6, 1, 3, 1, 4, 6), Counter32()).setMaxAccess("readonly")
