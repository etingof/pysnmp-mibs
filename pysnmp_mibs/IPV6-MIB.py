...
ipv6RouteProtocol = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 11, 1, 7), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(7,1,3,9,4,6,8,2,5,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("local", 2), ("netmgmt", 3), ("ndisc", 4), ("rip", 5), ("ospf", 6), ("bgp", 7), ("idrp", 8), ("igrp", 9), ))).setMaxAccess("readonly")
