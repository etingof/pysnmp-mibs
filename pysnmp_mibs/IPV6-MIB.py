...
# by libsmi2pysnmp-0.0.7-alpha at Wed Feb  7 16:13:00 2007,
...
ipv6IfOperStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 5, 1, 10), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,4,3,1,5,)).subtype(namedValues=namedval.NamedValues(("up", 1), ("down", 2), ("noIfIdentifier", 3), ("unknown", 4), ("notPresent", 5), ))).setMaxAccess("readonly")
...
ipv6AddrType = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 8, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,3,)).subtype(namedValues=namedval.NamedValues(("stateless", 1), ("stateful", 2), ("unknown", 3), ))).setMaxAccess("readonly")
ipv6AddrAnycastFlag = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 8, 1, 4), TruthValue()).setMaxAccess("readonly")
ipv6AddrStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 8, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,4,3,1,5,)).subtype(namedValues=namedval.NamedValues(("preferred", 1), ("deprecated", 2), ("invalid", 3), ("inaccessible", 4), ("unknown", 5), ))).setMaxAccess("readonly")
...
ipv6RouteType = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 11, 1, 6), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(4,1,2,3,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("discard", 2), ("local", 3), ("remote", 4), ))).setMaxAccess("readonly")
ipv6RouteProtocol = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 11, 1, 7), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(7,3,9,4,6,5,1,8,2,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("local", 2), ("netmgmt", 3), ("ndisc", 4), ("rip", 5), ("ospf", 6), ("bgp", 7), ("idrp", 8), ("igrp", 9), ))).setMaxAccess("readonly")
...
ipv6NetToMediaType = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 12, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,3,4,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("dynamic", 2), ("static", 3), ("local", 4), ))).setMaxAccess("readonly")
ipv6IfNetToMediaState = MibTableColumn((1, 3, 6, 1, 2, 1, 55, 1, 12, 1, 4), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,6,4,5,1,2,)).subtype(namedValues=namedval.NamedValues(("reachable", 1), ("stale", 2), ("delay", 3), ("probe", 4), ("invalid", 5), ("unknown", 6), ))).setMaxAccess("readonly")
