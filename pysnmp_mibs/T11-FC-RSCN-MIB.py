...
t11FcRscnRegFcId = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 1, 1, 1, 2), FcAddressIdOrZero().subtype(subtypeSpec=constraint.ValueSizeConstraint(3, 3)).setFixedLength(3)).setMaxAccess("noaccess")
if mibBuilder.loadTexts: t11FcRscnRegFcId.setDescription("The Fibre Channel Address Identifier of the\nregistering Nx_Port.")
t11FcRscnRegType = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 1, 1, 1, 3), Bits().subtype(namedValues=namedval.NamedValues(("fromFabricController", 0), ("fromNxPort", 1), ))).setMaxAccess("readonly")
...
t11FcRscnRejectedRequestString = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 3, 1, 1, 3), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 255))).setMaxAccess("readonly")
...
t11FcRscnRejectReasonCodeExp = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 3, 1, 1, 6), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 1)).setFixedLength(1)).setMaxAccess("readonly")
...
t11FcRscnRejectReasonVendorCode = MibTableColumn((1, 3, 6, 1, 2, 1, 161, 1, 3, 1, 1, 7), OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, 1)).setFixedLength(1)).setMaxAccess("readonly")
