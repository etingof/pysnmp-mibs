...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:31:31 2015
...
rip2IfConfAuthType = MibTableColumn((1, 3, 6, 1, 2, 1, 23, 3, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("noAuthentication", 1), ("simplePassword", 2), ("md5", 3),)).clone('noAuthentication')).setMaxAccess("readcreate")
...
rip2IfConfSend = MibTableColumn((1, 3, 6, 1, 2, 1, 23, 3, 1, 5), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6,)).clone(namedValues=NamedValues(("doNotSend", 1), ("ripVersion1", 2), ("rip1Compatible", 3), ("ripVersion2", 4), ("ripV1Demand", 5), ("ripV2Demand", 6),)).clone('rip1Compatible')).setMaxAccess("readcreate")
...
rip2IfConfReceive = MibTableColumn((1, 3, 6, 1, 2, 1, 23, 3, 1, 6), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("rip1", 1), ("rip2", 2), ("rip1OrRip2", 3), ("doNotRecieve", 4),)).clone('rip1OrRip2')).setMaxAccess("readcreate")
...
mibBuilder.exportSymbols("RIPv2-MIB", rip2Compliances=rip2Compliances, rip2IfConfTable=rip2IfConfTable, PYSNMP_MODULE_ID=rip2, rip2IfStatTable=rip2IfStatTable, rip2IfStatStatus=rip2IfStatStatus, rip2PeerTable=rip2PeerTable, rip2PeerGroup=rip2PeerGroup, rip2IfStatRcvBadPackets=rip2IfStatRcvBadPackets, rip2IfStatSentUpdates=rip2IfStatSentUpdates, rip2Conformance=rip2Conformance, rip2Compliance=rip2Compliance, rip2Globals=rip2Globals, rip2IfConfDefaultMetric=rip2IfConfDefaultMetric, rip2GlobalGroup=rip2GlobalGroup, rip2PeerVersion=rip2PeerVersion, rip2IfStatEntry=rip2IfStatEntry, rip2IfConfAddress=rip2IfConfAddress, rip2PeerDomain=rip2PeerDomain, rip2IfConfAuthKey=rip2IfConfAuthKey, rip2PeerEntry=rip2PeerEntry, rip2IfConfAuthType=rip2IfConfAuthType, rip2IfConfReceive=rip2IfConfReceive, rip2IfConfEntry=rip2IfConfEntry, RouteTag=RouteTag, rip2IfConfGroup=rip2IfConfGroup, rip2IfConfDomain=rip2IfConfDomain, rip2PeerRcvBadRoutes=rip2PeerRcvBadRoutes, rip2PeerAddress=rip2PeerAddress, rip2GlobalRouteChanges=rip2GlobalRouteChanges, rip2IfConfSend=rip2IfConfSend, rip2Groups=rip2Groups, rip2PeerRcvBadPackets=rip2PeerRcvBadPackets, rip2PeerLastUpdate=rip2PeerLastUpdate, rip2IfConfStatus=rip2IfConfStatus, rip2IfStatAddress=rip2IfStatAddress, rip2IfStatGroup=rip2IfStatGroup, rip2=rip2, rip2GlobalQueries=rip2GlobalQueries, rip2IfStatRcvBadRoutes=rip2IfStatRcvBadRoutes, rip2IfConfSrcAddress=rip2IfConfSrcAddress)
