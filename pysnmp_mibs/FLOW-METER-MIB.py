...
class ActionNumber(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(1,15,6,5,10,17,3,2,13,14,16,7,9,11,8,4,12,)
...
class AdjacentType(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(9,1,3,12,13,7,11,15,)
