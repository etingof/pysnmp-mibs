...
finDeviceMaxCapacity = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 30, 1, 1, 5), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-2, 2147483647)).clone(-2)).setMaxAccess("readwrite")
...
finDeviceCurrentCapacity = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 30, 1, 1, 6), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-2, 2147483647)).clone(-2)).setMaxAccess("readwrite")
...
finSupplyMaxCapacity = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 31, 1, 1, 7), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-2, 2147483647)).clone(-2)).setMaxAccess("readwrite")
...
finSupplyCurrentLevel = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 31, 1, 1, 8), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-3, 2147483647)).clone(-2)).setMaxAccess("readwrite")
...
finSupplyMediaInputMediaDimFeedDir = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 32, 1, 1, 6), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-2, 2147483647))).setMaxAccess("readwrite")
...
finSupplyMediaInputMediaDimXFeedDir = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 32, 1, 1, 7), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-2, 2147483647))).setMaxAccess("readwrite")
...
finSupplyMediaInputMediaThickness = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 32, 1, 1, 14), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-2, 2147483647))).setMaxAccess("readwrite")
...
finDeviceAttributeValueAsInteger = MibTableColumn((1, 3, 6, 1, 2, 1, 43, 33, 1, 1, 3), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-2, 2147483647)).clone(-2)).setMaxAccess("readwrite")
