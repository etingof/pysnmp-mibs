...
ds1 = ModuleIdentity((1, 3, 6, 1, 2, 1, 10, 18)).setRevisions(("2004-09-09 00:00","1998-08-01 18:30","1993-01-25 20:28",))
...
dsx1LineType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 18, 6, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(7,10,8,9,3,11,4,2,1,13,6,12,5,)).subtype(namedValues=namedval.NamedValues(("other", 1), ("dsx1DS2M12", 10), ("dsx1E2", 11), ("dsx1E1Q50", 12), ("dsx1E1Q50CRC", 13), ("dsx1ESF", 2), ("dsx1D4", 3), ("dsx1E1", 4), ("dsx1E1CRC", 5), ("dsx1E1MF", 6), ("dsx1E1CRCMF", 7), ("dsx1Unframed", 8), ("dsx1E1Unframed", 9), ))).setMaxAccess("readwrite")
...
dsx1LoopbackConfig = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 18, 6, 1, 9), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(6,5,1,2,3,4,)).subtype(namedValues=namedval.NamedValues(("dsx1NoLoop", 1), ("dsx1PayloadLoop", 2), ("dsx1LineLoop", 3), ("dsx1OtherLoop", 4), ("dsx1InwardLoop", 5), ("dsx1DualLoop", 6), ))).setMaxAccess("readwrite")
...
dsx1FracIfIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 18, 13, 1, 3), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readwrite")
