...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:31:55 2015
...
sipUACfgTimerEntry = MibTableRow((1, 3, 6, 1, 2, 1, 9998, 3, 1, 1, 1, 1), ).setIndexNames((0, "SIP-UA-MIB", "applIndex"))
...
sipUACfgRetryEntry = MibTableRow((1, 3, 6, 1, 2, 1, 9998, 3, 1, 2, 1, 1), ).setIndexNames((0, "SIP-UA-MIB", "applIndex"))
...
sipUAStatsRetryEntry = MibTableRow((1, 3, 6, 1, 2, 1, 9998, 3, 2, 1, 1, 1), ).setIndexNames((0, "SIP-UA-MIB", "applIndex"))
...
mibBuilder.exportSymbols("SIP-UA-MIB", PYSNMP_MODULE_ID=sipUAMIB, sipUAStatsGroup=sipUAStatsGroup, sipUACfgRetryEntry=sipUACfgRetryEntry, sipStatsRetryByes=sipStatsRetryByes, sipUACfgRetryResponse=sipUACfgRetryResponse, sipUACfgRetryTable=sipUACfgRetryTable, sipUACfgTimerEntry=sipUACfgTimerEntry, sipUACompliance=sipUACompliance, sipUACfgTimerProv=sipUACfgTimerProv, sipUACfgTimerTable=sipUACfgTimerTable, sipUAStatsRetryTable=sipUAStatsRetryTable, sipUACfgTimerAck=sipUACfgTimerAck, sipUAMIB=sipUAMIB, sipUAMIBNotif=sipUAMIBNotif, sipUAMIBGroups=sipUAMIBGroups, sipUACfgTimer=sipUACfgTimer, sipStatsRetryRegisters=sipStatsRetryRegisters, sipUACfgRetryCancel=sipUACfgRetryCancel, sipUAStatsRetry=sipUAStatsRetry, sipUACfgRetryInvite=sipUACfgRetryInvite, sipStatsRetryInvites=sipStatsRetryInvites, sipUAConfigGroup=sipUAConfigGroup, sipUACfgRetry=sipUACfgRetry, sipUAMIBCompliances=sipUAMIBCompliances, sipUAStats=sipUAStats, sipUACfgTimerTrying=sipUACfgTimerTrying, sipUACfgRetryRegister=sipUACfgRetryRegister, sipUACfgTimerReRegister=sipUACfgTimerReRegister, sipUAStatsRetryEntry=sipUAStatsRetryEntry, sipUACfg=sipUACfg, sipUAMIBConformance=sipUAMIBConformance, sipUACfgTimerDisconnect=sipUACfgTimerDisconnect, sipUACfgRetryBye=sipUACfgRetryBye, sipStatsRetryCancels=sipStatsRetryCancels, sipStatsRetryResponses=sipStatsRetryResponses)
