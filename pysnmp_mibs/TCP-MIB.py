...
tcpRtoAlgorithm = MibVariable((1, 3, 6, 1, 2, 1, 6, 1), Integer().addConstraints(subtypes.SingleValueConstraint(4,1,2,3,)).addNamedValues(("other", 1), ("constant", 2), ("rsre", 3), ("vanj", 4), )).setMaxAccess("readonly")
...
tcpConnLocalPort = MibTableColumn((1, 3, 6, 1, 2, 1, 6, 13, 1, 3)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 65535))).setMaxAccess("readonly"))
tcpConnRemAddress = MibTableColumn((1, 3, 6, 1, 2, 1, 6, 13, 1, 4)).setColumnInitializer(MibVariable((), IpAddress()).setMaxAccess("readonly"))
tcpConnRemPort = MibTableColumn((1, 3, 6, 1, 2, 1, 6, 13, 1, 5)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 65535))).setMaxAccess("readonly"))
