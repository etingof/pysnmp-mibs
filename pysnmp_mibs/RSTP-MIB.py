...
dot1dStpVersion = MibScalar((1, 3, 6, 1, 2, 1, 17, 2, 16), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(0,2,)).subtype(namedValues=namedval.NamedValues(("stpCompatible", 0), ("rstp", 2), )).clone(2)).setMaxAccess("readwrite")
...
dot1dStpTxHoldCount = MibScalar((1, 3, 6, 1, 2, 1, 17, 2, 17), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 10)).clone(3)).setMaxAccess("readwrite")
...
dot1dStpPortAdminPointToPoint = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 2, 19, 1, 4), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,0,2,)).subtype(namedValues=namedval.NamedValues(("forceTrue", 0), ("forceFalse", 1), ("auto", 2), ))).setMaxAccess("readwrite")
...
dot1dStpPortAdminPathCost = MibTableColumn((1, 3, 6, 1, 2, 1, 17, 2, 19, 1, 6), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 200000000))).setMaxAccess("readwrite")
...
apply(dot1dStpExtPortEntry.setIndexNames, dot1dStpPortEntry.getIndexNames())
