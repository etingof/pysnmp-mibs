...
# Produced by pysmi-0.0.4 at Sun Jul  5 17:50:13 2015
...
ospfVersionNumber = MibScalar((1, 3, 6, 1, 2, 1, 14, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(2,)).clone(namedValues=NamedValues(("version2", 2),))).setMaxAccess("readonly")
...
ospfLsdbType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 4, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5,)).clone(namedValues=NamedValues(("routerLink", 1), ("networkLink", 2), ("summaryLink", 3), ("asSummaryLink", 4), ("asExternalLink", 5),))).setMaxAccess("readonly")
...
ospfIfType = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("broadcast", 1), ("nbma", 2), ("pointToPoint", 3),))).setMaxAccess("readwrite")
...
ospfIfState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 7, 1, 12), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6, 7,)).clone(namedValues=NamedValues(("down", 1), ("loopback", 2), ("waiting", 3), ("pointToPoint", 4), ("designatedRouter", 5), ("backupDesignatedRouter", 6), ("otherDesignatedRouter", 7),)).clone('down')).setMaxAccess("readonly")
...
ospfVirtIfState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 9, 1, 7), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 4,)).clone(namedValues=NamedValues(("down", 1), ("pointToPoint", 4),)).clone('down')).setMaxAccess("readonly")
...
ospfNbrState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 10, 1, 6), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8,)).clone(namedValues=NamedValues(("down", 1), ("attempt", 2), ("init", 3), ("twoWay", 4), ("exchangeStart", 5), ("exchange", 6), ("loading", 7), ("full", 8),)).clone('down')).setMaxAccess("readonly")
...
ospfVirtNbrState = MibTableColumn((1, 3, 6, 1, 2, 1, 14, 11, 1, 5), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8,)).clone(namedValues=NamedValues(("down", 1), ("attempt", 2), ("init", 3), ("twoWay", 4), ("exchangeStart", 5), ("exchange", 6), ("loading", 7), ("full", 8),))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("RFC1253-MIB", ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfAuthKey=ospfVirtIfAuthKey, UpToMaxAge=UpToMaxAge, ospfNbrPriority=ospfNbrPriority, ospfLsdbAge=ospfLsdbAge, AreaID=AreaID, ospfIfHelloInterval=ospfIfHelloInterval, ospfHostTable=ospfHostTable, ospfVersionNumber=ospfVersionNumber, HelloRange=HelloRange, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfStubMetric=ospfStubMetric, ospfLsdbRouterId=ospfLsdbRouterId, ospfNBMANbrStatus=ospfNBMANbrStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostEntry=ospfHostEntry, ospfHostStatus=ospfHostStatus, ospfVirtNbrState=ospfVirtNbrState, ospfNbrOptions=ospfNbrOptions, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrLSRetransQLen=ospfVirtNbrLSRetransQLen, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostIpAddress=ospfHostIpAddress, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfRtrPriority=ospfIfRtrPriority, ospfLsdbEntry=ospfLsdbEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfEntry=ospfIfEntry, ospfAuthType=ospfAuthType, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfHostTOS=ospfHostTOS, ospfNbrLSRetransQLen=ospfNbrLSRetransQLen, ospfLsdbType=ospfLsdbType, TOSType=TOSType, BigMetric=BigMetric, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaId=ospfAreaId, ospfOriginateNewLSAs=ospfOriginateNewLSAs, ospfStubStatus=ospfStubStatus, ospfRxNewLSAs=ospfRxNewLSAs, ospfNbrEntry=ospfNbrEntry, ospfAreaEntry=ospfAreaEntry, ospfRouterId=ospfRouterId, ospfLsdbLSID=ospfLsdbLSID, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfAreaId=ospfIfAreaId, ospfAreaRangeAreaID=ospfAreaRangeAreaID, ospfHostMetric=ospfHostMetric, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfState=ospfVirtIfState, TruthValue=TruthValue, ospfIfTable=ospfIfTable, ospfIfType=ospfIfType, ospfStubAreaTable=ospfStubAreaTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaRangeStatus=ospfAreaRangeStatus, ospf=ospf, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrState=ospfNbrState, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaTable=ospfAreaTable, Metric=Metric, ospfLsdbTable=ospfLsdbTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfSpfRuns=ospfSpfRuns, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfState=ospfIfState, ospfAddressLessIf=ospfAddressLessIf, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAdminStat=ospfAdminStat, ospfIfMetricEntry=ospfIfMetricEntry, ospfStubAreaID=ospfStubAreaID, RouterID=RouterID, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricTable=ospfIfMetricTable, ospfIfIpAddress=ospfIfIpAddress, PositiveInteger=PositiveInteger, ospfAreaLSACount=ospfAreaLSACount, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfTOSSupport=ospfTOSSupport, ospfASBdrRtrCount=ospfASBdrRtrCount, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfAreaID=ospfVirtIfAreaID, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, Status=Status, ospfIfEvents=ospfIfEvents, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfPollInterval=ospfIfPollInterval, ospfExternLSACksumSum=ospfExternLSACksumSum, InterfaceIndex=InterfaceIndex, ospfAreaLSACksumSum=ospfAreaLSACksumSum, ospfIfAuthKey=ospfIfAuthKey, ospfNbrTable=ospfNbrTable, ospfExternLSACount=ospfExternLSACount, ospfStubTOS=ospfStubTOS, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfMetricMetric=ospfIfMetricMetric, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfImportASExtern=ospfImportASExtern, ospfVirtIfTable=ospfVirtIfTable, Validation=Validation)
