...
class TeLinkEncodingType(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(9,3,5,1,11,7,2,8,)
    namedValues = namedval.NamedValues(("packet", 1), ("fiberChannel", 11), ("ethernet", 2), ("ansiEtsiPdh", 3), ("sdhItuSonetAnsi", 5), ("digitalWrapper", 7), ("lambda", 8), ("fiber", 9), )
    pass

class TeLinkPriority(TextualConvention, Unsigned32):
    displayHint = "d"
    subtypeSpec = Unsigned32.subtypeSpec+constraint.ValueRangeConstraint(0,7)
    pass

class TeLinkProtection(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(2,1,)
    namedValues = namedval.NamedValues(("primary", 1), ("secondary", 2), )
    pass

class TeLinkSonetSdhIndication(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(0,1,)
    namedValues = namedval.NamedValues(("standard", 0), ("arbitrary", 1), )
    pass

class TeLinkSwitchingCapability(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(100,200,1,3,2,4,150,51,)
    namedValues = namedval.NamedValues(("packetSwitch1", 1), ("tdm", 100), ("lambdaSwitch", 150), ("packetSwitch2", 2), ("fiberSwitch", 200), ("packetSwitch3", 3), ("packetSwitch4", 4), ("layer2Switch", 51), )
    pass
...
teLinkProtectionType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 1, 1, 6), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(4,2,6,3,1,5,)).subtype(namedValues=namedval.NamedValues(("extraTraffic", 1), ("unprotected", 2), ("shared", 3), ("dedicated1For1", 4), ("dedicated1Plus1", 5), ("enhanced", 6), ))).setMaxAccess("readcreate")
...
teLinkIncomingIfId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 1, 1, 9), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readcreate")
...
teLinkDescriptorId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 2, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
teLinkDescrInterfaceMtu = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 2, 1, 13), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 65535))).setMaxAccess("readcreate")
...
teLinkSrlg = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 3, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 4294967295L))).setMaxAccess("noaccess")
...
componentLinkDescrId = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 6, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
componentLinkDescrInterfaceMtu = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 200, 1, 6, 1, 13), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 65535))).setMaxAccess("readcreate")
...
# Groups
mibBuilder.exportSymbols("TE-LINK-STD-MIB", teLinkBandwidthGroup=teLinkBandwidthGroup, teLinkGroup=teLinkGroup, teLinkTdmGroup=teLinkTdmGroup, teLinkSrlgGroup=teLinkSrlgGroup, teLinkPscGroup=teLinkPscGroup, componentLinkBandwidthGroup=componentLinkBandwidthGroup)
