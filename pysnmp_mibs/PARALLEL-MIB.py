...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:30:44 2015
...
paraPortType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 34, 2, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("other", 1), ("centronics", 2), ("dataproducts", 3),))).setMaxAccess("readonly")
...
paraInSigName = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 34, 3, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5,)).clone(namedValues=NamedValues(("power", 1), ("online", 2), ("busy", 3), ("paperout", 4), ("fault", 5),))).setMaxAccess("readonly")
if mibBuilder.loadTexts: paraInSigName.setDescription('Identification of a hardware signal.')
paraInSigState = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 34, 3, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("none", 1), ("on", 2), ("off", 3),))).setMaxAccess("readonly")
...
paraOutSigName = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 34, 4, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5,)).clone(namedValues=NamedValues(("power", 1), ("online", 2), ("busy", 3), ("paperout", 4), ("fault", 5),))).setMaxAccess("readonly")
if mibBuilder.loadTexts: paraOutSigName.setDescription('Identification of a hardware signal.')
paraOutSigState = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 34, 4, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("none", 1), ("on", 2), ("off", 3),))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("PARALLEL-MIB", paraGroup=paraGroup, PYSNMP_MODULE_ID=para, paraInSigState=paraInSigState, paraConformance=paraConformance, paraPortInSigNumber=paraPortInSigNumber, para=para, paraOutSigState=paraOutSigState, paraPortType=paraPortType, paraInSigEntry=paraInSigEntry, paraNumber=paraNumber, paraCompliances=paraCompliances, paraGroups=paraGroups, paraCompliance=paraCompliance, paraPortEntry=paraPortEntry, paraOutSigChanges=paraOutSigChanges, paraPortTable=paraPortTable, paraOutSigPortIndex=paraOutSigPortIndex, paraInSigName=paraInSigName, paraPortOutSigNumber=paraPortOutSigNumber, paraOutSigName=paraOutSigName, paraOutSigEntry=paraOutSigEntry, paraInSigTable=paraInSigTable, paraInSigPortIndex=paraInSigPortIndex, paraPortIndex=paraPortIndex, paraInSigChanges=paraInSigChanges, paraOutSigTable=paraOutSigTable)
