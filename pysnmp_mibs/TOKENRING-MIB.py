...
dot5RingOpenStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 9, 1, 1, 5), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(5,6,9,8,1,2,11,7,3,10,4,)).subtype(namedValues=namedval.NamedValues(("noOpen", 1), ("removeReceived", 10), ("open", 11), ("badParam", 2), ("lobeFailed", 3), ("signalLoss", 4), ("insertionTimeout", 5), ("ringFailed", 6), ("beaconing", 7), ("duplicateMAC", 8), ("requestFailed", 9), ))).setMaxAccess("readonly")
