...
bgp4PathAttrMultiExitDisc = MibTableColumn((1, 3, 6, 1, 2, 1, 15, 6, 1, 7), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-1, 2147483647))).setMaxAccess("readonly")
...
bgp4PathAttrLocalPref = MibTableColumn((1, 3, 6, 1, 2, 1, 15, 6, 1, 8), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-1, 2147483647))).setMaxAccess("readonly")
...
bgp4PathAttrCalcLocalPref = MibTableColumn((1, 3, 6, 1, 2, 1, 15, 6, 1, 12), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(-1, 2147483647))).setMaxAccess("readonly")
