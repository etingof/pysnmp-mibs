...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:13:12 2006,
...
atmInterfaceAddressType = MibTableColumn((1, 3, 6, 1, 2, 1, 37, 1, 2, 1, 9), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,1,4,2,)).subtype(namedValues=namedval.NamedValues(("private", 1), ("nsapE164", 2), ("nativeE164", 3), ("other", 4), ))).setMaxAccess("readonly")
