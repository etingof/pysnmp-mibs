...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:30:02 2015
...
mdmLineState = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 3, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6,)).clone(namedValues=NamedValues(("unknown", 1), ("onHook", 2), ("offHook", 3), ("connected", 4), ("busiedOut", 5), ("reset", 6),))).setMaxAccess("readwrite")
...
mdmLineCapabilitiesEnableRequested = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 4, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("disabled", 1), ("optional", 2), ("preferred", 3),)).clone('preferred')).setMaxAccess("readwrite")
...
mdmLineCapabilitiesEnableGranted = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 4, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("disabled", 1), ("optional", 2), ("preferred", 3),))).setMaxAccess("readonly")
...
mdmDTEActionDTROnToOff = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 6, 1, 1), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("ignore", 1), ("escapeToCommandMode", 2), ("disconnectCall", 3), ("resetModem", 4),)).clone('disconnectCall')).setMaxAccess("readwrite")
...
mdmDTEActionDTROffToOn = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 6, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("ignore", 1), ("enableDial", 2), ("autoAnswerEnable", 3), ("establishConnection", 4),)).clone('autoAnswerEnable')).setMaxAccess("readwrite")
...
mdmDTESyncTimingSource = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 6, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("internal", 1), ("external", 2), ("loopback", 3), ("network", 4),)).clone('internal')).setMaxAccess("readwrite")
...
mdmDTESyncAsyncMode = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 6, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("async", 1), ("sync", 2), ("syncAfterDial", 3),)).clone('async')).setMaxAccess("readwrite")
...
mdmCCResultCodeEnable = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 7, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("disabled", 1), ("numericEnabled", 2), ("verboseEnabled", 3),)).clone('verboseEnabled')).setMaxAccess("readwrite")
...
mdmCCEscapeAction = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 7, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("ignoreEscape", 1), ("hangUp", 2), ("enterCommandMode", 3),)).clone('ignoreEscape')).setMaxAccess("readwrite")
...
mdmCCConnectionFailReason = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 7, 1, 6), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6, 10, 11, 20, 30, 31, 32, 33, 40, 41, 42,)).clone(namedValues=NamedValues(("unknown", 1), ("other", 2), ("managementCommand", 3), ("inactivityTimeout", 4), ("mnpIncompatibility", 5), ("protocolError", 6), ("powerLoss", 10), ("equipmentFailure", 11), ("dtrDrop", 20), ("noDialTone", 30), ("lineBusy", 31), ("noAnswer", 32), ("voiceDetected", 33), ("carrierLost", 40), ("trainingFailed", 41), ("faxDetected", 42),))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("Modem-MIB", mdmLineCapabilitiesEntry=mdmLineCapabilitiesEntry, mdmIDProductDetails=mdmIDProductDetails, mdmMIBObjects=mdmMIBObjects, mdmSCTable=mdmSCTable, mdmLineTable=mdmLineTable, mdmLineCapabilitiesEnableGranted=mdmLineCapabilitiesEnableGranted, mdmStatisticsGroup=mdmStatisticsGroup, mdmSCInitialLineTransmitRate=mdmSCInitialLineTransmitRate, mdmLineCapabilitiesIndex=mdmLineCapabilitiesIndex, mdmCompliance=mdmCompliance, mdmMib=mdmMib, mdmIDGroup=mdmIDGroup, mdmLineCapabilitiesEnableRequested=mdmLineCapabilitiesEnableRequested, mdmLineCapabilitiesV21=mdmLineCapabilitiesV21, mdmCompliances=mdmCompliances, mdmCCCallSetUpFailTimer=mdmCCCallSetUpFailTimer, mdmErrorControlGroup=mdmErrorControlGroup, mdmIDManufacturerOID=mdmIDManufacturerOID, mdmDCEntry=mdmDCEntry, mdmStatsCompressionEfficiency=mdmStatsCompressionEfficiency, mdmLineCapabilitiesV32bis=mdmLineCapabilitiesV32bis, mdmLineCapabilitiesV32terbo=mdmLineCapabilitiesV32terbo, mdmDCCompressionTypeUsed=mdmDCCompressionTypeUsed, mdmLineCapabilitiesV34=mdmLineCapabilitiesV34, mdmStatsTable=mdmStatsTable, mdmStatsIncomingConnectionCompletions=mdmStatsIncomingConnectionCompletions, mdmStatsOutgoingConnectionFailures=mdmStatsOutgoingConnectionFailures, mdmDTEInterfaceTable=mdmDTEInterfaceTable, mdmStatsSentDataFrames=mdmStatsSentDataFrames, mdmStatsOutgoingConnectionCompletions=mdmStatsOutgoingConnectionCompletions, mdmStatsFailedDialAttempts=mdmStatsFailedDialAttempts, mdmLineCapabilitiesV27ter=mdmLineCapabilitiesV27ter, mdmCCResultCodeEnable=mdmCCResultCodeEnable, mdmDTEInactivityTimeout=mdmDTEInactivityTimeout, mdmSCModulationSchemeUsed=mdmSCModulationSchemeUsed, mdmCCStoredDialStringTable=mdmCCStoredDialStringTable, mdmLineCapabilitiesMNP1=mdmLineCapabilitiesMNP1, mdmLineCapabilitiesMNP9=mdmLineCapabilitiesMNP9, mdmLineCapabilitiesV22bis=mdmLineCapabilitiesV22bis, PYSNMP_MODULE_ID=mdmMIB, mdmGroups=mdmGroups, mdmECEntry=mdmECEntry, mdmLineCapabilitiesV32=mdmLineCapabilitiesV32, mdmCCConnectionFailReason=mdmCCConnectionFailReason, mdmLineInterfaceGroup=mdmLineInterfaceGroup, mdmLineCapabilitiesTable=mdmLineCapabilitiesTable, mdmDTEActionDTROnToOff=mdmDTEActionDTROnToOff, mdmLineEntry=mdmLineEntry, mdmConformance=mdmConformance, mdmSCCurrentLineTransmitRate=mdmSCCurrentLineTransmitRate, mdmLineCapabilitiesID=mdmLineCapabilitiesID, mdmDTEInterfaceGroup=mdmDTEInterfaceGroup, mdmStats2400OrLessConnections=mdmStats2400OrLessConnections, mdmLineCapabilitiesBell208=mdmLineCapabilitiesBell208, mdmLineCapabilitiesV22=mdmLineCapabilitiesV22, mdmLineCarrierLossTime=mdmLineCarrierLossTime, mdmDTEInterfaceEntry=mdmDTEInterfaceEntry, mdmStatsResentFrames=mdmStatsResentFrames, mdmDCTable=mdmDCTable, mdmCallControlEntry=mdmCallControlEntry, mdmStatsSentOctets=mdmStatsSentOctets, mdmStatsReceivedDataFrames=mdmStatsReceivedDataFrames, mdmStatsIncomingConnectionFailures=mdmStatsIncomingConnectionFailures, mdmLineCapabilitiesV23CC=mdmLineCapabilitiesV23CC, mdmIndex=mdmIndex, mdmStatsEntry=mdmStatsEntry, mdmStatsGreaterThan14400Connections=mdmStatsGreaterThan14400Connections, mdmLineCapabilitiesV25bis=mdmLineCapabilitiesV25bis, mdmCCEscapeAction=mdmCCEscapeAction, mdmCCStoredDialString=mdmCCStoredDialString, mdmCallControlGroup=mdmCallControlGroup, mdmLineCapabilitiesV26bis=mdmLineCapabilitiesV26bis, mdmStatsErrorControlledConnections=mdmStatsErrorControlledConnections, mdmDTESyncTimingSource=mdmDTESyncTimingSource, mdmStatsErrorFrames=mdmStatsErrorFrames, mdmLineCapabilitiesMNP3=mdmLineCapabilitiesMNP3, mdmLineState=mdmLineState, mdmLineCapabilitiesV23SC=mdmLineCapabilitiesV23SC, mdmLineCapabilities=mdmLineCapabilities, mdmLineCapabilitiesV29=mdmLineCapabilitiesV29, mdmStatsCompressedConnections=mdmStatsCompressedConnections, mdmDataCompressionGroup=mdmDataCompressionGroup, mdmLineCapabilitiesV42=mdmLineCapabilitiesV42, mdmDTESyncAsyncMode=mdmDTESyncAsyncMode, mdmCallControlTable=mdmCallControlTable, mdmSCInitialLineReceiveRate=mdmSCInitialLineReceiveRate, mdmLineCapabilitiesMNP4=mdmLineCapabilitiesMNP4, mdmSCCurrentLineReceiveRate=mdmSCCurrentLineReceiveRate, mdmCCCallDuration=mdmCCCallDuration, mdmStatsReceivedOctets=mdmStatsReceivedOctets, mdmLineCapabilitiesMNP10=mdmLineCapabilitiesMNP10, mdmLineCapabilitiesMNP7=mdmLineCapabilitiesMNP7, mdmSCEntry=mdmSCEntry, mdmLineCapabilitiesV26ter=mdmLineCapabilitiesV26ter, mdmLineCapabilitiesMNP6=mdmLineCapabilitiesMNP6, mdmMIB=mdmMIB, mdmLineCapabilitiesV33=mdmLineCapabilitiesV33, mdmNumber=mdmNumber, mdmCCStoredDialStringEntry=mdmCCStoredDialStringEntry, mdmLineCapabilitiesVFC=mdmLineCapabilitiesVFC, mdmCCStoredDialStringIndex=mdmCCStoredDialStringIndex, mdmECTable=mdmECTable, mdmECErrorControlUsed=mdmECErrorControlUsed, mdmStats2400To14400Connections=mdmStats2400To14400Connections, mdmIDTable=mdmIDTable, mdmLineCapabilitiesMNP8=mdmLineCapabilitiesMNP8, mdmSignalConvertorGroup=mdmSignalConvertorGroup, mdmIDEntry=mdmIDEntry, mdmDTEActionDTROffToOn=mdmDTEActionDTROffToOn, mdmLineCapabilitiesV42bis=mdmLineCapabilitiesV42bis, mdmLineCapabilitiesMNP5=mdmLineCapabilitiesMNP5, mdmLineCapabilitiesMNP2=mdmLineCapabilitiesMNP2, mdmStatsRetrains=mdmStatsRetrains, mdmCCRingsBeforeAnswer=mdmCCRingsBeforeAnswer, mdmStatsRingNoAnswers=mdmStatsRingNoAnswers)
