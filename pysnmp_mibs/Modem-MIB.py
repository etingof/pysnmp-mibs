...
# by libsmi2pysnmp-0.0.7-alpha at Wed Feb  7 16:13:03 2007,
...
mdmDTEActionDTROnToOff = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 6, 1, 1), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,3,2,4,)).subtype(namedValues=namedval.NamedValues(("ignore", 1), ("escapeToCommandMode", 2), ("disconnectCall", 3), ("resetModem", 4), )).clone(3)).setMaxAccess("readwrite")
mdmDTEActionDTROffToOn = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 6, 1, 2), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,2,3,4,)).subtype(namedValues=namedval.NamedValues(("ignore", 1), ("enableDial", 2), ("autoAnswerEnable", 3), ("establishConnection", 4), )).clone(3)).setMaxAccess("readwrite")
mdmDTESyncTimingSource = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 6, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(4,3,1,2,)).subtype(namedValues=namedval.NamedValues(("internal", 1), ("external", 2), ("loopback", 3), ("network", 4), )).clone(1)).setMaxAccess("readwrite")
...
mdmCCEscapeAction = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 7, 1, 4), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(2,1,3,)).subtype(namedValues=namedval.NamedValues(("ignoreEscape", 1), ("hangUp", 2), ("enterCommandMode", 3), )).clone(1)).setMaxAccess("readwrite")
mdmCCCallDuration = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 7, 1, 5), Integer32()).setMaxAccess("readonly")
mdmCCConnectionFailReason = MibTableColumn((1, 3, 6, 1, 2, 1, 38, 1, 1, 7, 1, 6), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(33,10,1,41,32,11,30,4,2,5,40,20,3,6,42,31,)).subtype(namedValues=namedval.NamedValues(("unknown", 1), ("powerLoss", 10), ("equipmentFailure", 11), ("other", 2), ("dtrDrop", 20), ("managementCommand", 3), ("noDialTone", 30), ("lineBusy", 31), ("noAnswer", 32), ("voiceDetected", 33), ("inactivityTimeout", 4), ("carrierLost", 40), ("trainingFailed", 41), ("faxDetected", 42), ("mnpIncompatibility", 5), ("protocolError", 6), ))).setMaxAccess("readonly")
