...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:30:48 2015
...
( ipMRouteNextHopGroup, ipMRouteNextHopSourceMask, ipMRouteNextHopAddress, ipMRouteSource, ipMRouteNextHopSource, ipMRouteNextHopIfIndex, ipMRouteGroup, ipMRouteSourceMask, ) = mibBuilder.importSymbols("IPMROUTE-STD-MIB", "ipMRouteNextHopGroup", "ipMRouteNextHopSourceMask", "ipMRouteNextHopAddress", "ipMRouteSource", "ipMRouteNextHopSource", "ipMRouteNextHopIfIndex", "ipMRouteGroup", "ipMRouteSourceMask")
( NotificationGroup, ModuleCompliance, ObjectGroup, ) = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance", "ObjectGroup")
( Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Bits, TimeTicks, Counter64, Unsigned32, ModuleIdentity, Counter32, iso, ObjectIdentity, IpAddress, experimental, Gauge32, ) = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Bits", "TimeTicks", "Counter64", "Unsigned32", "ModuleIdentity", "Counter32", "iso", "ObjectIdentity", "IpAddress", "experimental", "Gauge32")
...
pimInterfaceMode = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 2, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("dense", 1), ("sparse", 2), ("sparseDense", 3),)).clone('dense')).setMaxAccess("readcreate")
...
pimNeighborMode = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 3, 1, 5), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2,)).clone(namedValues=NamedValues(("dense", 1), ("sparse", 2),))).setMaxAccess("readonly")
...
pimIpMRouteEntry = MibTableRow((1, 3, 6, 1, 3, 61, 1, 1, 4, 1), ).setIndexNames((0, "PIM-MIB", "ipMRouteGroup"), (0, "PIM-MIB", "ipMRouteSource"), (0, "PIM-MIB", "ipMRouteSourceMask"))
...
pimIpMRouteNextHopEntry = MibTableRow((1, 3, 6, 1, 3, 61, 1, 1, 7, 1), ).setIndexNames((0, "PIM-MIB", "ipMRouteNextHopGroup"), (0, "PIM-MIB", "ipMRouteNextHopSource"), (0, "PIM-MIB", "ipMRouteNextHopSourceMask"), (0, "PIM-MIB", "ipMRouteNextHopIfIndex"), (0, "PIM-MIB", "ipMRouteNextHopAddress"))
...
pimIpMRouteNextHopPruneReason = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 7, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("other", 1), ("prune", 2), ("assert", 3),))).setMaxAccess("readonly")
...
pimRPState = MibTableColumn((1, 3, 6, 1, 3, 61, 1, 1, 5, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2,)).clone(namedValues=NamedValues(("up", 1), ("down", 2),))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("PIM-MIB", pimComponentBSRAddress=pimComponentBSRAddress, pimIpMRouteFlags=pimIpMRouteFlags, pimIpMRouteAssertMetricPref=pimIpMRouteAssertMetricPref, pimRPStateTimer=pimRPStateTimer, pimNeighborMode=pimNeighborMode, pimNeighborUpTime=pimNeighborUpTime, pimNotificationGroup=pimNotificationGroup, pimRPSetGroupMask=pimRPSetGroupMask, pimRPSetTable=pimRPSetTable, pimJoinPruneInterval=pimJoinPruneInterval, pimMIBGroups=pimMIBGroups, pimCandidateRPRowStatus=pimCandidateRPRowStatus, pimInterfaceStatus=pimInterfaceStatus, pimRPGroupAddress=pimRPGroupAddress, pimInterfaceDR=pimInterfaceDR, pimComponentTable=pimComponentTable, pimTraps=pimTraps, pimInterfaceCBSRPreference=pimInterfaceCBSRPreference, pimRPAddress=pimRPAddress, pimV1MIBGroup=pimV1MIBGroup, pimNeighborExpiryTime=pimNeighborExpiryTime, pimNeighborLoss=pimNeighborLoss, pimDenseV2MIBCompliance=pimDenseV2MIBCompliance, pimRPSetAddress=pimRPSetAddress, pimIpMRouteNextHopEntry=pimIpMRouteNextHopEntry, pimNeighborIfIndex=pimNeighborIfIndex, pimNeighborEntry=pimNeighborEntry, pim=pim, pimIpMRouteAssertRPTBit=pimIpMRouteAssertRPTBit, pimComponentBSRExpiryTime=pimComponentBSRExpiryTime, pimInterfaceJoinPruneInterval=pimInterfaceJoinPruneInterval, pimMIBConformance=pimMIBConformance, pimIpMRouteAssertMetric=pimIpMRouteAssertMetric, pimRPSetComponent=pimRPSetComponent, pimRPState=pimRPState, pimNeighborAddress=pimNeighborAddress, pimCandidateRPTable=pimCandidateRPTable, pimRPTable=pimRPTable, pimInterfaceEntry=pimInterfaceEntry, pimNextHopGroup=pimNextHopGroup, pimComponentEntry=pimComponentEntry, pimMIB=pimMIB, pimCandidateRPGroupMask=pimCandidateRPGroupMask, pimRPSetGroupAddress=pimRPSetGroupAddress, pimNeighborTable=pimNeighborTable, pimRPRowStatus=pimRPRowStatus, pimRPEntry=pimRPEntry, pimMIBCompliances=pimMIBCompliances, pimInterfaceTable=pimInterfaceTable, pimRPSetExpiryTime=pimRPSetExpiryTime, pimIpMRouteNextHopTable=pimIpMRouteNextHopTable, pimInterfaceHelloInterval=pimInterfaceHelloInterval, pimComponentStatus=pimComponentStatus, pimComponentIndex=pimComponentIndex, pimRPLastChange=pimRPLastChange, pimRPSetEntry=pimRPSetEntry, pimAssertGroup=pimAssertGroup, pimDenseV2MIBGroup=pimDenseV2MIBGroup, pimInterfaceNetMask=pimInterfaceNetMask, pimCandidateRPAddress=pimCandidateRPAddress, pimInterfaceIfIndex=pimInterfaceIfIndex, pimIpMRouteNextHopPruneReason=pimIpMRouteNextHopPruneReason, pimInterfaceAddress=pimInterfaceAddress, PYSNMP_MODULE_ID=pimMIB, pimV2CandidateRPMIBGroup=pimV2CandidateRPMIBGroup, pimInterfaceMode=pimInterfaceMode, pimCandidateRPGroupAddress=pimCandidateRPGroupAddress, pimCandidateRPEntry=pimCandidateRPEntry, pimIpMRouteUpstreamAssertTimer=pimIpMRouteUpstreamAssertTimer, pimV2MIBGroup=pimV2MIBGroup, pimIpMRouteEntry=pimIpMRouteEntry, pimSparseV2MIBCompliance=pimSparseV2MIBCompliance, pimRPSetHoldTime=pimRPSetHoldTime, pimComponentCRPHoldTime=pimComponentCRPHoldTime, pimV1MIBCompliance=pimV1MIBCompliance, pimMIBObjects=pimMIBObjects, pimIpMRouteTable=pimIpMRouteTable)
