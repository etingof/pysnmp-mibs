...
etherWisDeviceTxTestPatternMode = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 1, 1, 1, 1, 1)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(2,1,4,3,)).addNamedValues(("none", 1), ("squareWave", 2), ("prbs31", 3), ("mixedFrequency", 4), )).setMaxAccess("readwrite"))
etherWisDeviceRxTestPatternMode = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 1, 1, 1, 1, 2)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,4,3,)).addNamedValues(("none", 1), ("prbs31", 3), ("mixedFrequency", 4), )).setMaxAccess("readwrite"))
etherWisDeviceRxTestPatternErrors = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 1, 1, 1, 1, 3)).setColumnInitializer(MibVariable((), Gauge32().addConstraints(subtypes.ValueRangeConstraint(0, 65535))).setMaxAccess("readwrite"))
...
etherWisSectionCurrentJ0Transmitted = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 1, 2, 1, 1, 1)).setColumnInitializer(MibVariable((), OctetString().addConstraints(subtypes.ValueRangeConstraint(16, 16))).setMaxAccess("readwrite"))
etherWisSectionCurrentJ0Received = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 1, 2, 1, 1, 2)).setColumnInitializer(MibVariable((), OctetString().addConstraints(subtypes.ValueRangeConstraint(16, 16))).setMaxAccess("readonly"))
...
etherWisPathCurrentStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 2, 1, 1, 1, 1)).setColumnInitializer(MibVariable((), Bits().addNamedValues(("etherWisPathLOP", 0), ("etherWisPathAIS", 1), ("etherWisPathPLM", 2), ("etherWisPathLCD", 3), )).setMaxAccess("readonly"))
etherWisPathCurrentJ1Transmitted = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 2, 1, 1, 1, 2)).setColumnInitializer(MibVariable((), OctetString().addConstraints(subtypes.ValueRangeConstraint(16, 16))).setMaxAccess("readwrite"))
etherWisPathCurrentJ1Received = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 2, 1, 1, 1, 3)).setColumnInitializer(MibVariable((), OctetString().addConstraints(subtypes.ValueRangeConstraint(16, 16))).setMaxAccess("readonly"))
...
etherWisFarEndPathCurrentStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 134, 2, 2, 1, 1, 1)).setColumnInitializer(MibVariable((), Bits().addNamedValues(("etherWisFarEndPayloadDefect", 0), ("etherWisFarEndServerDefect", 1), )).setMaxAccess("readonly"))
