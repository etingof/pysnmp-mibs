...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:13:16 2006,
...
traceRouteCtlTargetAddressType = MibTableColumn((1, 3, 6, 1, 2, 1, 81, 1, 2, 1, 3), InetAddressType().clone('ipv4')).setMaxAccess("readcreate")
...
traceRouteCtlInitialTtl = MibTableColumn((1, 3, 6, 1, 2, 1, 81, 1, 2, 1, 18), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 255)).clone(1)).setMaxAccess("readcreate")
...
traceRouteCtlDescr = MibTableColumn((1, 3, 6, 1, 2, 1, 81, 1, 2, 1, 22), SnmpAdminString().clone('0x00')).setMaxAccess("readcreate")
