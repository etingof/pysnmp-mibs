...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:26:46 2015
...
dsTableEntry = MibTableRow((1, 3, 6, 1, 2, 1, 66, 1, 1), ).setIndexNames((0, "DIRECTORY-SERVER-MIB", "applIndex"))
...
dsApplIfOpsEntry = MibTableRow((1, 3, 6, 1, 2, 1, 66, 2, 1), ).setIndexNames((0, "DIRECTORY-SERVER-MIB", "applIndex"), (0, "DIRECTORY-SERVER-MIB", "dsApplIfProtocolIndex"))
...
dsIntEntry = MibTableRow((1, 3, 6, 1, 2, 1, 66, 3, 1), ).setIndexNames((0, "DIRECTORY-SERVER-MIB", "applIndex"), (0, "DIRECTORY-SERVER-MIB", "dsIntEntIndex"), (0, "DIRECTORY-SERVER-MIB", "dsApplIfProtocolIndex"))
...
mibBuilder.exportSymbols("DIRECTORY-SERVER-MIB", dsApplIfOneLevelSearchOps=dsApplIfOneLevelSearchOps, dsIntCompliance=dsIntCompliance, dsIntEntFailuresSinceLastSuccess=dsIntEntFailuresSinceLastSuccess, dsIntEntTimeOfLastAttempt=dsIntEntTimeOfLastAttempt, dsApplIfReplicationUpdatesOut=dsApplIfReplicationUpdatesOut, dsConformance=dsConformance, dsMIB=dsMIB, dsIntGroup=dsIntGroup, dsIntTable=dsIntTable, dsApplIfInBytes=dsApplIfInBytes, dsIntEntry=dsIntEntry, dsIntEntTimeOfLastSuccess=dsIntEntTimeOfLastSuccess, dsIntEntURL=dsIntEntURL, dsApplIfCompareOps=dsApplIfCompareOps, dsApplIfListOps=dsApplIfListOps, dsCacheEntries=dsCacheEntries, dsServerDescription=dsServerDescription, dsIntEntTimeOfCreation=dsIntEntTimeOfCreation, dsApplIfProtocol=dsApplIfProtocol, PYSNMP_MODULE_ID=dsMIB, dsOpsGroup=dsOpsGroup, dsApplIfOpsEntry=dsApplIfOpsEntry, dsApplIfSimpleAuthBinds=dsApplIfSimpleAuthBinds, dsIntEntDirectoryName=dsIntEntDirectoryName, dsOpsCompliance=dsOpsCompliance, dsApplIfAddEntryOps=dsApplIfAddEntryOps, dsServerType=dsServerType, dsIntEntFailures=dsIntEntFailures, dsApplIfUnauthBinds=dsApplIfUnauthBinds, dsApplIfRemoveEntryOps=dsApplIfRemoveEntryOps, dsMasterEntries=dsMasterEntries, dsApplIfReadOps=dsApplIfReadOps, dsApplIfBindSecurityErrors=dsApplIfBindSecurityErrors, dsApplIfErrors=dsApplIfErrors, dsApplIfInOps=dsApplIfInOps, dsApplIfWholeSubtreeSearchOps=dsApplIfWholeSubtreeSearchOps, dsTable=dsTable, dsIntEntSuccesses=dsIntEntSuccesses, dsGroups=dsGroups, dsEntryCompliance=dsEntryCompliance, dsApplIfOpsTable=dsApplIfOpsTable, dsCacheHits=dsCacheHits, dsApplIfReplicationUpdatesIn=dsApplIfReplicationUpdatesIn, dsApplIfChainings=dsApplIfChainings, dsApplIfReferrals=dsApplIfReferrals, dsApplIfSecurityErrors=dsApplIfSecurityErrors, dsCompliances=dsCompliances, dsApplIfOutBytes=dsApplIfOutBytes, dsApplIfStrongAuthBinds=dsApplIfStrongAuthBinds, dsIntEntIndex=dsIntEntIndex, dsApplIfProtocolIndex=dsApplIfProtocolIndex, dsApplIfModifyEntryOps=dsApplIfModifyEntryOps, dsSlaveHits=dsSlaveHits, dsCopyEntries=dsCopyEntries, dsApplIfModifyRDNOps=dsApplIfModifyRDNOps, dsTableEntry=dsTableEntry, dsApplIfSearchOps=dsApplIfSearchOps, dsOpsIntCompliance=dsOpsIntCompliance, dsEntryGroup=dsEntryGroup)
