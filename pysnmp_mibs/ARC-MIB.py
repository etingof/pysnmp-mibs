...
arcState = MibTableColumn((1, 3, 6, 1, 2, 1, 117, 2, 1, 1, 4), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(4,3,2,1,)).subtype(namedValues=namedval.NamedValues(("nalm", 1), ("nalmQI", 2), ("nalmTI", 3), ("nalmQICD", 4), ))).setMaxAccess("readcreate")
...
# Groups
mibBuilder.exportSymbols("ARC-MIB", arcTIGroup=arcTIGroup, arcSettingGroup=arcSettingGroup, arcQICDGroup=arcQICDGroup)
