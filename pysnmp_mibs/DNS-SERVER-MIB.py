...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:26:58 2015
...
dnsServConfigRecurs = MibScalar((1, 3, 6, 1, 2, 1, 32, 1, 1, 1, 2), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("available", 1), ("restricted", 2), ("unavailable", 3),))).setMaxAccess("readwrite")
...
dnsServConfigReset = MibScalar((1, 3, 6, 1, 2, 1, 32, 1, 1, 1, 5), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("other", 1), ("reset", 2), ("initializing", 3), ("running", 4),))).setMaxAccess("readwrite")
...
dnsServCounterTransport = MibTableColumn((1, 3, 6, 1, 2, 1, 32, 1, 1, 2, 13, 1, 4), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3,)).clone(namedValues=NamedValues(("udp", 1), ("tcp", 2), ("other", 3),)))
...
mibBuilder.exportSymbols("DNS-SERVER-MIB", dnsServCounterAuthNoNames=dnsServCounterAuthNoNames, dnsServOptCounterFriendsNonAuthDatas=dnsServOptCounterFriendsNonAuthDatas, DnsRespCode=DnsRespCode, dns=dns, dnsServCounterOtherErrors=dnsServCounterOtherErrors, dnsServZoneSrcStatus=dnsServZoneSrcStatus, DnsTime=DnsTime, dnsServZoneLastSourceAttempt=dnsServZoneLastSourceAttempt, dnsServConfigUpTime=dnsServConfigUpTime, dnsServCounterRequests=dnsServCounterRequests, DnsName=DnsName, dnsServZoneName=dnsServZoneName, dnsServOptCounterSelfErrors=dnsServOptCounterSelfErrors, dnsServCounterReqUnparses=dnsServCounterReqUnparses, dnsServZoneGroup=dnsServZoneGroup, dnsServCounterAuthAns=dnsServCounterAuthAns, DnsQType=DnsQType, dnsServOptCounterFriendsReferrals=dnsServOptCounterFriendsReferrals, dnsServOptCounterFriendsReqRefusals=dnsServOptCounterFriendsReqRefusals, dnsServZoneLastReloadAttempt=dnsServZoneLastReloadAttempt, dnsServOptCounterFriendsErrors=dnsServOptCounterFriendsErrors, dnsServZoneSrcName=dnsServZoneSrcName, dnsServOptCounterSelfNonAuthDatas=dnsServOptCounterSelfNonAuthDatas, dnsServMIBCompliance=dnsServMIBCompliance, dnsServCounterErrors=dnsServCounterErrors, DnsClass=DnsClass, dnsServOptCounterFriendsReqUnparses=dnsServOptCounterFriendsReqUnparses, dnsServZone=dnsServZone, dnsServConfigImplementIdent=dnsServConfigImplementIdent, DnsType=DnsType, dnsServOptCounterSelfAuthAns=dnsServOptCounterSelfAuthAns, dnsServOptCounterFriendsNonAuthNoDatas=dnsServOptCounterFriendsNonAuthNoDatas, DnsNameAsIndex=DnsNameAsIndex, dnsServZoneSrcAddr=dnsServZoneSrcAddr, dnsServConfigGroup=dnsServConfigGroup, dnsServOptCounterSelfAuthNoDataResps=dnsServOptCounterSelfAuthNoDataResps, dnsServCounterNonAuthDatas=dnsServCounterNonAuthDatas, dnsServOptCounterFriendsRelNames=dnsServOptCounterFriendsRelNames, dnsServCounter=dnsServCounter, dnsServCounterReqRefusals=dnsServCounterReqRefusals, dnsServCounterTable=dnsServCounterTable, dnsServMIBObjects=dnsServMIBObjects, dnsServCounterOpCode=dnsServCounterOpCode, dnsServConfigResetTime=dnsServConfigResetTime, dnsServMIBGroups=dnsServMIBGroups, dnsServOptCounterSelfOtherErrors=dnsServOptCounterSelfOtherErrors, dnsServOptCounterSelfRelNames=dnsServOptCounterSelfRelNames, dnsServConfigReset=dnsServConfigReset, dnsServCounterQClass=dnsServCounterQClass, dnsServZoneTable=dnsServZoneTable, dnsServCounterEntry=dnsServCounterEntry, dnsServZoneSerial=dnsServZoneSerial, dnsServZoneClass=dnsServZoneClass, PYSNMP_MODULE_ID=dnsServMIB, dnsServOptCounterSelfAuthNoNames=dnsServOptCounterSelfAuthNoNames, dnsServOptCounterFriendsAuthAns=dnsServOptCounterFriendsAuthAns, dnsServCounterAuthNoDataResps=dnsServCounterAuthNoDataResps, dnsServMIB=dnsServMIB, dnsServZoneSrcTable=dnsServZoneSrcTable, dnsServCounterTransport=dnsServCounterTransport, DnsOpCode=DnsOpCode, dnsServOptCounterSelfReqRefusals=dnsServOptCounterSelfReqRefusals, dnsServCounterRelNames=dnsServCounterRelNames, dnsServZoneStatus=dnsServZoneStatus, dnsServOptCounter=dnsServOptCounter, dnsServZoneLastSourceSuccess=dnsServZoneLastSourceSuccess, dnsServOptCounterFriendsAuthNoNames=dnsServOptCounterFriendsAuthNoNames, dnsServOptCounterFriendsAuthNoDataResps=dnsServOptCounterFriendsAuthNoDataResps, dnsServCounterReferrals=dnsServCounterReferrals, dnsServConfig=dnsServConfig, dnsServOptCounterSelfReqUnparses=dnsServOptCounterSelfReqUnparses, dnsServCounterGroup=dnsServCounterGroup, dnsServConfigRecurs=dnsServConfigRecurs, dnsServCounterResponses=dnsServCounterResponses, dnsServCounterNonAuthNoDatas=dnsServCounterNonAuthNoDatas, dnsServZoneSrcEntry=dnsServZoneSrcEntry, dnsServZoneSrcClass=dnsServZoneSrcClass, dnsServOptCounterSelfReferrals=dnsServOptCounterSelfReferrals, DnsQClass=DnsQClass, dnsServMIBCompliances=dnsServMIBCompliances, dnsServZoneCurrent=dnsServZoneCurrent, dnsServZoneLastReloadSuccess=dnsServZoneLastReloadSuccess, dnsServOptCounterFriendsOtherErrors=dnsServOptCounterFriendsOtherErrors, dnsServOptCounterGroup=dnsServOptCounterGroup, dnsServOptCounterSelfNonAuthNoDatas=dnsServOptCounterSelfNonAuthNoDatas, dnsServCounterQType=dnsServCounterQType, dnsServZoneEntry=dnsServZoneEntry)
