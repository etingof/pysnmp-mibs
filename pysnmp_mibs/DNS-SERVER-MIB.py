...
( Bits, Counter32, Gauge32, Integer32, IpAddress, ModuleIdentity, MibIdentifier, ObjectIdentity, MibVariable, MibTable, MibTableRow, MibTableColumn, TimeTicks, ) = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Gauge32", "Integer32", "IpAddress", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "MibVariable", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
class DnsOpCode(Integer32):
    subtypeConstraints = Integer32.subtypeConstraints + ( subtypes.ValueRangeConstraint(0, 15), )
    pass
...
dnsServConfigRecurs = MibVariable((1, 3, 6, 1, 2, 1, 32, 1, 1, 1, 2), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,3,)).addNamedValues(("available", 1), ("restricted", 2), ("unavailable", 3), )).setMaxAccess("readwrite")
...
dnsServConfigReset = MibVariable((1, 3, 6, 1, 2, 1, 32, 1, 1, 1, 5), Integer().addConstraints(subtypes.SingleValueConstraint(2,3,4,1,)).addNamedValues(("other", 1), ("reset", 2), ("initializing", 3), ("running", 4), )).setMaxAccess("readwrite")
...
dnsServCounterTransport = MibTableColumn((1, 3, 6, 1, 2, 1, 32, 1, 1, 2, 13, 1, 4)).setColumnInitializer(MibVariable((), Integer().addConstraints(subtypes.SingleValueConstraint(1,3,2,)).addNamedValues(("udp", 1), ("tcp", 2), ("other", 3), )).setMaxAccess("noaccess"))
