...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:33:09 2015
...
( DisplayString, TimeInterval, TextualConvention, DateAndTime, ) = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeInterval", "TextualConvention", "DateAndTime")
...
wwwServiceType = MibTableColumn((1, 3, 6, 1, 2, 1, 65, 1, 1, 1, 1, 6), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5,)).clone(namedValues=NamedValues(("wwwOther", 1), ("wwwServer", 2), ("wwwClient", 3), ("wwwProxy", 4), ("wwwCachingProxy", 5),))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("WWW-MIB", wwwDocAccessTopNEntry=wwwDocAccessTopNEntry, wwwResponseOutLastTime=wwwResponseOutLastTime, wwwDocBucketTable=wwwDocBucketTable, wwwRequestOutIndex=wwwRequestOutIndex, wwwRequestInTable=wwwRequestInTable, wwwResponseOutResponses=wwwResponseOutResponses, wwwDocBytesTopNTable=wwwDocBytesTopNTable, wwwDocLastNResponseType=wwwDocLastNResponseType, wwwDocAccessTopNAccesses=wwwDocAccessTopNAccesses, wwwMIBConformance=wwwMIBConformance, wwwRequestOutBytes=wwwRequestOutBytes, wwwServiceLastChange=wwwServiceLastChange, wwwServiceProtocol=wwwServiceProtocol, wwwDocBytesTopNEntry=wwwDocBytesTopNEntry, wwwRequestInEntry=wwwRequestInEntry, wwwDocLastNEntry=wwwDocLastNEntry, wwwSummaryInLowBytes=wwwSummaryInLowBytes, wwwDocCtrlBuckets=wwwDocCtrlBuckets, wwwServiceType=wwwServiceType, WwwDocName=WwwDocName, wwwServiceDescription=wwwServiceDescription, wwwDocBucketEntry=wwwDocBucketEntry, wwwResponseInTable=wwwResponseInTable, wwwMinimalCompliance=wwwMinimalCompliance, wwwResponseOutEntry=wwwResponseOutEntry, wwwResponseOutGroup=wwwResponseOutGroup, wwwServiceContact=wwwServiceContact, wwwServiceEntry=wwwServiceEntry, wwwDocBytesTopNIndex=wwwDocBytesTopNIndex, wwwFullCompliance=wwwFullCompliance, wwwResponseOutBytes=wwwResponseOutBytes, wwwSummaryInResponses=wwwSummaryInResponses, wwwDocCtrlBucketTimeInterval=wwwDocCtrlBucketTimeInterval, wwwSummaryOutLowBytes=wwwSummaryOutLowBytes, WwwOperStatus=WwwOperStatus, wwwDocLastNTimeStamp=wwwDocLastNTimeStamp, wwwRequestInLastTime=wwwRequestInLastTime, wwwResponseInEntry=wwwResponseInEntry, wwwMIBObjects=wwwMIBObjects, wwwServiceGroup=wwwServiceGroup, wwwResponseInResponses=wwwResponseInResponses, wwwProtocolStatistics=wwwProtocolStatistics, wwwMIBCompliances=wwwMIBCompliances, wwwDocLastNStatusMsg=wwwDocLastNStatusMsg, wwwServiceTable=wwwServiceTable, wwwDocLastNName=wwwDocLastNName, wwwDocBucketIndex=wwwDocBucketIndex, wwwRequestInRequests=wwwRequestInRequests, WwwRequestType=WwwRequestType, wwwDocumentStatistics=wwwDocumentStatistics, wwwDocLastNIndex=wwwDocLastNIndex, wwwDocCtrlTable=wwwDocCtrlTable, wwwDocCtrlEntry=wwwDocCtrlEntry, wwwSummaryInBytes=wwwSummaryInBytes, wwwDocLastNRequestType=wwwDocLastNRequestType, wwwDocAccessTopNBytes=wwwDocAccessTopNBytes, wwwDocumentGroup=wwwDocumentGroup, wwwDocBucketBytes=wwwDocBucketBytes, wwwDocAccessTopNTable=wwwDocAccessTopNTable, wwwDocBytesTopNName=wwwDocBytesTopNName, wwwDocCtrlTopNSize=wwwDocCtrlTopNSize, wwwDocBytesTopNLastResponseType=wwwDocBytesTopNLastResponseType, wwwResponseOutIndex=wwwResponseOutIndex, wwwServiceIndex=wwwServiceIndex, wwwDocAccessTopNLastResponseType=wwwDocAccessTopNLastResponseType, wwwDocBucketDocuments=wwwDocBucketDocuments, wwwRequestOutLastTime=wwwRequestOutLastTime, wwwRequestInIndex=wwwRequestInIndex, wwwServiceStartTime=wwwServiceStartTime, wwwRequestOutTable=wwwRequestOutTable, wwwRequestOutGroup=wwwRequestOutGroup, wwwSummaryGroup=wwwSummaryGroup, wwwService=wwwService, wwwRequestOutRequests=wwwRequestOutRequests, wwwMIBGroups=wwwMIBGroups, wwwSummaryTable=wwwSummaryTable, wwwServiceName=wwwServiceName, wwwRequestOutEntry=wwwRequestOutEntry, wwwRequestInBytes=wwwRequestInBytes, wwwResponseInIndex=wwwResponseInIndex, wwwDocBytesTopNBytes=wwwDocBytesTopNBytes, wwwSummaryOutRequests=wwwSummaryOutRequests, wwwRequestInGroup=wwwRequestInGroup, PYSNMP_MODULE_ID=wwwMIB, WwwResponseType=WwwResponseType, wwwDocCtrlLastNLock=wwwDocCtrlLastNLock, wwwDocAccessTopNName=wwwDocAccessTopNName, wwwDocBytesTopNAccesses=wwwDocBytesTopNAccesses, wwwDocBucketAccesses=wwwDocBucketAccesses, wwwSummaryInRequests=wwwSummaryInRequests, wwwResponseInLastTime=wwwResponseInLastTime, wwwServiceOperStatus=wwwServiceOperStatus, wwwResponseInBytes=wwwResponseInBytes, wwwDocCtrlLastNSize=wwwDocCtrlLastNSize, wwwDocLastNBytes=wwwDocLastNBytes, wwwDocLastNTable=wwwDocLastNTable, wwwDocAccessTopNIndex=wwwDocAccessTopNIndex, wwwSummaryOutResponses=wwwSummaryOutResponses, wwwResponseOutTable=wwwResponseOutTable, wwwSummaryOutBytes=wwwSummaryOutBytes, wwwMIB=wwwMIB, wwwResponseInGroup=wwwResponseInGroup, wwwSummaryEntry=wwwSummaryEntry, wwwDocBucketTimeStamp=wwwDocBucketTimeStamp)
