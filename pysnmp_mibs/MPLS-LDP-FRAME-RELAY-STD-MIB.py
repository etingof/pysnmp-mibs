...
mplsLdpEntityFrameRelayMergeCap = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1, 1, 1, 1, 2), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,0,)).subtype(namedValues=namedval.NamedValues(("notSupported", 0), ("supported", 1), ))).setMaxAccess("readcreate")
...
mplsLdpEntityFrameRelayStorageType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1, 1, 1, 1, 5), StorageType()).setMaxAccess("readcreate")
...
mplsLdpEntityFrameRelayLRStorageType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 166, 6, 1, 1, 2, 1, 4), StorageType()).setMaxAccess("readcreate")
