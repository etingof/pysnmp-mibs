...
class IANAifJackType(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(9,15,11,3,7,8,12,4,2,1,13,6,5,10,14,)
    namedValues = namedval.NamedValues(("other", 1), ("fiberST", 10), ("telco", 11), ("mtrj", 12), ("hssdc", 13), ("fiberLC", 14), ("cx4", 15), ("rj45", 2), ("rj45S", 3), ("db9", 4), ("bnc", 5), ("fAUI", 6), ("mAUI", 7), ("fiberSC", 8), ("fiberMIC", 9), )
    pass

class IANAifMauAutoNegCapBits(Bits):
    namedValues = namedval.NamedValues(("bOther", 0), ("b10baseT", 1), ("bFdxSPause", 10), ("bFdxBPause", 11), ("b1000baseX", 12), ("b1000baseXFD", 13), ("b1000baseT", 14), ("b1000baseTFD", 15), ("b10baseTFD", 2), ("b100baseT4", 3), ("b100baseTX", 4), ("b100baseTXFD", 5), ("b100baseT2", 6), ("b100baseT2FD", 7), ("bFdxPause", 8), ("bFdxAPause", 9), )
    pass

class IANAifMauMediaAvailable(Integer):
    subtypeSpec = Integer.subtypeSpec+constraint.SingleValueConstraint(9,3,12,13,20,6,2,17,1,14,10,7,5,4,16,11,15,8,18,19,)
