...
fcipDynIpConfType = MibScalar((1, 3, 6, 1, 2, 1, 224, 1, 1, 1), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2,)).clone(namedValues=NamedValues(("slpv2", 1), ("none", 2),))).setMaxAccess("readwrite")
...
fcipEntitySACKOption = MibScalar((1, 3, 6, 1, 2, 1, 224, 1, 1, 3), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2,)).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2),))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("FCIP-MGMT-MIB", fcipLinkFcipReceivedSfDuplicates=fcipLinkFcipReceivedSfDuplicates, fcipLinkTcpExcessiveDroppedDatagrams=fcipLinkTcpExcessiveDroppedDatagrams, fcipLinkFcipSfInvalidWWNs=fcipLinkFcipSfInvalidWWNs, fcipLinkStatus=fcipLinkStatus, fcipTcpConnLocalPort=fcipTcpConnLocalPort, fcipDiscoveryDomainIndex=fcipDiscoveryDomainIndex, FcipEntityMode=FcipEntityMode, fcipTcpConnMSS=fcipTcpConnMSS, fcipLinkTcpSaParamMismatches=fcipLinkTcpSaParamMismatches, fcipEntitySeqNumWrap=fcipEntitySeqNumWrap, fcipLinkRemFcipEntityWWN=fcipLinkRemFcipEntityWWN, FcipDomainIdInOctetForm=FcipDomainIdInOctetForm, fcipDeviceWWN=fcipDeviceWWN, fcipLinkCost=fcipLinkCost, fcipLinkFcipSfInvalidNonces=fcipLinkFcipSfInvalidNonces, FcipEntityId=FcipEntityId, fcipLinkEntry=fcipLinkEntry, fcipMIB=fcipMIB, fcipLinkLocalFcipEntityAddressType=fcipLinkLocalFcipEntityAddressType, fcipLinkLocalFcipEntityMode=fcipLinkLocalFcipEntityMode, fcipStaticRouteGroup=fcipStaticRouteGroup, fcipLinkRemFcipEntityAddressType=fcipLinkRemFcipEntityAddressType, fcipTcpConnEntry=fcipTcpConnEntry, fcipLinkErrorsEntry=fcipLinkErrorsEntry, fcipDiscoveryDomainGroup=fcipDiscoveryDomainGroup, fcipStaticRouteStatus=fcipStaticRouteStatus, fcipConformance=fcipConformance, fcipLinkFcipEncapErrors=fcipLinkFcipEncapErrors, fcipEntityPHBSupport=fcipEntityPHBSupport, fcipLinkCreateTime=fcipLinkCreateTime, fcipStaticRouteDID=fcipStaticRouteDID, fcipLinkFcipBB2LkaTimeOuts=fcipLinkFcipBB2LkaTimeOuts, fcipEntityStatus=fcipEntityStatus, fcipDynIpConfType=fcipDynIpConfType, PYSNMP_MODULE_ID=fcipMIB, fcipEntityId=fcipEntityId, fcipLinkTable=fcipLinkTable, fcipDynamicRouteTable=fcipDynamicRouteTable, fcipLinkErrorsTable=fcipLinkErrorsTable, fcipTcpConnRWSize=fcipTcpConnRWSize, fcipLinkGroup=fcipLinkGroup, fcipEntityAddress=fcipEntityAddress, fcipConfig=fcipConfig, fcipDiscoveryDomainName=fcipDiscoveryDomainName, fcipLinkFcipSfRespMismatches=fcipLinkFcipSfRespMismatches, fcipStaticRouteLinkIndex=fcipStaticRouteLinkIndex, fcipStaticRouteEntry=fcipStaticRouteEntry, fcipLinkRemFcipEntityAddress=fcipLinkRemFcipEntityAddress, fcipDynamicRouteDID=fcipDynamicRouteDID, fcipLinkIfIndex=fcipLinkIfIndex, fcipDynamicRouteLinkIndex=fcipDynamicRouteLinkIndex, fcipDynamicRouteEntry=fcipDynamicRouteEntry, fcipTcpConnRemPort=fcipTcpConnRemPort, fcipEntityTcpConnPort=fcipEntityTcpConnPort, fcipLinkTcpTooManyErrors=fcipLinkTcpTooManyErrors, fcipLinkFcipLossofFcSynchs=fcipLinkFcipLossofFcSynchs, fcipEntityInstanceTable=fcipEntityInstanceTable, fcipTcpConnGroup=fcipTcpConnGroup, fcipEntityInstanceEntry=fcipEntityInstanceEntry, fcipDynamicRouteGroup=fcipDynamicRouteGroup, fcipTcpConnTable=fcipTcpConnTable, fcipEntityInstanceGroup=fcipEntityInstanceGroup, fcipLinkIndex=fcipLinkIndex, fcipCompliances=fcipCompliances, fcipDiscoveryDomainTable=fcipDiscoveryDomainTable, fcipEntityName=fcipEntityName, fcipEntityScalarGroup=fcipEntityScalarGroup, fcipStaticRouteTable=fcipStaticRouteTable, fcipEntityAddressType=fcipEntityAddressType, fcipLinkErrorsGroup=fcipLinkErrorsGroup, fcipCompliance=fcipCompliance, fcipLinkLocalFcipEntityAddress=fcipLinkLocalFcipEntityAddress, fcipLinkRemFcipEntityId=fcipLinkRemFcipEntityId, fcipLinkFcipNotReceivedSfResps=fcipLinkFcipNotReceivedSfResps, fcipEntitySACKOption=fcipEntitySACKOption, fcipLinkFcipSntpExpiredTimeStamps=fcipLinkFcipSntpExpiredTimeStamps, fcipObjects=fcipObjects, fcipGroups=fcipGroups, fcipDiscoveryDomainEntry=fcipDiscoveryDomainEntry)
