...
fcipLinkIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 5, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
fcipDynamicRouteLinkIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 7, 1, 2), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("readonly")
...
fcipStaticRouteLinkIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 8, 1, 2), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("readcreate")
...
fcipDiscoveryDomainIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 224, 1, 1, 9, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
# Groups
mibBuilder.exportSymbols("FCIP-MGMT-MIB", fcipDynamicRouteGroup=fcipDynamicRouteGroup, fcipDiscoveryDomainGroup=fcipDiscoveryDomainGroup, fcipEntityInstanceGroup=fcipEntityInstanceGroup, fcipEntityScalarGroup=fcipEntityScalarGroup, fcipLinkErrorsGroup=fcipLinkErrorsGroup, fcipStaticRouteGroup=fcipStaticRouteGroup, fcipLinkGroup=fcipLinkGroup, fcipTcpConnGroup=fcipTcpConnGroup)
