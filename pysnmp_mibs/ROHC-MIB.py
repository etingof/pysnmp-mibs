...
# by libsmi2pysnmp-0.0.7-alpha at Thu Nov 16 19:46:23 2006,
...
rohcChannelType = MibTableColumn((1, 3, 6, 1, 2, 1, 112, 1, 1, 1, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,3,2,)).subtype(namedValues=namedval.NamedValues(("notInUse", 1), ("rohc", 2), ("dedicatedFeedback", 3), ))).setMaxAccess("readonly")
...
rohcContextCIDState = MibTableColumn((1, 3, 6, 1, 2, 1, 112, 1, 2, 1, 3), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,4,2,3,)).subtype(namedValues=namedval.NamedValues(("unused", 1), ("active", 2), ("expired", 3), ("terminated", 4), ))).setMaxAccess("readonly")
...
rohcContextActivationTime = MibTableColumn((1, 3, 6, 1, 2, 1, 112, 1, 2, 1, 7), DateAndTime().clone('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readonly")
rohcContextDeactivationTime = MibTableColumn((1, 3, 6, 1, 2, 1, 112, 1, 2, 1, 8), DateAndTime().clone('\x00\x00\x00\x00\x00\x00\x00\x00')).setMaxAccess("readonly")
