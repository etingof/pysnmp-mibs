...
class FcAddressIdOrZero(OctetString):
    subtypeSpec = OctetString.subtypeSpec+constraint.ConstraintsUnion(constraint.ValueSizeConstraint(0,0),constraint.ValueSizeConstraint(3,3),)
    pass
...
class FcDomainIdOrZero(Integer32):
    subtypeSpec = Integer32.subtypeSpec+constraint.ValueRangeConstraint(0,239)
    pass

class FcNameIdOrZero(OctetString):
    subtypeSpec = OctetString.subtypeSpec+constraint.ConstraintsUnion(constraint.ValueSizeConstraint(0,0),constraint.ValueSizeConstraint(8,8),constraint.ValueSizeConstraint(16,16),)
    pass
...
class FcUnitFunctions(Bits):
    namedValues = namedval.NamedValues(("other", 0), ("hub", 1), ("storageDevice", 10), ("switch", 2), ("bridge", 3), ("gateway", 4), ("host", 5), ("storageSubsys", 6), ("storageAccessDev", 7), ("nas", 8), ("wdmux", 9), )
    pass
...
fcmInstanceIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 1, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
fcmInstancePhysicalIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 1, 1, 4), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readonly")
...
fcmInstanceSoftwareIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 1, 1, 5), Integer32().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647L))).setMaxAccess("readonly")
...
fcmInstanceStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 1, 1, 6), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(1,3,2,4,)).subtype(namedValues=namedval.NamedValues(("unknown", 1), ("ok", 2), ("warning", 3), ("failed", 4), ))).setMaxAccess("readonly")
...
fcmInstanceTextName = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 1, 1, 7), SnmpAdminString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, 79))).setMaxAccess("readwrite")
...
fcmSwitchIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 2, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
fcmPortInstanceIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("readonly")
...
fcmPortTransmitterType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 8), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(5,1,2,6,4,3,)).subtype(namedValues=namedval.NamedValues(("unknown", 1), ("other", 2), ("shortwave850nm", 3), ("longwave1550nm", 4), ("longwave1310nm", 5), ("electrical", 6), ))).setMaxAccess("readonly")
if mibBuilder.loadTexts: fcmPortTransmitterType.setDescription("The technology of the port transceiver.")
fcmPortConnectorType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 9), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(3,9,2,5,4,6,1,8,7,)).subtype(namedValues=namedval.NamedValues(("unknown", 1), ("other", 2), ("gbic", 3), ("embedded", 4), ("glm", 5), ("gbicSerialId", 6), ("gbicNoSerialId", 7), ("sfpSerialId", 8), ("sfpNoSerialId", 9), ))).setMaxAccess("readonly")
...
fcmPortAdminSpeed = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 12), Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(5,3,1,2,8,4,6,7,)).subtype(namedValues=namedval.NamedValues(("auto", 1), ("eighthGbs", 2), ("quarterGbs", 3), ("halfGbs", 4), ("oneGbs", 5), ("twoGbs", 6), ("fourGbs", 7), ("tenGbs", 8), ))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: fcmPortAdminSpeed.setDescription("The speed of the interface:\n\n'auto'        - auto-negotiation\n'tenGbs'      - 10Gbs\n'fourGbs'     -  4Gbs\n'twoGbs'      -  2Gbs\n'oneGbs'      -  1Gbs\n'halfGbs'     - 500Mbs\n'quarterGbs'  - 250Mbs\n'eighthGbs'   - 125Mbs")
fcmPortCapProtocols = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 13), Bits().subtype(namedValues=namedval.NamedValues(("unknown", 0), ("loop", 1), ("fabric", 2), ("scsi", 3), ("tcpIp", 4), ("vi", 5), ("ficon", 6), ))).setMaxAccess("readonly")
...
fcmPortOperProtocols = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 14), Bits().subtype(namedValues=namedval.NamedValues(("unknown", 0), ("loop", 1), ("fabric", 2), ("scsi", 3), ("tcpIp", 4), ("vi", 5), ("ficon", 6), ))).setMaxAccess("readonly")
...
fcmFLoginNxPortIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 9, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
fcmLinkIndex = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 10, 1, 1), Unsigned32().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, 4294967295L))).setMaxAccess("noaccess")
...
apply(fcmPortStatsEntry.setIndexNames, fcmPortEntry.getIndexNames())
fcmPortEntry.registerAugmentions(("FC-MGMT-MIB", "fcmPortErrorsEntry"))
apply(fcmPortErrorsEntry.setIndexNames, fcmPortEntry.getIndexNames())
fcmPortEntry.registerAugmentions(("FC-MGMT-MIB", "fcmPortLcStatsEntry"))
apply(fcmPortLcStatsEntry.setIndexNames, fcmPortEntry.getIndexNames())
...
# Groups
mibBuilder.exportSymbols("FC-MGMT-MIB", fcmPortStatsGroup=fcmPortStatsGroup, fcmPortLcStatsGroup=fcmPortLcStatsGroup, fcmSwitchBasicGroup=fcmSwitchBasicGroup, fcmPortClass23StatsGroup=fcmPortClass23StatsGroup, fcmPortBasicGroup=fcmPortBasicGroup, fcmPortErrorsGroup=fcmPortErrorsGroup, fcmLinkBasicGroup=fcmLinkBasicGroup, fcmInstanceBasicGroup=fcmInstanceBasicGroup, fcmPortClassFStatsGroup=fcmPortClassFStatsGroup, fcmSwitchLoginGroup=fcmSwitchLoginGroup, fcmSwitchPortGroup=fcmSwitchPortGroup)
