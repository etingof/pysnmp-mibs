...
# Produced by pysmi-0.0.3 at Wed Jul  1 22:27:55 2015
...
fcmInstanceStatus = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 1, 1, 6), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4,)).clone(namedValues=NamedValues(("unknown", 1), ("ok", 2), ("warning", 3), ("failed", 4),))).setMaxAccess("readonly")
...
fcmPortEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1), ).setIndexNames((0, "FC-MGMT-MIB", "ifIndex"))
...
fcmPortTransmitterType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 8), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6,)).clone(namedValues=NamedValues(("unknown", 1), ("other", 2), ("shortwave850nm", 3), ("longwave1550nm", 4), ("longwave1310nm", 5), ("electrical", 6),))).setMaxAccess("readonly")
if mibBuilder.loadTexts: fcmPortTransmitterType.setDescription('The technology of the port transceiver.')
fcmPortConnectorType = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 9), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8, 9,)).clone(namedValues=NamedValues(("unknown", 1), ("other", 2), ("gbic", 3), ("embedded", 4), ("glm", 5), ("gbicSerialId", 6), ("gbicNoSerialId", 7), ("sfpSerialId", 8), ("sfpNoSerialId", 9),))).setMaxAccess("readonly")
...
fcmPortAdminSpeed = MibTableColumn((1, 3, 6, 1, 2, 1, 10, 56, 1, 3, 1, 12), Integer32().subtype(subtypeSpec=SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8,)).clone(namedValues=NamedValues(("auto", 1), ("eighthGbs", 2), ("quarterGbs", 3), ("halfGbs", 4), ("oneGbs", 5), ("twoGbs", 6), ("fourGbs", 7), ("tenGbs", 8),))).setMaxAccess("readwrite")
...
fcmFxPortEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 56, 1, 7, 1), ).setIndexNames((0, "FC-MGMT-MIB", "ifIndex"))
...
fcmISPortEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 56, 1, 8, 1), ).setIndexNames((0, "FC-MGMT-MIB", "ifIndex"))
...
fcmFLoginEntry = MibTableRow((1, 3, 6, 1, 2, 1, 10, 56, 1, 9, 1), ).setIndexNames((0, "FC-MGMT-MIB", "ifIndex"), (0, "FC-MGMT-MIB", "fcmFLoginNxPortIndex"))
...
mibBuilder.exportSymbols("FC-MGMT-MIB", fcmPortClass2RxFrames=fcmPortClass2RxFrames, fcmFxPortCapDataFieldSizeMin=fcmFxPortCapDataFieldSizeMin, fcmPortNodeWwn=fcmPortNodeWwn, fcmPortLcClass3TxOctets=fcmPortLcClass3TxOctets, fcmFxPortCapBbCreditMin=fcmFxPortCapBbCreditMin, fcmPortLcClass3Discards=fcmPortLcClass3Discards, fcmPortClass2RxPrjtFrames=fcmPortClass2RxPrjtFrames, fcmPortLcBBCreditZeros=fcmPortLcBBCreditZeros, fcmLinkTable=fcmLinkTable, fcmFxPortRttov=fcmFxPortRttov, fcmPortLinkFailures=fcmPortLinkFailures, fcmFLoginClass3SeqDelivAgreed=fcmFLoginClass3SeqDelivAgreed, fcmPortCapProtocols=fcmPortCapProtocols, fcmPortEncodingDisparityErrors=fcmPortEncodingDisparityErrors, fcmLinkEnd1NodeWwn=fcmLinkEnd1NodeWwn, fcmISPortTable=fcmISPortTable, fcmFxPortEdtov=fcmFxPortEdtov, fcmPortLcClass2TxFrjtFrames=fcmPortLcClass2TxFrjtFrames, fcmPortClass2TxPbsyFrames=fcmPortClass2TxPbsyFrames, fcmFLoginBbCredit=fcmFLoginBbCredit, fcmPortLcClass2TxFbsyFrames=fcmPortLcClass2TxFbsyFrames, fcmFLoginTable=fcmFLoginTable, fcmPortSerialNumber=fcmPortSerialNumber, fcmPortClass2TxFbsyFrames=fcmPortClass2TxFbsyFrames, PYSNMP_MODULE_ID=fcMgmtMIB, fcmPortDelimiterErrors=fcmPortDelimiterErrors, fcmPortInvalidTxWords=fcmPortInvalidTxWords, fcmSwitchPrincipal=fcmSwitchPrincipal, fcmFLoginClass2DataFieldSize=fcmFLoginClass2DataFieldSize, fcmPortTable=fcmPortTable, fcmSwitchEntry=fcmSwitchEntry, fcmPortClassFTxFrames=fcmPortClassFTxFrames, fcmPortClass2TxFrames=fcmPortClass2TxFrames, fcmSwitchPortGroup=fcmSwitchPortGroup, fcmPortLcClass2RxFbsyFrames=fcmPortLcClass2RxFbsyFrames, fcmFLoginNodeWwn=fcmFLoginNodeWwn, fcmPortClass3RxOctets=fcmPortClass3RxOctets, fcmPortLcClass2TxFrames=fcmPortLcClass2TxFrames, fcmPortFcOperClass=fcmPortFcOperClass, fcmFLoginClassesAgreed=fcmFLoginClassesAgreed, fcmSwitchWWN=fcmSwitchWWN, fcmPortBasicGroup=fcmPortBasicGroup, fcmISPortClassFDataFieldSize=fcmISPortClassFDataFieldSize, fcmgmtObjects=fcmgmtObjects, fcmPortLcStatsTable=fcmPortLcStatsTable, fcmLinkEnd2UnitType=fcmLinkEnd2UnitType, fcmFxPortCapClass2SeqDeliv=fcmFxPortCapClass2SeqDeliv, fcmFxPortCapHoldTimeMax=fcmFxPortCapHoldTimeMax, fcmInstanceTable=fcmInstanceTable, fcmPortAddressErrors=fcmPortAddressErrors, fcmPortWwn=fcmPortWwn, fcmPortClass3TxOctets=fcmPortClass3TxOctets, fcmPortPhysicalNumber=fcmPortPhysicalNumber, fcmPortClass3RxFrames=fcmPortClass3RxFrames, fcmSwitchLoginGroup=fcmSwitchLoginGroup, fcmFLoginPortWwn=fcmFLoginPortWwn, fcmFxPortCapClass3SeqDeliv=fcmFxPortCapClass3SeqDeliv, fcmPortClassFDiscards=fcmPortClassFDiscards, fcmPortTruncatedFrames=fcmPortTruncatedFrames, fcmPortClass3TxFrames=fcmPortClass3TxFrames, fcmPortLcClass2RxOctets=fcmPortLcClass2RxOctets, fcmPortClass2RxOctets=fcmPortClass2RxOctets, fcmPortTxOfflineSequences=fcmPortTxOfflineSequences, fcmPortLinkResets=fcmPortLinkResets, fcmPortLcClass2TxPbsyFrames=fcmPortLcClass2TxPbsyFrames, fcmPortLcClass2RxPrjtFrames=fcmPortLcClass2RxPrjtFrames, fcmPortFcCapClass=fcmPortFcCapClass, fcmSwitchDomainId=fcmSwitchDomainId, fcmPortClassFRxFrames=fcmPortClassFRxFrames, fcmLinkEnd2NodeWwn=fcmLinkEnd2NodeWwn, fcmPortLcClass2TxOctets=fcmPortLcClass2TxOctets, fcmPortClass2Discards=fcmPortClass2Discards, fcmPortOtherErrors=fcmPortOtherErrors, fcmPortInvalidCRCs=fcmPortInvalidCRCs, fcmPortAdminSpeed=fcmPortAdminSpeed, fcmInstanceBasicGroup=fcmInstanceBasicGroup, fcmPortClassFTxOctets=fcmPortClassFTxOctets, FcNameIdOrZero=FcNameIdOrZero, FcClasses=FcClasses, fcmPortRxLinkResets=fcmPortRxLinkResets, fcmInstanceSoftwareIndex=fcmInstanceSoftwareIndex, fcmPortOperType=fcmPortOperType, fcmPortClass3Discards=fcmPortClass3Discards, fcmFLoginClass3DataFieldSize=fcmFLoginClass3DataFieldSize, fcmPortTxLinkResets=fcmPortTxLinkResets, fcmPortInstanceIndex=fcmPortInstanceIndex, fcmPortErrorsTable=fcmPortErrorsTable, fcmFxPortCapBbCreditMax=fcmFxPortCapBbCreditMax, fcmPortClassFRxOctets=fcmPortClassFRxOctets, fcmPortPrimSeqProtocolErrors=fcmPortPrimSeqProtocolErrors, fcmPortInvalidOrderedSets=fcmPortInvalidOrderedSets, fcmLinkEnd2PortWwn=fcmLinkEnd2PortWwn, fcmPortLcFullInputBuffers=fcmPortLcFullInputBuffers, fcmPortStatsTable=fcmPortStatsTable, fcmPortLcClass3RxOctets=fcmPortLcClass3RxOctets, FcUnitFunctions=FcUnitFunctions, fcmInstanceEntry=fcmInstanceEntry, fcmPortLcClass3RxFrames=fcmPortLcClass3RxFrames, fcmPortLcStatsEntry=fcmPortLcStatsEntry, fcmPortLcClass2RxPbsyFrames=fcmPortLcClass2RxPbsyFrames, fcmPortClass2TxFrjtFrames=fcmPortClass2TxFrjtFrames, fcmLinkIndex=fcmLinkIndex, fcmInstanceIndex=fcmInstanceIndex, fcmgmtNotifications=fcmgmtNotifications, fcmFxPortHoldTime=fcmFxPortHoldTime, fcmPortFullInputBuffers=fcmPortFullInputBuffers, fcmPortClass2TxPrjtFrames=fcmPortClass2TxPrjtFrames, fcmLinkEnd1PortWwn=fcmLinkEnd1PortWwn, fcmPortStatsEntry=fcmPortStatsEntry, fcmLinkBasicGroup=fcmLinkBasicGroup, fcmInstanceStatus=fcmInstanceStatus, fcmLinkEnd2FcAddressId=fcmLinkEnd2FcAddressId, fcmgmtGroups=fcmgmtGroups, fcmPortErrorsGroup=fcmPortErrorsGroup, fcmLinkEnd2AgentAddress=fcmLinkEnd2AgentAddress, fcmgmtConformance=fcmgmtConformance, fcmPortEntry=fcmPortEntry, fcmInstanceFabricId=fcmInstanceFabricId, fcmPortClass2RxFbsyFrames=fcmPortClass2RxFbsyFrames, fcmgmtCompliances=fcmgmtCompliances, fcmPortStatsGroup=fcmPortStatsGroup, fcmPortLossofSignals=fcmPortLossofSignals, fcmFLoginEntry=fcmFLoginEntry, fcmLinkEnd2PortType=fcmLinkEnd2PortType, FcBbCreditModel=FcBbCreditModel, fcmPortClass23StatsGroup=fcmPortClass23StatsGroup, fcmPortRxOfflineSequences=fcmPortRxOfflineSequences, fcmLinkEntry=fcmLinkEntry, fcMgmtMIB=fcMgmtMIB, fcmSwitchIndex=fcmSwitchIndex, fcmPortClass2RxFrjtFrames=fcmPortClass2RxFrjtFrames, fcmInstanceWwn=fcmInstanceWwn, fcmgmtNotifPrefix=fcmgmtNotifPrefix, fcmgmtCompliance=fcmgmtCompliance, fcmSwitchBasicGroup=fcmSwitchBasicGroup, fcmSwitchTable=fcmSwitchTable, FcDomainIdOrZero=FcDomainIdOrZero, FcBbCredit=FcBbCredit, fcmPortConnectorType=fcmPortConnectorType, FcDataFieldSize=FcDataFieldSize, fcmISPortEntry=fcmISPortEntry, fcmPortClassFStatsGroup=fcmPortClassFStatsGroup, fcmFLoginClass2SeqDelivAgreed=fcmFLoginClass2SeqDelivAgreed, fcmPortOperProtocols=fcmPortOperProtocols, fcmPortLcClass2TxPrjtFrames=fcmPortLcClass2TxPrjtFrames, fcmPortLossofSynchs=fcmPortLossofSynchs, fcmISPortClassFCredit=fcmISPortClassFCredit, fcmPortLcClass3TxFrames=fcmPortLcClass3TxFrames, fcmPortClass2TxOctets=fcmPortClass2TxOctets, fcmPortBBCreditZeros=fcmPortBBCreditZeros, fcmInstanceDescr=fcmInstanceDescr, FcPortType=FcPortType, fcmFxPortCapHoldTimeMin=fcmFxPortCapHoldTimeMin, fcmFxPortTable=fcmFxPortTable, fcmPortLcClass2RxFrjtFrames=fcmPortLcClass2RxFrjtFrames, fcmInstancePhysicalIndex=fcmInstancePhysicalIndex, FcAddressIdOrZero=FcAddressIdOrZero, fcmPortErrorsEntry=fcmPortErrorsEntry, fcmPortLcClass2RxFrames=fcmPortLcClass2RxFrames, fcmInstanceTextName=fcmInstanceTextName, fcmFxPortRatov=fcmFxPortRatov, fcmInstanceFunctions=fcmInstanceFunctions, fcmPortLcClass2Discards=fcmPortLcClass2Discards, fcmPortTransmitterType=fcmPortTransmitterType, fcmPortFrameTooLongs=fcmPortFrameTooLongs, fcmFxPortEntry=fcmFxPortEntry, fcmPortClass2RxPbsyFrames=fcmPortClass2RxPbsyFrames, fcmPortAdminType=fcmPortAdminType, fcmFLoginNxPortIndex=fcmFLoginNxPortIndex, fcmLinkEnd1PhysPortNumber=fcmLinkEnd1PhysPortNumber, fcmFLoginBbCreditModel=fcmFLoginBbCreditModel, fcmFxPortCapDataFieldSizeMax=fcmFxPortCapDataFieldSizeMax, fcmPortLcStatsGroup=fcmPortLcStatsGroup, fcmLinkEnd2PhysPortNumber=fcmLinkEnd2PhysPortNumber)
