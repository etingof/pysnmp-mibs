...
upsIdentManufacturer = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 1, 1), DisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 31))).setMaxAccess("readonly")
upsIdentModel = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 1, 2), DisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 63))).setMaxAccess("readonly")
upsIdentUPSSoftwareVersion = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 1, 3), DisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 63))).setMaxAccess("readonly")
upsIdentAgentSoftwareVersion = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 1, 4), DisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 63))).setMaxAccess("readonly")
upsIdentName = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 1, 5), DisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 63))).setMaxAccess("readwrite")
upsIdentAttachedDevices = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 1, 6), DisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 63))).setMaxAccess("readwrite")
upsBattery = MibIdentifier((1, 3, 6, 1, 2, 1, 33, 1, 2))
upsBatteryStatus = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 2, 1), Integer().addConstraints(subtypes.SingleValueConstraint(3,1,2,4,)).addNamedValues(("unknown", 1), ("batteryNormal", 2), ("batteryLow", 3), ("batteryDepleted", 4), )).setMaxAccess("readonly")
...
upsEstimatedChargeRemaining = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 2, 4), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 100))).setMaxAccess("readonly").setUnits("percent")
...
upsOutputSource = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 4, 1), Integer().addConstraints(subtypes.SingleValueConstraint(2,1,7,4,3,5,6,)).addNamedValues(("other", 1), ("none", 2), ("normal", 3), ("bypass", 4), ("battery", 5), ("booster", 6), ("reducer", 7), )).setMaxAccess("readonly")
...
upsOutputPercentLoad = MibTableColumn((1, 3, 6, 1, 2, 1, 33, 1, 4, 4, 1, 5)).setColumnInitializer(MibVariable((), Integer32().addConstraints(subtypes.ValueRangeConstraint(0, 200))).setMaxAccess("readonly"))
...
upsTestResultsSummary = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 7, 3), Integer().addConstraints(subtypes.SingleValueConstraint(3,4,5,1,6,2,)).addNamedValues(("donePass", 1), ("doneWarning", 2), ("doneError", 3), ("aborted", 4), ("inProgress", 5), ("noTestsInitiated", 6), )).setMaxAccess("readonly")
upsTestResultsDetail = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 7, 4), DisplayString().addConstraints(subtypes.ValueRangeConstraint(0, 255))).setMaxAccess("readonly")
...
upsShutdownType = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 8, 1), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,)).addNamedValues(("output", 1), ("system", 2), )).setMaxAccess("readwrite")
upsShutdownAfterDelay = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 8, 2), Integer32().addConstraints(subtypes.ValueRangeConstraint(-1, 2147483647L))).setMaxAccess("readwrite").setUnits("seconds")
upsStartupAfterDelay = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 8, 3), Integer32().addConstraints(subtypes.ValueRangeConstraint(-1, 2147483647L))).setMaxAccess("readwrite").setUnits("seconds")
upsRebootWithDuration = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 8, 4), Integer32().addConstraints(subtypes.ValueRangeConstraint(-1, 300))).setMaxAccess("readwrite").setUnits("seconds")
upsAutoRestart = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 8, 5), Integer().addConstraints(subtypes.SingleValueConstraint(1,2,)).addNamedValues(("on", 1), ("off", 2), )).setMaxAccess("readwrite")
...
upsConfigAudibleStatus = MibVariable((1, 3, 6, 1, 2, 1, 33, 1, 9, 8), Integer().addConstraints(subtypes.SingleValueConstraint(1,3,2,)).addNamedValues(("disabled", 1), ("enabled", 2), ("muted", 3), )).setMaxAccess("readwrite")
